...
export namespace typeUtil {
  ...
  export type TPlain<TSchemaBranded> = TSchemaBranded extends ZodBranded<
    infer TSchema,
    infer _TBrand
  >
    ? z.infer<TSchema>
  ...
  export type PartialValue<T> = T extends typeUtil.Primitive
    ...
    ? Partial<
        Record<key, U | ValueObjectCtor<string, ZodBranded<ZodType<U>, string>>>
      >
    : never;

  export type KeyType = string | number | symbol;

  type NativeTypes<TSchema extends ZodType> = TSchema extends ZodBranded<
    infer TSchema,
    infer _
  >
    ? z.infer<TSchema>
  ...
  type MixedTypes<TSchema extends ZodType> = TSchema extends ZodBranded<
    infer S,
    any
  >
