...
use connector_utils::types::db::{
    ...
    MIGRATION_KEYGEN_REQUEST_NOTIFICATION, NEW_KMS_CONTEXT_NOTIFICATION,
    NEW_KMS_EPOCH_NOTIFICATION, PREP_KEYGEN_REQUEST_NOTIFICATION,
    PREP_MIGRATION_KEYGEN_REQUEST_NOTIFICATION, PUBLIC_DECRYPT_REQUEST_NOTIFICATION,
...
impl DbEventNotifier {
    ...
    async fn listen(&mut self) -> sqlx::Result<()> {
        ...
        self.db_listener
            .listen(PREP_MIGRATION_KEYGEN_REQUEST_NOTIFICATION)
            .await?;
        self.db_listener
    ...
    pub async fn start(mut self) {
        ...
        let mut prep_migration_keygen_ticker =
            EventTicker::new(db_long_event_polling, EventType::PrepMigrationKeygenRequest);
        ...
        loop {
            let notification = select! {
                ...
                _ = prep_migration_keygen_ticker.tick() => prep_migration_keygen_ticker.deliver(),
            ...
            match notification {
                ...
                EventType::PrepMigrationKeygenRequest => prep_migration_keygen_ticker.reset(),
