...
//!
//! The carrier names the encrypted store whose history contains a public handle and nothing else; the
...
fn extra_data_vectors_encode_and_round_trip() {
    ...
    for record in &file.records {
        ...
        assert_eq!(
            encode_solana_public_decrypt_extra_data(context_id, encrypted_store),
            expected_blob,
        ...
        assert_eq!(parsed.encrypted_store, encrypted_store, "{}", record.name);
    }
