...
pub async fn insert_rand_public_decryption_request(
    ...
    sqlx::query!(
        "INSERT INTO public_decryption_requests(decryption_id, sns_ct_materials, extra_data, tx_hash, otlp_context, already_sent, status) \
...
pub async fn insert_rand_user_decryption_request(
    ...
    sqlx::query!(
        ...
        decryption_id, sns_ct_materials, user_address, public_key, extra_data, tx_hash, otlp_context, already_sent, status\
        ) \
