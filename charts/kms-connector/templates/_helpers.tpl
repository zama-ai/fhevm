...
{{- range $field := list "url" "chainId" "aclAddress" }}
...
{{- $chains = append $chains (dict "url" $chain.url "chainId" (atoi $chain.chainId) "aclAddress" $chain.aclAddress) -}}
{{- end -}}
{{- toJson $chains -}}
{{- end -}}
