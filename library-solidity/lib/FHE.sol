...
library FHE {
     ...
     *                      otherwise it would revert with `NotEnoughNative(msg.value)` even if using a greater value than the quoted one (i.e no refund of excess sent funds, but revert also in this case).
