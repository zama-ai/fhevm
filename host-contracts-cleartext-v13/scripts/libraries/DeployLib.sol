...
import {KmsNode} from "../../src/host-contracts/contracts/shared/Structs.sol";
...
library DeployLib {
    ...
    function setProtocolConfigImplementation(VmSafe vm, address protocolConfigAddress, ProtocolConfig protocolConfigImplementation) internal {
        ...
        // v0.13: ProtocolConfig.initializeFromEmptyProxy takes (KmsNode[], KmsThresholds). (v0.14
        // widened this to KmsNodeParams[] + software version + PCR values.)
