...
contract TFHEExecutor {
    ...
    function fheAdd(uint256 lhs, uint256 rhs, bool scalar) public returns (uint256 result) {
    ...
    function fheSub(uint256 lhs, uint256 rhs, bool scalar) public returns (uint256 result) {
        require(acl.isAllowed(lhs, msg.sender));
        bytes1 scalarByte;
        if (scalar) {
            scalarByte = 0x01;
    ...
    function fheMul(uint256 lhs, uint256 rhs, bool scalar) public returns (uint256 result) {
        require(acl.isAllowed(lhs, msg.sender));
        bytes1 scalarByte;
        if (scalar) {
            scalarByte = 0x01;
    ...
    function fheDiv(uint256 lhs, uint256 rhs) public returns (uint256 result) {
        require(acl.isAllowed(lhs, msg.sender));
    ...
    function fheRem(uint256 lhs, uint256 rhs) public returns (uint256 result) {
        require(acl.isAllowed(lhs, msg.sender));
        bytes1 scalarByte = 0x01;
    ...
    function fheBitAnd(uint256 lhs, uint256 rhs) public returns (uint256 result) {
        require(acl.isAllowed(lhs, msg.sender));
    ...
    function fheBitOr(uint256 lhs, uint256 rhs) public returns (uint256 result) {
        require(acl.isAllowed(lhs, msg.sender));
        bytes1 scalarByte = 0x00;
    ...
    function fheBitXor(uint256 lhs, uint256 rhs) public returns (uint256 result) {
        require(acl.isAllowed(lhs, msg.sender));
        bytes1 scalarByte = 0x00;
    ...
    function fheShl(uint256 lhs, uint256 rhs, bool scalar) public returns (uint256 result) {
        require(acl.isAllowed(lhs, msg.sender));
        bytes1 scalarByte;
        if (scalar) {
            scalarByte = 0x01;
    ...
    function fheShr(uint256 lhs, uint256 rhs, bool scalar) public returns (uint256 result) {
        require(acl.isAllowed(lhs, msg.sender));
        bytes1 scalarByte;
        if (scalar) {
            scalarByte = 0x01;
    ...
    function fheRotl(uint256 lhs, uint256 rhs, bool scalar) public returns (uint256 result) {
        require(acl.isAllowed(lhs, msg.sender));
        bytes1 scalarByte;
        if (scalar) {
            scalarByte = 0x01;
    ...
    function fheRotr(uint256 lhs, uint256 rhs, bool scalar) public returns (uint256 result) {
        require(acl.isAllowed(lhs, msg.sender));
        bytes1 scalarByte;
        if (scalar) {
            scalarByte = 0x01;
    ...
    function fheEq(uint256 lhs, uint256 rhs, bool scalar) public returns (uint256 result) {
        require(acl.isAllowed(lhs, msg.sender));
        bytes1 scalarByte;
        if (scalar) {
            scalarByte = 0x01;
    ...
    function fheNe(uint256 lhs, uint256 rhs, bool scalar) public returns (uint256 result) {
        require(acl.isAllowed(lhs, msg.sender));
        bytes1 scalarByte;
        if (scalar) {
            scalarByte = 0x01;
    ...
    function fheGe(uint256 lhs, uint256 rhs, bool scalar) public returns (uint256 result) {
        require(acl.isAllowed(lhs, msg.sender));
        bytes1 scalarByte;
        if (scalar) {
            scalarByte = 0x01;
    ...
    function fheGt(uint256 lhs, uint256 rhs, bool scalar) public returns (uint256 result) {
        require(acl.isAllowed(lhs, msg.sender));
        bytes1 scalarByte;
        if (scalar) {
            scalarByte = 0x01;
    ...
    function fheLe(uint256 lhs, uint256 rhs, bool scalar) public returns (uint256 result) {
        require(acl.isAllowed(lhs, msg.sender));
        bytes1 scalarByte;
        if (scalar) {
            scalarByte = 0x01;
    ...
    function fheLt(uint256 lhs, uint256 rhs, bool scalar) public returns (uint256 result) {
        require(acl.isAllowed(lhs, msg.sender));
        bytes1 scalarByte;
        if (scalar) {
            scalarByte = 0x01;
    ...
    function fheMin(uint256 lhs, uint256 rhs, bool scalar) public returns (uint256 result) {
        require(acl.isAllowed(lhs, msg.sender));
        bytes1 scalarByte;
        if (scalar) {
            scalarByte = 0x01;
    ...
    function fheMax(uint256 lhs, uint256 rhs, bool scalar) public returns (uint256 result) {
        require(acl.isAllowed(lhs, msg.sender));
        bytes1 scalarByte;
        if (scalar) {
            scalarByte = 0x01;
    ...
    function fheNeg(uint256 ct) public returns (uint256 result) {
        require(acl.isAllowed(ct, msg.sender));
        result = FhevmLib(address(EXT_TFHE_LIBRARY)).fheNeg(ct);
        acl.allowTransient(result, msg.sender);
    }

    function fheNot(uint256 ct) public returns (uint256 result) {
        require(acl.isAllowed(ct, msg.sender));
