...
- **Solidity integration:** Write FHEVM contracts like any standard Solidity contract using Solidity. Compatible with popular Ethereum development toolchains such as Hardhat and Foundry.
