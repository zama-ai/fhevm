...
- **Solidity integration:** Write FHEVM contracts like any standard Solidity contract in Solidity, using familiar toolchains such as Hardhat and Foundry (*coming soon*).
