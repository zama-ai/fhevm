...
- [Hardhat setup guide](https://docs.zama.ai/protocol/solidity-guides/v0.7/getting-started/setup) — Step-by-step guide for setting up an FHEVM Hardhat development environment using the official template.
