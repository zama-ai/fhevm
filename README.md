...
This repository provides tools and components for building and experimenting
with Fully Homomorphic Encryption Virtual Machine (FHEVM) applications.
It is intended for developers and researchers exploring privacy-preserving computation.
