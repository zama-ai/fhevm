...
{% hint style="info" %}
For more information on a Relayer's part in the overall architecture please refer to [the Relayer's page in the architecture documentation](../protocol/architecture/relayer_oracle.md).
{% endhint %}
