...
- Make sure that your Hardhat project is clean and ready to start. See the instructions [here](setup.md#reset-the-hardhat-environment).
...
- `await tx.wait()` to wait for the transaction to be mined.
