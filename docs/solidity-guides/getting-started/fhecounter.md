...
Starting with the plain `Counter.sol` contract that you build from the [2. Writing a simple contract](write_a_simple_contract.md), and step-by-step, you’ll learn how to:
