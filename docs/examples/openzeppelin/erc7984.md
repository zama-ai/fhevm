...
2. Set up the [OpenZeppelin confidential contracts library](https://github.com/OpenZeppelin/openzeppelin-confidential-contracts). (For guidance on this, follow the [Setting up OpenZeppelin confidential contracts tutorial](./README.md).)
