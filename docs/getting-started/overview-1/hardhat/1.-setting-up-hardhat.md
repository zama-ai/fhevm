...
This guide walks you through setting up your Hardhat environment using Zama's HTTPZ Hardhat template.

## Step 1: Clone the Hardhat template

1. Open the repository: [Zama HTTPZ Hardhat Template](https://github.com/zama-ai/fhevm-hardhat-template)
