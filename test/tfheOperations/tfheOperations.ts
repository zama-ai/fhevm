...
describe('TFHE operations', function () {
  ...
  it('test operator "add" overload (euint8, euint64) => euint64 test 1 (255, 4294902015)', async function () {
    const res = await this.contract1.add_euint8_euint64(
      this.instances1.alice.encrypt8(255),
      this.instances1.alice.encrypt64(4294902015),
    );
    expect(res).to.equal(4294902270);
  });

  it('test operator "sub" overload (euint8, euint64) => euint64 test 1 (255, 4294902015)', async function () {
    const res = await this.contract1.sub_euint8_euint64(
      this.instances1.alice.encrypt8(255),
      this.instances1.alice.encrypt64(4294902015),
    );
  ...
  it('test operator "sub" overload (euint8, euint64) => euint64 test 2 (255, 16)', async function () {
    const res = await this.contract1.sub_euint8_euint64(
      this.instances1.alice.encrypt8(255),
      this.instances1.alice.encrypt64(16),
    );
    expect(res).to.equal(239);
  });

  it('test operator "mul" overload (euint8, euint64) => euint64 test 1 (16, 65536)', async function () {
    const res = await this.contract1.mul_euint8_euint64(
      this.instances1.alice.encrypt8(16),
      this.instances1.alice.encrypt64(65536),
    );
    expect(res).to.equal(1048576);
  });

  it('test operator "and" overload (euint8, euint64) => euint64 test 1 (16, 65536)', async function () {
    const res = await this.contract1.and_euint8_euint64(
      this.instances1.alice.encrypt8(16),
      this.instances1.alice.encrypt64(65536),
    );
    expect(res).to.equal(0);
  ...
  it('test operator "and" overload (euint8, euint64) => euint64 test 2 (17, 65552)', async function () {
    const res = await this.contract1.and_euint8_euint64(
      this.instances1.alice.encrypt8(17),
      this.instances1.alice.encrypt64(65552),
    );
    expect(res).to.equal(16);
  });

  it('test operator "or" overload (euint8, euint64) => euint64 test 1 (16, 65536)', async function () {
    const res = await this.contract1.or_euint8_euint64(
      this.instances1.alice.encrypt8(16),
      this.instances1.alice.encrypt64(65536),
    );
    expect(res).to.equal(65552);
  ...
  it('test operator "xor" overload (euint8, euint64) => euint64 test 1 (16, 65536)', async function () {
    const res = await this.contract1.xor_euint8_euint64(
      this.instances1.alice.encrypt8(16),
      this.instances1.alice.encrypt64(65536),
    );
    expect(res).to.equal(65552);
  ...
  it('test operator "eq" overload (euint8, euint64) => ebool test 1 (1, 1)', async function () {
    const res = await this.contract1.eq_euint8_euint64(
      this.instances1.alice.encrypt8(1),
      this.instances1.alice.encrypt64(1),
    );
    expect(res).to.equal(true);
  });
  ...
  it('test operator "eq" overload (euint8, euint64) => ebool test 2 (1, 65537)', async function () {
    const res = await this.contract1.eq_euint8_euint64(
      this.instances1.alice.encrypt8(1),
      this.instances1.alice.encrypt64(65537),
    );
    expect(res).to.equal(false);
  });

  it('test operator "ne" overload (euint8, euint64) => ebool test 1 (1, 1)', async function () {
    const res = await this.contract1.ne_euint8_euint64(
      this.instances1.alice.encrypt8(1),
      this.instances1.alice.encrypt64(1),
    );
    expect(res).to.equal(false);
  ...
  it('test operator "ge" overload (euint8, euint64) => ebool test 1 (1, 1)', async function () {
    const res = await this.contract1.ge_euint8_euint64(
      this.instances1.alice.encrypt8(1),
      this.instances1.alice.encrypt64(1),
    );
    expect(res).to.equal(true);
  ...
  it('test operator "gt" overload (euint8, euint64) => ebool test 1 (1, 1)', async function () {
    const res = await this.contract1.gt_euint8_euint64(
      this.instances1.alice.encrypt8(1),
      this.instances1.alice.encrypt64(1),
    );
    expect(res).to.equal(false);
  ...
  it('test operator "le" overload (euint8, euint64) => ebool test 1 (1, 1)', async function () {
    const res = await this.contract1.le_euint8_euint64(
      this.instances1.alice.encrypt8(1),
      this.instances1.alice.encrypt64(1),
    );
    expect(res).to.equal(true);
  ...
  it('test operator "lt" overload (euint8, euint64) => ebool test 1 (1, 1)', async function () {
    const res = await this.contract1.lt_euint8_euint64(
      this.instances1.alice.encrypt8(1),
      this.instances1.alice.encrypt64(1),
    );
    expect(res).to.equal(false);
  ...
  it('test operator "min" overload (euint8, euint64) => euint64 test 1 (1, 1)', async function () {
    const res = await this.contract1.min_euint8_euint64(
      this.instances1.alice.encrypt8(1),
      this.instances1.alice.encrypt64(1),
    );
    expect(res).to.equal(1);
  ...
  it('test operator "max" overload (euint8, euint64) => euint64 test 1 (1, 1)', async function () {
    const res = await this.contract1.max_euint8_euint64(
      this.instances1.alice.encrypt8(1),
      this.instances1.alice.encrypt64(1),
    );
    expect(res).to.equal(1);
  ...
  it('test operator "add" overload (euint16, euint64) => euint64 test 1 (514, 131074)', async function () {
    const res = await this.contract2.add_euint16_euint64(
      this.instances2.alice.encrypt16(514),
      this.instances2.alice.encrypt64(131074),
    );
    expect(res).to.equal(131588);
  });

  it('test operator "sub" overload (euint16, euint64) => euint64 test 1 (514, 2)', async function () {
    const res = await this.contract2.sub_euint16_euint64(
      this.instances2.alice.encrypt16(514),
      this.instances2.alice.encrypt64(2),
    );
    expect(res).to.equal(512);
  });
  ...
  it('test operator "mul" overload (euint16, euint64) => euint64 test 1 (512, 65536)', async function () {
    const res = await this.contract2.mul_euint16_euint64(
      this.instances2.alice.encrypt16(512),
      this.instances2.alice.encrypt64(65536),
    );
    expect(res).to.equal(33554432);
  ...
  it('test operator "and" overload (euint16, euint64) => euint64 test 1 (514, 65536)', async function () {
    const res = await this.contract2.and_euint16_euint64(
      this.instances2.alice.encrypt16(514),
      this.instances2.alice.encrypt64(65536),
    );
    expect(res).to.equal(0);
  ...
  it('test operator "and" overload (euint16, euint64) => euint64 test 2 (514, 65538)', async function () {
    const res = await this.contract2.and_euint16_euint64(
      this.instances2.alice.encrypt16(514),
      this.instances2.alice.encrypt64(65538),
    );
    expect(res).to.equal(2);
  });

  it('test operator "or" overload (euint16, euint64) => euint64 test 1 (514, 65536)', async function () {
    const res = await this.contract2.or_euint16_euint64(
      this.instances2.alice.encrypt16(514),
      this.instances2.alice.encrypt64(65536),
    );
    expect(res).to.equal(66050);
  ...
  it('test operator "xor" overload (euint16, euint64) => euint64 test 1 (514, 65536)', async function () {
    const res = await this.contract2.xor_euint16_euint64(
      this.instances2.alice.encrypt16(514),
      this.instances2.alice.encrypt64(65536),
    );
    expect(res).to.equal(66050);
  ...
  it('test operator "eq" overload (euint16, euint64) => ebool test 1 (514, 66050)', async function () {
    const res = await this.contract2.eq_euint16_euint64(
      this.instances2.alice.encrypt16(514),
      this.instances2.alice.encrypt64(66050),
    );
    expect(res).to.equal(false);
  });
  ...
  it('test operator "eq" overload (euint16, euint64) => ebool test 2 (514, 514)', async function () {
    const res = await this.contract2.eq_euint16_euint64(
      this.instances2.alice.encrypt16(514),
      this.instances2.alice.encrypt64(514),
    );
    expect(res).to.equal(true);
  });

  it('test operator "ne" overload (euint16, euint64) => ebool test 1 (514, 66050)', async function () {
    const res = await this.contract2.ne_euint16_euint64(
      this.instances2.alice.encrypt16(514),
      this.instances2.alice.encrypt64(66050),
    );
    expect(res).to.equal(true);
  ...
  it('test operator "ge" overload (euint16, euint64) => ebool test 1 (514, 66050)', async function () {
    const res = await this.contract2.ge_euint16_euint64(
      this.instances2.alice.encrypt16(514),
      this.instances2.alice.encrypt64(66050),
    );
    expect(res).to.equal(false);
  ...
  it('test operator "ge" overload (euint16, euint64) => ebool test 3 (514, 513)', async function () {
    const res = await this.contract2.ge_euint16_euint64(
      this.instances2.alice.encrypt16(514),
      this.instances2.alice.encrypt64(513),
    );
    expect(res).to.equal(true);
  });

  it('test operator "gt" overload (euint16, euint64) => ebool test 1 (514, 66050)', async function () {
    const res = await this.contract2.gt_euint16_euint64(
      this.instances2.alice.encrypt16(514),
      this.instances2.alice.encrypt64(66050),
    );
    expect(res).to.equal(false);
  ...
  it('test operator "le" overload (euint16, euint64) => ebool test 1 (514, 66050)', async function () {
    const res = await this.contract2.le_euint16_euint64(
      this.instances2.alice.encrypt16(514),
      this.instances2.alice.encrypt64(66050),
    );
    expect(res).to.equal(true);
  ...
  it('test operator "lt" overload (euint16, euint64) => ebool test 1 (514, 66050)', async function () {
    const res = await this.contract2.lt_euint16_euint64(
      this.instances2.alice.encrypt16(514),
      this.instances2.alice.encrypt64(66050),
    );
    expect(res).to.equal(true);
  ...
  it('test operator "min" overload (euint16, euint64) => euint64 test 1 (514, 66050)', async function () {
    const res = await this.contract2.min_euint16_euint64(
      this.instances2.alice.encrypt16(514),
      this.instances2.alice.encrypt64(66050),
    );
    expect(res).to.equal(514);
  ...
  it('test operator "max" overload (euint16, euint64) => euint64 test 1 (514, 66050)', async function () {
    const res = await this.contract2.max_euint16_euint64(
      this.instances2.alice.encrypt16(514),
      this.instances2.alice.encrypt64(66050),
    );
    expect(res).to.equal(66050);
  ...
  it('test operator "min" overload (euint32, euint32) => euint32 test 1 (3280896, 3280896)', async function () {
    const res = await this.contract3.min_euint32_euint32(
      this.instances3.alice.encrypt32(3280896),
      this.instances3.alice.encrypt32(3280896),
    );
  ...
  it('test operator "min" overload (euint32, euint32) => euint32 test 2 (3280896, 3280897)', async function () {
    const res = await this.contract3.min_euint32_euint32(
      this.instances3.alice.encrypt32(3280896),
      this.instances3.alice.encrypt32(3280897),
    );
    expect(res).to.equal(3280896);
  });
  ...
  it('test operator "add" overload (euint32, euint64) => euint64 test 1 (50335779, 4099)', async function () {
    const res = await this.contract3.add_euint32_euint64(
      this.instances3.alice.encrypt32(50335779),
      this.instances3.alice.encrypt64(4099),
    );
    expect(res).to.equal(50339878);
  });

  it('test operator "sub" overload (euint32, euint64) => euint64 test 1 (50335779, 4099)', async function () {
    const res = await this.contract3.sub_euint32_euint64(
      this.instances3.alice.encrypt32(50335779),
      this.instances3.alice.encrypt64(4099),
    );
    expect(res).to.equal(50331680);
  ...
  it('test operator "mul" overload (euint32, euint64) => euint64 test 1 (50335779, 3)', async function () {
    const res = await this.contract3.mul_euint32_euint64(
      this.instances3.alice.encrypt32(50335779),
      this.instances3.alice.encrypt64(3),
    );
    expect(res).to.equal(151007337);
  });

  it('test operator "and" overload (euint32, euint64) => euint64 test 1 (50335776, 3)', async function () {
    const res = await this.contract3.and_euint32_euint64(
      this.instances3.alice.encrypt32(50335776),
      this.instances3.alice.encrypt64(3),
    );
    expect(res).to.equal(0);
  });
  ...
  it('test operator "or" overload (euint32, euint64) => euint64 test 1 (50331680, 4099)', async function () {
    const res = await this.contract3.or_euint32_euint64(
      this.instances3.alice.encrypt32(50331680),
      this.instances3.alice.encrypt64(4099),
    );
    expect(res).to.equal(50335779);
  });
  ...
  it('test operator "or" overload (euint32, euint64) => euint64 test 2 (50331683, 4099)', async function () {
    const res = await this.contract3.or_euint32_euint64(
      this.instances3.alice.encrypt32(50331683),
      this.instances3.alice.encrypt64(4099),
    );
    expect(res).to.equal(50335779);
  });
  ...
  it('test operator "xor" overload (euint32, euint64) => euint64 test 1 (50331683, 4099)', async function () {
    const res = await this.contract3.xor_euint32_euint64(
      this.instances3.alice.encrypt32(50331683),
      this.instances3.alice.encrypt64(4099),
    );
    expect(res).to.equal(50335776);
  ...
  it('test operator "eq" overload (euint32, euint64) => ebool test 1 (4096, 4096)', async function () {
    const res = await this.contract3.eq_euint32_euint64(
      this.instances3.alice.encrypt32(4096),
      this.instances3.alice.encrypt64(4096),
    );
    expect(res).to.equal(true);
  });
  ...
  it('test operator "eq" overload (euint32, euint64) => ebool test 2 (16781312, 4096)', async function () {
    const res = await this.contract3.eq_euint32_euint64(
      this.instances3.alice.encrypt32(16781312),
      this.instances3.alice.encrypt64(4096),
    );
    expect(res).to.equal(false);
  });
  ...
  it('test operator "ne" overload (euint32, euint64) => ebool test 1 (4096, 4096)', async function () {
    const res = await this.contract3.ne_euint32_euint64(
      this.instances3.alice.encrypt32(4096),
      this.instances3.alice.encrypt64(4096),
    );
    expect(res).to.equal(false);
  ...
  it('test operator "ge" overload (euint32, euint64) => ebool test 1 (4096, 4096)', async function () {
    const res = await this.contract3.ge_euint32_euint64(
      this.instances3.alice.encrypt32(4096),
      this.instances3.alice.encrypt64(4096),
    );
    expect(res).to.equal(true);
  ...
  it('test operator "ge" overload (euint32, euint64) => ebool test 3 (4096, 4097)', async function () {
    const res = await this.contract3.ge_euint32_euint64(
      this.instances3.alice.encrypt32(4096),
      this.instances3.alice.encrypt64(4097),
    );
    expect(res).to.equal(false);
  });

  it('test operator "gt" overload (euint32, euint64) => ebool test 1 (4096, 4096)', async function () {
    const res = await this.contract3.gt_euint32_euint64(
      this.instances3.alice.encrypt32(4096),
      this.instances3.alice.encrypt64(4096),
    );
    expect(res).to.equal(false);
  ...
  it('test operator "le" overload (euint32, euint64) => ebool test 1 (4096, 4096)', async function () {
    const res = await this.contract3.le_euint32_euint64(
      this.instances3.alice.encrypt32(4096),
      this.instances3.alice.encrypt64(4096),
    );
    expect(res).to.equal(true);
  ...
  it('test operator "lt" overload (euint32, euint64) => ebool test 1 (4096, 4096)', async function () {
    const res = await this.contract3.lt_euint32_euint64(
      this.instances3.alice.encrypt32(4096),
      this.instances3.alice.encrypt64(4096),
    );
    expect(res).to.equal(false);
  ...
  it('test operator "min" overload (euint32, euint64) => euint64 test 1 (4096, 4096)', async function () {
    const res = await this.contract3.min_euint32_euint64(
      this.instances3.alice.encrypt32(4096),
      this.instances3.alice.encrypt64(4096),
    );
    expect(res).to.equal(4096);
  ...
  it('test operator "max" overload (euint32, euint64) => euint64 test 1 (4096, 4096)', async function () {
    const res = await this.contract3.max_euint32_euint64(
      this.instances3.alice.encrypt32(4096),
      this.instances3.alice.encrypt64(4096),
    );
    expect(res).to.equal(4096);
  ...
  it('test operator "add" overload (euint64, euint8) => euint64 test 1 (50331648, 3)', async function () {
    const res = await this.contract3.add_euint64_euint8(
      this.instances3.alice.encrypt64(50331648),
  ...
  it('test operator "sub" overload (euint64, euint8) => euint64 test 1 (50331648, 3)', async function () {
    const res = await this.contract3.sub_euint64_euint8(
      this.instances3.alice.encrypt64(50331648),
      this.instances3.alice.encrypt8(3),
    );
    expect(res).to.equal(50331645);
  ...
  it('test operator "mul" overload (euint64, euint8) => euint64 test 1 (50331648, 3)', async function () {
    const res = await this.contract3.mul_euint64_euint8(
      this.instances3.alice.encrypt64(50331648),
      this.instances3.alice.encrypt8(3),
    );
    expect(res).to.equal(150994944);
  ...
  it('test operator "and" overload (euint64, euint8) => euint64 test 1 (50397184, 3)', async function () {
    const res = await this.contract3.and_euint64_euint8(
      this.instances3.alice.encrypt64(50397184),
      this.instances3.alice.encrypt8(3),
    );
    expect(res).to.equal(0);
  });
  ...
  it('test operator "and" overload (euint64, euint8) => euint64 test 2 (50397187, 3)', async function () {
    const res = await this.contract3.and_euint64_euint8(
      this.instances3.alice.encrypt64(50397187),
      this.instances3.alice.encrypt8(3),
    );
    expect(res).to.equal(3);
  });
  ...
  it('test operator "or" overload (euint64, euint8) => euint64 test 1 (50397184, 3)', async function () {
    const res = await this.contract3.or_euint64_euint8(
      this.instances3.alice.encrypt64(50397184),
      this.instances3.alice.encrypt8(3),
    );
    expect(res).to.equal(50397187);
  ...
  it('test operator "xor" overload (euint64, euint8) => euint64 test 1 (50397184, 3)', async function () {
    const res = await this.contract3.xor_euint64_euint8(
      this.instances3.alice.encrypt64(50397184),
      this.instances3.alice.encrypt8(3),
    );
    expect(res).to.equal(50397187);
  ...
  it('test operator "eq" overload (euint64, euint8) => ebool test 1 (3, 3)', async function () {
    const res = await this.contract3.eq_euint64_euint8(
      this.instances3.alice.encrypt64(3),
      this.instances3.alice.encrypt8(3),
    );
    expect(res).to.equal(true);
  ...
  it('test operator "eq" overload (euint64, euint8) => ebool test 2 (50331651, 3)', async function () {
    const res = await this.contract3.eq_euint64_euint8(
      this.instances3.alice.encrypt64(50331651),
      this.instances3.alice.encrypt8(3),
    );
    expect(res).to.equal(false);
  });
  ...
  it('test operator "ne" overload (euint64, euint8) => ebool test 1 (3, 3)', async function () {
    const res = await this.contract3.ne_euint64_euint8(
      this.instances3.alice.encrypt64(3),
      this.instances3.alice.encrypt8(3),
    );
    expect(res).to.equal(false);
  ...
  it('test operator "ge" overload (euint64, euint8) => ebool test 1 (3, 3)', async function () {
    const res = await this.contract3.ge_euint64_euint8(
      this.instances3.alice.encrypt64(3),
      this.instances3.alice.encrypt8(3),
    );
    expect(res).to.equal(true);
  ...
  it('test operator "gt" overload (euint64, euint8) => ebool test 1 (3, 3)', async function () {
    const res = await this.contract3.gt_euint64_euint8(
      this.instances3.alice.encrypt64(3),
      this.instances3.alice.encrypt8(3),
    );
    expect(res).to.equal(false);
  ...
  it('test operator "le" overload (euint64, euint8) => ebool test 1 (3, 3)', async function () {
    const res = await this.contract3.le_euint64_euint8(
      this.instances3.alice.encrypt64(3),
      this.instances3.alice.encrypt8(3),
    );
    expect(res).to.equal(true);
  ...
  it('test operator "lt" overload (euint64, euint8) => ebool test 1 (3, 3)', async function () {
    const res = await this.contract3.lt_euint64_euint8(
      this.instances3.alice.encrypt64(3),
      this.instances3.alice.encrypt8(3),
    );
    expect(res).to.equal(false);
  ...
  it('test operator "min" overload (euint64, euint8) => euint64 test 1 (3, 3)', async function () {
    const res = await this.contract3.min_euint64_euint8(
      this.instances3.alice.encrypt64(3),
      this.instances3.alice.encrypt8(3),
    );
    expect(res).to.equal(3);
  ...
  it('test operator "max" overload (euint64, euint8) => euint64 test 1 (2, 3)', async function () {
    const res = await this.contract3.max_euint64_euint8(
  ...
  it('test operator "add" overload (euint64, euint16) => euint64 test 1 (50335779, 4099)', async function () {
    const res = await this.contract3.add_euint64_euint16(
      this.instances3.alice.encrypt64(50335779),
      this.instances3.alice.encrypt16(4099),
    );
    expect(res).to.equal(50339878);
  });

  it('test operator "sub" overload (euint64, euint16) => euint64 test 1 (50335779, 4099)', async function () {
    const res = await this.contract3.sub_euint64_euint16(
      this.instances3.alice.encrypt64(50335779),
      this.instances3.alice.encrypt16(4099),
    );
    expect(res).to.equal(50331680);
  ...
  it('test operator "mul" overload (euint64, euint16) => euint64 test 1 (50335779, 3)', async function () {
    const res = await this.contract3.mul_euint64_euint16(
      this.instances3.alice.encrypt64(50335779),
  ...
  it('test operator "and" overload (euint64, euint16) => euint64 test 1 (50335776, 3)', async function () {
    const res = await this.contract3.and_euint64_euint16(
      this.instances3.alice.encrypt64(50335776),
      this.instances3.alice.encrypt16(3),
    );
    expect(res).to.equal(0);
  });
  ...
  it('test operator "or" overload (euint64, euint16) => euint64 test 1 (50331680, 4099)', async function () {
    const res = await this.contract3.or_euint64_euint16(
      this.instances3.alice.encrypt64(50331680),
      this.instances3.alice.encrypt16(4099),
    );
    expect(res).to.equal(50335779);
  });
  ...
  it('test operator "or" overload (euint64, euint16) => euint64 test 2 (50331683, 4099)', async function () {
    const res = await this.contract3.or_euint64_euint16(
      this.instances3.alice.encrypt64(50331683),
      this.instances3.alice.encrypt16(4099),
    );
    expect(res).to.equal(50335779);
  });
  ...
  it('test operator "xor" overload (euint64, euint16) => euint64 test 1 (50331683, 4099)', async function () {
    const res = await this.contract3.xor_euint64_euint16(
      this.instances3.alice.encrypt64(50331683),
      this.instances3.alice.encrypt16(4099),
    );
    expect(res).to.equal(50335776);
  ...
  it('test operator "eq" overload (euint64, euint16) => ebool test 1 (4096, 4096)', async function () {
    const res = await this.contract3.eq_euint64_euint16(
      this.instances3.alice.encrypt64(4096),
  ...
  it('test operator "eq" overload (euint64, euint16) => ebool test 2 (16781312, 4096)', async function () {
    const res = await this.contract3.eq_euint64_euint16(
      this.instances3.alice.encrypt64(16781312),
      this.instances3.alice.encrypt16(4096),
    );
    expect(res).to.equal(false);
  });
  ...
  it('test operator "ne" overload (euint64, euint16) => ebool test 1 (4096, 4096)', async function () {
    const res = await this.contract3.ne_euint64_euint16(
      this.instances3.alice.encrypt64(4096),
      this.instances3.alice.encrypt16(4096),
    );
    expect(res).to.equal(false);
  ...
  it('test operator "ge" overload (euint64, euint16) => ebool test 1 (4096, 4096)', async function () {
    const res = await this.contract3.ge_euint64_euint16(
      this.instances3.alice.encrypt64(4096),
      this.instances3.alice.encrypt16(4096),
    );
    expect(res).to.equal(true);
  ...
  it('test operator "ge" overload (euint64, euint16) => ebool test 3 (4096, 4097)', async function () {
    const res = await this.contract3.ge_euint64_euint16(
      this.instances3.alice.encrypt64(4096),
      this.instances3.alice.encrypt16(4097),
    );
    expect(res).to.equal(false);
  });

  it('test operator "gt" overload (euint64, euint16) => ebool test 1 (4096, 4096)', async function () {
    const res = await this.contract3.gt_euint64_euint16(
      this.instances3.alice.encrypt64(4096),
      this.instances3.alice.encrypt16(4096),
    );
    expect(res).to.equal(false);
  ...
  it('test operator "le" overload (euint64, euint16) => ebool test 1 (4096, 4096)', async function () {
    const res = await this.contract3.le_euint64_euint16(
      this.instances3.alice.encrypt64(4096),
      this.instances3.alice.encrypt16(4096),
    );
    expect(res).to.equal(true);
  ...
  it('test operator "lt" overload (euint64, euint16) => ebool test 1 (4096, 4096)', async function () {
    const res = await this.contract3.lt_euint64_euint16(
      this.instances3.alice.encrypt64(4096),
      this.instances3.alice.encrypt16(4096),
    );
    expect(res).to.equal(false);
  ...
  it('test operator "min" overload (euint64, euint16) => euint64 test 1 (4096, 4096)', async function () {
    const res = await this.contract3.min_euint64_euint16(
      this.instances3.alice.encrypt64(4096),
      this.instances3.alice.encrypt16(4096),
    );
    expect(res).to.equal(4096);
  ...
  it('test operator "max" overload (euint64, euint16) => euint64 test 1 (4096, 4096)', async function () {
    const res = await this.contract3.max_euint64_euint16(
      this.instances3.alice.encrypt64(4096),
      this.instances3.alice.encrypt16(4096),
    );
    expect(res).to.equal(4096);
  ...
  it('test operator "add" overload (euint64, euint32) => euint64 test 1 (50335779, 4099)', async function () {
    const res = await this.contract3.add_euint64_euint32(
      this.instances3.alice.encrypt64(50335779),
      this.instances3.alice.encrypt32(4099),
    );
    expect(res).to.equal(50339878);
  });

  it('test operator "sub" overload (euint64, euint32) => euint64 test 1 (50335779, 4099)', async function () {
    const res = await this.contract3.sub_euint64_euint32(
      this.instances3.alice.encrypt64(50335779),
      this.instances3.alice.encrypt32(4099),
    );
    expect(res).to.equal(50331680);
  ...
  it('test operator "mul" overload (euint64, euint32) => euint64 test 1 (50335779, 3)', async function () {
    const res = await this.contract3.mul_euint64_euint32(
      this.instances3.alice.encrypt64(50335779),
  ...
  it('test operator "and" overload (euint64, euint32) => euint64 test 1 (50335776, 3)', async function () {
    const res = await this.contract3.and_euint64_euint32(
      this.instances3.alice.encrypt64(50335776),
      this.instances3.alice.encrypt32(3),
    );
    expect(res).to.equal(0);
  ...
  it('test operator "or" overload (euint64, euint32) => euint64 test 1 (50331680, 4099)', async function () {
    const res = await this.contract3.or_euint64_euint32(
      this.instances3.alice.encrypt64(50331680),
      this.instances3.alice.encrypt32(4099),
    );
    expect(res).to.equal(50335779);
  ...
  it('test operator "xor" overload (euint64, euint32) => euint64 test 1 (50331683, 4099)', async function () {
    const res = await this.contract3.xor_euint64_euint32(
      this.instances3.alice.encrypt64(50331683),
      this.instances3.alice.encrypt32(4099),
    );
    expect(res).to.equal(50335776);
  ...
  it('test operator "eq" overload (euint64, euint32) => ebool test 1 (4096, 4096)', async function () {
    const res = await this.contract3.eq_euint64_euint32(
      this.instances3.alice.encrypt64(4096),
      this.instances3.alice.encrypt32(4096),
    );
    expect(res).to.equal(true);
  ...
  it('test operator "ne" overload (euint64, euint32) => ebool test 1 (4096, 4096)', async function () {
    const res = await this.contract3.ne_euint64_euint32(
      this.instances3.alice.encrypt64(4096),
      this.instances3.alice.encrypt32(4096),
    );
    expect(res).to.equal(false);
  ...
  it('test operator "ge" overload (euint64, euint32) => ebool test 1 (4096, 4096)', async function () {
    const res = await this.contract3.ge_euint64_euint32(
      this.instances3.alice.encrypt64(4096),
      this.instances3.alice.encrypt32(4096),
    );
    expect(res).to.equal(true);
  ...
  it('test operator "ge" overload (euint64, euint32) => ebool test 3 (4096, 4097)', async function () {
    const res = await this.contract3.ge_euint64_euint32(
      this.instances3.alice.encrypt64(4096),
      this.instances3.alice.encrypt32(4097),
    );
    expect(res).to.equal(false);
  });

  it('test operator "gt" overload (euint64, euint32) => ebool test 1 (4096, 4096)', async function () {
    const res = await this.contract3.gt_euint64_euint32(
      this.instances3.alice.encrypt64(4096),
      this.instances3.alice.encrypt32(4096),
    );
    expect(res).to.equal(false);
  ...
  it('test operator "le" overload (euint64, euint32) => ebool test 1 (4096, 4096)', async function () {
    const res = await this.contract3.le_euint64_euint32(
      this.instances3.alice.encrypt64(4096),
      this.instances3.alice.encrypt32(4096),
    );
    expect(res).to.equal(true);
  ...
  it('test operator "lt" overload (euint64, euint32) => ebool test 1 (4096, 4096)', async function () {
    const res = await this.contract3.lt_euint64_euint32(
      this.instances3.alice.encrypt64(4096),
      this.instances3.alice.encrypt32(4096),
    );
    expect(res).to.equal(false);
  ...
  it('test operator "min" overload (euint64, euint32) => euint64 test 1 (4096, 4096)', async function () {
    const res = await this.contract3.min_euint64_euint32(
      this.instances3.alice.encrypt64(4096),
      this.instances3.alice.encrypt32(4096),
    );
    expect(res).to.equal(4096);
  ...
  it('test operator "max" overload (euint64, euint32) => euint64 test 1 (4096, 4096)', async function () {
    const res = await this.contract3.max_euint64_euint32(
      this.instances3.alice.encrypt64(4096),
      this.instances3.alice.encrypt32(4096),
    );
    expect(res).to.equal(4096);
  ...
  it('test operator "add" overload (euint64, euint64) => euint64 test 1 (3280896, 1118208)', async function () {
    const res = await this.contract3.add_euint64_euint64(
      this.instances3.alice.encrypt64(3280896),
      this.instances3.alice.encrypt64(1118208),
    );
    expect(res).to.equal(4399104);
  });

  it('test operator "sub" overload (euint64, euint64) => euint64 test 1 (3280896, 1118208)', async function () {
    const res = await this.contract3.sub_euint64_euint64(
      this.instances3.alice.encrypt64(3280896),
      this.instances3.alice.encrypt64(1118208),
    );
    expect(res).to.equal(2162688);
  ...
  it('test operator "mul" overload (euint64, euint64) => euint64 test 1 (3280896, 32)', async function () {
    const res = await this.contract3.mul_euint64_euint64(
      this.instances3.alice.encrypt64(3280896),
      this.instances3.alice.encrypt64(32),
    );
    expect(res).to.equal(104988672);
  });

  it('test operator "and" overload (euint64, euint64) => euint64 test 1 (3280896, 1409286144)', async function () {
    const res = await this.contract3.and_euint64_euint64(
      this.instances3.alice.encrypt64(3280896),
      this.instances3.alice.encrypt64(1409286144),
    );
    expect(res).to.equal(0);
  });
  ...
  it('test operator "xor" overload (euint64, euint64) => euint64 test 1 (3280896, 1409286144)', async function () {
    const res = await this.contract3.xor_euint64_euint64(
      this.instances3.alice.encrypt64(3280896),
      this.instances3.alice.encrypt64(1409286144),
    );
    expect(res).to.equal(1412567040);
  ...
  it('test operator "eq" overload (euint64, euint64) => ebool test 1 (3280896, 3280896)', async function () {
    const res = await this.contract3.eq_euint64_euint64(
      this.instances3.alice.encrypt64(3280896),
      this.instances3.alice.encrypt64(3280896),
    );
    expect(res).to.equal(true);
  ...
  it('test operator "eq" overload (euint64, euint64) => ebool test 2 (3280896, 3280897)', async function () {
    const res = await this.contract3.eq_euint64_euint64(
      this.instances3.alice.encrypt64(3280896),
      this.instances3.alice.encrypt64(3280897),
    );
    expect(res).to.equal(false);
  });

  it('test operator "ne" overload (euint64, euint64) => ebool test 1 (3280896, 3280896)', async function () {
    const res = await this.contract3.ne_euint64_euint64(
      this.instances3.alice.encrypt64(3280896),
      this.instances3.alice.encrypt64(3280896),
    );
    expect(res).to.equal(false);
  ...
  it('test operator "ge" overload (euint64, euint64) => ebool test 1 (3280896, 3280896)', async function () {
    const res = await this.contract3.ge_euint64_euint64(
      this.instances3.alice.encrypt64(3280896),
      this.instances3.alice.encrypt64(3280896),
    );
    expect(res).to.equal(true);
  ...
  it('test operator "ge" overload (euint64, euint64) => ebool test 3 (3280896, 3280895)', async function () {
    const res = await this.contract3.ge_euint64_euint64(
      this.instances3.alice.encrypt64(3280896),
      this.instances3.alice.encrypt64(3280895),
    );
    expect(res).to.equal(true);
  });

  it('test operator "gt" overload (euint64, euint64) => ebool test 1 (3280896, 3280896)', async function () {
    const res = await this.contract3.gt_euint64_euint64(
      this.instances3.alice.encrypt64(3280896),
      this.instances3.alice.encrypt64(3280896),
    );
    expect(res).to.equal(false);
  ...
  it('test operator "le" overload (euint64, euint64) => ebool test 1 (3280896, 3280896)', async function () {
    const res = await this.contract3.le_euint64_euint64(
      this.instances3.alice.encrypt64(3280896),
      this.instances3.alice.encrypt64(3280896),
    );
    expect(res).to.equal(true);
  ...
  it('test operator "lt" overload (euint64, euint64) => ebool test 1 (3280896, 3280896)', async function () {
    const res = await this.contract3.lt_euint64_euint64(
      this.instances3.alice.encrypt64(3280896),
      this.instances3.alice.encrypt64(3280896),
    );
    expect(res).to.equal(false);
  ...
  it('test operator "min" overload (euint64, euint64) => euint64 test 1 (3280896, 3280896)', async function () {
    const res = await this.contract3.min_euint64_euint64(
      this.instances3.alice.encrypt64(3280896),
      this.instances3.alice.encrypt64(3280896),
    );
    expect(res).to.equal(3280896);
  ...
  it('test operator "max" overload (euint64, euint64) => euint64 test 1 (3280896, 3280896)', async function () {
    const res = await this.contract3.max_euint64_euint64(
      this.instances3.alice.encrypt64(3280896),
      this.instances3.alice.encrypt64(3280896),
    );
    expect(res).to.equal(3280896);
  ...
  it('test operator "add" overload (euint64, uint64) => euint64 test 1 (3416064, 3280896)', async function () {
    const res = await this.contract3.add_euint64_uint64(this.instances3.alice.encrypt64(3416064), 3280896);
    expect(res).to.equal(6696960);
  });

  it('test operator "add" overload (uint64, euint64) => euint64 test 1 (3416064, 3280896)', async function () {
    const res = await this.contract3.add_uint64_euint64(3416064, this.instances3.alice.encrypt64(3280896));
    expect(res).to.equal(6696960);
  });

  it('test operator "sub" overload (euint64, uint64) => euint64 test 1 (3416064, 3280896)', async function () {
    const res = await this.contract3.sub_euint64_uint64(this.instances3.alice.encrypt64(3416064), 3280896);
    expect(res).to.equal(135168);
  });

  it('test operator "sub" overload (uint64, euint64) => euint64 test 1 (3416064, 3280896)', async function () {
    const res = await this.contract3.sub_uint64_euint64(3416064, this.instances3.alice.encrypt64(3280896));
    expect(res).to.equal(135168);
  });

  it('test operator "mul" overload (euint64, uint64) => euint64 test 1 (3416064, 256)', async function () {
    const res = await this.contract4.mul_euint64_uint64(this.instances4.alice.encrypt64(3416064), 256);
    expect(res).to.equal(874512384);
  });

  it('test operator "mul" overload (uint64, euint64) => euint64 test 1 (3416064, 256)', async function () {
    const res = await this.contract4.mul_uint64_euint64(3416064, this.instances4.alice.encrypt64(256));
    expect(res).to.equal(874512384);
  });

  it('test operator "div" overload (euint64, uint64) => euint64 test 1 (3416064, 256)', async function () {
    const res = await this.contract4.div_euint64_uint64(this.instances4.alice.encrypt64(3416064), 256);
    expect(res).to.equal(13344);
  });

  it('test operator "rem" overload (euint64, uint64) => euint64 test 1 (3416121, 256)', async function () {
    const res = await this.contract4.rem_euint64_uint64(this.instances4.alice.encrypt64(3416121), 256);
    expect(res).to.equal(57);
  });

  it('test operator "eq" overload (euint64, uint64) => ebool test 1 (3416064, 3416064)', async function () {
    const res = await this.contract4.eq_euint64_uint64(this.instances4.alice.encrypt64(3416064), 3416064);
    expect(res).to.equal(true);
  });

  it('test operator "eq" overload (euint64, uint64) => ebool test 2 (3416064, 3416065)', async function () {
    const res = await this.contract4.eq_euint64_uint64(this.instances4.alice.encrypt64(3416064), 3416065);
    expect(res).to.equal(false);
  });

  it('test operator "eq" overload (uint64, euint64) => ebool test 1 (3416064, 3416064)', async function () {
    const res = await this.contract4.eq_uint64_euint64(3416064, this.instances4.alice.encrypt64(3416064));
    expect(res).to.equal(true);
  });

  it('test operator "eq" overload (uint64, euint64) => ebool test 2 (3416064, 3416065)', async function () {
    const res = await this.contract4.eq_uint64_euint64(3416064, this.instances4.alice.encrypt64(3416065));
    expect(res).to.equal(false);
  });

  it('test operator "ne" overload (euint64, uint64) => ebool test 1 (3416064, 3416064)', async function () {
    const res = await this.contract4.ne_euint64_uint64(this.instances4.alice.encrypt64(3416064), 3416064);
    expect(res).to.equal(false);
  });

  it('test operator "ne" overload (euint64, uint64) => ebool test 2 (3416064, 3416065)', async function () {
    const res = await this.contract4.ne_euint64_uint64(this.instances4.alice.encrypt64(3416064), 3416065);
    expect(res).to.equal(true);
  });

  it('test operator "ne" overload (uint64, euint64) => ebool test 1 (3416064, 3416064)', async function () {
    const res = await this.contract4.ne_uint64_euint64(3416064, this.instances4.alice.encrypt64(3416064));
    expect(res).to.equal(false);
  });

  it('test operator "ne" overload (uint64, euint64) => ebool test 2 (3416064, 3416065)', async function () {
    const res = await this.contract4.ne_uint64_euint64(3416064, this.instances4.alice.encrypt64(3416065));
    expect(res).to.equal(true);
  });

  it('test operator "ge" overload (euint64, uint64) => ebool test 1 (3416064, 3416064)', async function () {
    const res = await this.contract4.ge_euint64_uint64(this.instances4.alice.encrypt64(3416064), 3416064);
    expect(res).to.equal(true);
  });

  it('test operator "ge" overload (euint64, uint64) => ebool test 2 (3416064, 3416065)', async function () {
    const res = await this.contract4.ge_euint64_uint64(this.instances4.alice.encrypt64(3416064), 3416065);
    expect(res).to.equal(false);
  });

  it('test operator "ge" overload (euint64, uint64) => ebool test 3 (3416064, 3416063)', async function () {
    const res = await this.contract4.ge_euint64_uint64(this.instances4.alice.encrypt64(3416064), 3416063);
    expect(res).to.equal(true);
  });

  it('test operator "ge" overload (uint64, euint64) => ebool test 1 (3416064, 3416064)', async function () {
    const res = await this.contract4.ge_uint64_euint64(3416064, this.instances4.alice.encrypt64(3416064));
    expect(res).to.equal(true);
  });

  it('test operator "ge" overload (uint64, euint64) => ebool test 2 (3416064, 3416065)', async function () {
    const res = await this.contract4.ge_uint64_euint64(3416064, this.instances4.alice.encrypt64(3416065));
    expect(res).to.equal(false);
  });

  it('test operator "ge" overload (uint64, euint64) => ebool test 3 (3416064, 3416063)', async function () {
    const res = await this.contract4.ge_uint64_euint64(3416064, this.instances4.alice.encrypt64(3416063));
    expect(res).to.equal(true);
  });

  it('test operator "gt" overload (euint64, uint64) => ebool test 1 (3416064, 3416064)', async function () {
    const res = await this.contract4.gt_euint64_uint64(this.instances4.alice.encrypt64(3416064), 3416064);
    expect(res).to.equal(false);
  });

  it('test operator "gt" overload (euint64, uint64) => ebool test 2 (3416064, 3416065)', async function () {
    const res = await this.contract4.gt_euint64_uint64(this.instances4.alice.encrypt64(3416064), 3416065);
    expect(res).to.equal(false);
  });

  it('test operator "gt" overload (euint64, uint64) => ebool test 3 (3416064, 3416063)', async function () {
    const res = await this.contract4.gt_euint64_uint64(this.instances4.alice.encrypt64(3416064), 3416063);
    expect(res).to.equal(true);
  });

  it('test operator "gt" overload (uint64, euint64) => ebool test 1 (3416064, 3416064)', async function () {
    const res = await this.contract4.gt_uint64_euint64(3416064, this.instances4.alice.encrypt64(3416064));
    expect(res).to.equal(false);
  });

  it('test operator "gt" overload (uint64, euint64) => ebool test 2 (3416064, 3416065)', async function () {
    const res = await this.contract4.gt_uint64_euint64(3416064, this.instances4.alice.encrypt64(3416065));
    expect(res).to.equal(false);
  });

  it('test operator "gt" overload (uint64, euint64) => ebool test 3 (3416064, 3416063)', async function () {
    const res = await this.contract4.gt_uint64_euint64(3416064, this.instances4.alice.encrypt64(3416063));
    expect(res).to.equal(true);
  });

  it('test operator "le" overload (euint64, uint64) => ebool test 1 (3416064, 3416064)', async function () {
    const res = await this.contract4.le_euint64_uint64(this.instances4.alice.encrypt64(3416064), 3416064);
    expect(res).to.equal(true);
  });

  it('test operator "le" overload (euint64, uint64) => ebool test 2 (3416064, 3416065)', async function () {
    const res = await this.contract4.le_euint64_uint64(this.instances4.alice.encrypt64(3416064), 3416065);
    expect(res).to.equal(true);
  });

  it('test operator "le" overload (euint64, uint64) => ebool test 3 (3416064, 3416063)', async function () {
    const res = await this.contract4.le_euint64_uint64(this.instances4.alice.encrypt64(3416064), 3416063);
    expect(res).to.equal(false);
  });

  it('test operator "le" overload (uint64, euint64) => ebool test 1 (3416064, 3416064)', async function () {
    const res = await this.contract4.le_uint64_euint64(3416064, this.instances4.alice.encrypt64(3416064));
    expect(res).to.equal(true);
  });

  it('test operator "le" overload (uint64, euint64) => ebool test 2 (3416064, 3416065)', async function () {
    const res = await this.contract4.le_uint64_euint64(3416064, this.instances4.alice.encrypt64(3416065));
    expect(res).to.equal(true);
  });

  it('test operator "le" overload (uint64, euint64) => ebool test 3 (3416064, 3416063)', async function () {
    const res = await this.contract4.le_uint64_euint64(3416064, this.instances4.alice.encrypt64(3416063));
    expect(res).to.equal(false);
  });

  it('test operator "lt" overload (euint64, uint64) => ebool test 1 (3416064, 3416064)', async function () {
    const res = await this.contract4.lt_euint64_uint64(this.instances4.alice.encrypt64(3416064), 3416064);
    expect(res).to.equal(false);
  });

  it('test operator "lt" overload (euint64, uint64) => ebool test 2 (3416064, 3416065)', async function () {
    const res = await this.contract4.lt_euint64_uint64(this.instances4.alice.encrypt64(3416064), 3416065);
    expect(res).to.equal(true);
  });

  it('test operator "lt" overload (euint64, uint64) => ebool test 3 (3416064, 3416063)', async function () {
    const res = await this.contract4.lt_euint64_uint64(this.instances4.alice.encrypt64(3416064), 3416063);
    expect(res).to.equal(false);
  });

  it('test operator "lt" overload (uint64, euint64) => ebool test 1 (3416064, 3416064)', async function () {
    const res = await this.contract4.lt_uint64_euint64(3416064, this.instances4.alice.encrypt64(3416064));
    expect(res).to.equal(false);
  });

  it('test operator "lt" overload (uint64, euint64) => ebool test 2 (3416064, 3416065)', async function () {
    const res = await this.contract4.lt_uint64_euint64(3416064, this.instances4.alice.encrypt64(3416065));
    expect(res).to.equal(true);
  });

  it('test operator "lt" overload (uint64, euint64) => ebool test 3 (3416064, 3416063)', async function () {
    const res = await this.contract4.lt_uint64_euint64(3416064, this.instances4.alice.encrypt64(3416063));
    expect(res).to.equal(false);
  });

  it('test operator "min" overload (euint64, uint64) => euint64 test 1 (3416064, 3416064)', async function () {
    const res = await this.contract4.min_euint64_uint64(this.instances4.alice.encrypt64(3416064), 3416064);
    expect(res).to.equal(3416064);
  });

  it('test operator "min" overload (euint64, uint64) => euint64 test 2 (3416064, 3416065)', async function () {
    const res = await this.contract4.min_euint64_uint64(this.instances4.alice.encrypt64(3416064), 3416065);
    expect(res).to.equal(3416064);
  });

  it('test operator "min" overload (euint64, uint64) => euint64 test 3 (3416064, 3416063)', async function () {
    const res = await this.contract4.min_euint64_uint64(this.instances4.alice.encrypt64(3416064), 3416063);
    expect(res).to.equal(3416063);
  });

  it('test operator "min" overload (uint64, euint64) => euint64 test 1 (3416064, 3416064)', async function () {
    const res = await this.contract4.min_uint64_euint64(3416064, this.instances4.alice.encrypt64(3416064));
    expect(res).to.equal(3416064);
  });

  it('test operator "min" overload (uint64, euint64) => euint64 test 2 (3416064, 3416065)', async function () {
    const res = await this.contract4.min_uint64_euint64(3416064, this.instances4.alice.encrypt64(3416065));
    expect(res).to.equal(3416064);
  });

  it('test operator "min" overload (uint64, euint64) => euint64 test 3 (3416064, 3416063)', async function () {
    const res = await this.contract4.min_uint64_euint64(3416064, this.instances4.alice.encrypt64(3416063));
    expect(res).to.equal(3416063);
  });

  it('test operator "max" overload (euint64, uint64) => euint64 test 1 (3416064, 3416064)', async function () {
    const res = await this.contract4.max_euint64_uint64(this.instances4.alice.encrypt64(3416064), 3416064);
    expect(res).to.equal(3416064);
  });

  it('test operator "max" overload (euint64, uint64) => euint64 test 2 (3416064, 3416065)', async function () {
    const res = await this.contract4.max_euint64_uint64(this.instances4.alice.encrypt64(3416064), 3416065);
    expect(res).to.equal(3416065);
  });

  it('test operator "max" overload (euint64, uint64) => euint64 test 3 (3416064, 3416063)', async function () {
    const res = await this.contract4.max_euint64_uint64(this.instances4.alice.encrypt64(3416064), 3416063);
    expect(res).to.equal(3416064);
  });

  it('test operator "max" overload (uint64, euint64) => euint64 test 1 (3416064, 3416064)', async function () {
    const res = await this.contract4.max_uint64_euint64(3416064, this.instances4.alice.encrypt64(3416064));
    expect(res).to.equal(3416064);
  });

  it('test operator "max" overload (uint64, euint64) => euint64 test 2 (3416064, 3416065)', async function () {
    const res = await this.contract4.max_uint64_euint64(3416064, this.instances4.alice.encrypt64(3416065));
    expect(res).to.equal(3416065);
  });

  it('test operator "max" overload (uint64, euint64) => euint64 test 3 (3416064, 3416063)', async function () {
    const res = await this.contract4.max_uint64_euint64(3416064, this.instances4.alice.encrypt64(3416063));
    expect(res).to.equal(3416064);
  });

  it('test operator "shl" overload (euint8, euint8) => euint8 test 1 (2, 1)', async function () {
    const res = await this.contract4.shl_euint8_euint8(
  ...
  it('test operator "shl" overload (euint8, uint8) => euint8 test 1 (16, 1)', async function () {
    const res = await this.contract4.shl_euint8_uint8(this.instances4.alice.encrypt8(16), 1);
    expect(res).to.equal(32);
  });

  it('test operator "shl" overload (euint8, uint8) => euint8 test 2 (16, 2)', async function () {
    const res = await this.contract4.shl_euint8_uint8(this.instances4.alice.encrypt8(16), 2);
    expect(res).to.equal(64);
  });

  it('test operator "shr" overload (euint8, euint8) => euint8 test 1 (2, 1)', async function () {
    const res = await this.contract4.shr_euint8_euint8(
      this.instances4.alice.encrypt8(2),
      this.instances4.alice.encrypt8(1),
    );
    expect(res).to.equal(1);
  ...
  it('test operator "shr" overload (euint8, euint8) => euint8 test 2 (32, 4)', async function () {
    const res = await this.contract4.shr_euint8_euint8(
      this.instances4.alice.encrypt8(32),
      this.instances4.alice.encrypt8(4),
    );
    expect(res).to.equal(2);
  });
  ...
  it('test operator "shr" overload (euint8, uint8) => euint8 test 1 (16, 1)', async function () {
    const res = await this.contract4.shr_euint8_uint8(this.instances4.alice.encrypt8(16), 1);
    expect(res).to.equal(8);
  });

  it('test operator "shr" overload (euint8, uint8) => euint8 test 2 (16, 2)', async function () {
    const res = await this.contract4.shr_euint8_uint8(this.instances4.alice.encrypt8(16), 2);
    expect(res).to.equal(4);
  });

  it('test operator "shl" overload (euint16, euint8) => euint16 test 1 (4112, 2)', async function () {
    const res = await this.contract4.shl_euint16_euint8(
      this.instances4.alice.encrypt16(4112),
      this.instances4.alice.encrypt8(2),
    );
  ...
  it('test operator "shl" overload (euint16, uint8) => euint16 test 1 (4112, 2)', async function () {
    const res = await this.contract4.shl_euint16_uint8(this.instances4.alice.encrypt16(4112), 2);
    expect(res).to.equal(16448);
  });

  it('test operator "shr" overload (euint16, euint8) => euint16 test 1 (4112, 2)', async function () {
    const res = await this.contract4.shr_euint16_euint8(
      this.instances4.alice.encrypt16(4112),
      this.instances4.alice.encrypt8(2),
    );
  ...
  it('test operator "shr" overload (euint16, uint8) => euint16 test 1 (4112, 2)', async function () {
    const res = await this.contract4.shr_euint16_uint8(this.instances4.alice.encrypt16(4112), 2);
    expect(res).to.equal(1028);
  });

  it('test operator "shl" overload (euint32, euint8) => euint32 test 1 (50397184, 3)', async function () {
    const res = await this.contract4.shl_euint32_euint8(
  ...
  it('test operator "shl" overload (euint32, uint8) => euint32 test 1 (50397184, 3)', async function () {
    const res = await this.contract4.shl_euint32_uint8(this.instances4.alice.encrypt32(50397184), 3);
    expect(res).to.equal(403177472);
  });

  it('test operator "shr" overload (euint32, euint8) => euint32 test 1 (50397184, 3)', async function () {
    const res = await this.contract4.shr_euint32_euint8(
      this.instances4.alice.encrypt32(50397184),
      this.instances4.alice.encrypt8(3),
    );
  ...
  it('test operator "shr" overload (euint32, uint8) => euint32 test 1 (50397184, 3)', async function () {
    const res = await this.contract4.shr_euint32_uint8(this.instances4.alice.encrypt32(50397184), 3);
    expect(res).to.equal(6299648);
  });

  it('test operator "shl" overload (euint64, euint8) => euint64 test 1 (50397184, 3)', async function () {
    const res = await this.contract4.shl_euint64_euint8(
  ...
  it('test operator "shl" overload (euint64, uint8) => euint64 test 1 (50397184, 3)', async function () {
    const res = await this.contract4.shl_euint64_uint8(this.instances4.alice.encrypt64(50397184), 3);
    expect(res).to.equal(403177472);
  });

  it('test operator "shr" overload (euint64, euint8) => euint64 test 1 (50397184, 3)', async function () {
    const res = await this.contract4.shr_euint64_euint8(
      this.instances4.alice.encrypt64(50397184),
      this.instances4.alice.encrypt8(3),
    );
    expect(res).to.equal(6299648);
  ...
  it('test operator "shr" overload (euint64, uint8) => euint64 test 1 (50397184, 3)', async function () {
    const res = await this.contract4.shr_euint64_uint8(this.instances4.alice.encrypt64(50397184), 3);
    expect(res).to.equal(6299648);
  });

  it('test operator "neg" overload (euint8) => euint8 test 1 (1)', async function () {
    const res = await this.contract4.neg_euint8(this.instances4.alice.encrypt8(1));
    expect(res).to.equal(255);
  });

  it('test operator "neg" overload (euint8) => euint8 test 2 (2)', async function () {
    const res = await this.contract4.neg_euint8(this.instances4.alice.encrypt8(2));
    expect(res).to.equal(254);
  });

  it('test operator "not" overload (euint8) => euint8 test 1 (3)', async function () {
    const res = await this.contract4.not_euint8(this.instances4.alice.encrypt8(3));
    expect(res).to.equal(252);
  });

  it('test operator "neg" overload (euint16) => euint16 test 1 (1)', async function () {
    const res = await this.contract4.neg_euint16(this.instances4.alice.encrypt16(1));
    expect(res).to.equal(65535);
  });

  it('test operator "neg" overload (euint16) => euint16 test 2 (2)', async function () {
    const res = await this.contract4.neg_euint16(this.instances4.alice.encrypt16(2));
    expect(res).to.equal(65534);
  });

  it('test operator "not" overload (euint16) => euint16 test 1 (241)', async function () {
    const res = await this.contract4.not_euint16(this.instances4.alice.encrypt16(241));
    expect(res).to.equal(65294);
  });

  it('test operator "neg" overload (euint32) => euint32 test 1 (1)', async function () {
    const res = await this.contract4.neg_euint32(this.instances4.alice.encrypt32(1));
    expect(res).to.equal(4294967295);
  });

  it('test operator "neg" overload (euint32) => euint32 test 2 (2)', async function () {
    const res = await this.contract4.neg_euint32(this.instances4.alice.encrypt32(2));
  ...
  it('test operator "bin_op_sub" overload (euint8, euint8) => euint8 test 1 (4, 3)', async function () {
    const res = await this.contract4.bin_op_sub_euint8_euint8(
      this.instances4.alice.encrypt8(4),
      this.instances4.alice.encrypt8(3),
    );
    expect(res).to.equal(1);
  ...
  it('test operator "bin_op_mul" overload (euint8, euint8) => euint8 test 1 (4, 3)', async function () {
    const res = await this.contract4.bin_op_mul_euint8_euint8(
      this.instances4.alice.encrypt8(4),
      this.instances4.alice.encrypt8(3),
    );
    expect(res).to.equal(12);
  ...
  it('test operator "bin_op_and" overload (euint8, euint8) => euint8 test 1 (239, 240)', async function () {
    const res = await this.contract4.bin_op_and_euint8_euint8(
      this.instances4.alice.encrypt8(239),
  ...
  it('test operator "bin_op_or" overload (euint8, euint8) => euint8 test 1 (239, 240)', async function () {
    const res = await this.contract4.bin_op_or_euint8_euint8(
      this.instances4.alice.encrypt8(239),
      this.instances4.alice.encrypt8(240),
    );
    expect(res).to.equal(255);
  ...
  it('test operator "bin_op_xor" overload (euint8, euint8) => euint8 test 1 (239, 240)', async function () {
    const res = await this.contract4.bin_op_xor_euint8_euint8(
      this.instances4.alice.encrypt8(239),
      this.instances4.alice.encrypt8(240),
    );
  ...
  it('test operator "unary_op_neg" overload (euint8) => euint8 test 1 (2)', async function () {
    const res = await this.contract4.unary_op_neg_euint8(this.instances4.alice.encrypt8(2));
    expect(res).to.equal(254);
  });

  it('test operator "unary_op_not" overload (euint8) => euint8 test 1 (15)', async function () {
    const res = await this.contract4.unary_op_not_euint8(this.instances4.alice.encrypt8(15));
    expect(res).to.equal(240);
  });

  it('test operator "bin_op_add" overload (euint16, euint16) => euint16 test 1 (259, 516)', async function () {
    const res = await this.contract4.bin_op_add_euint16_euint16(
      this.instances4.alice.encrypt16(259),
      this.instances4.alice.encrypt16(516),
    );
    expect(res).to.equal(775);
  });

  it('test operator "bin_op_sub" overload (euint16, euint16) => euint16 test 1 (516, 259)', async function () {
    const res = await this.contract4.bin_op_sub_euint16_euint16(
      this.instances4.alice.encrypt16(516),
      this.instances4.alice.encrypt16(259),
    );
  ...
  it('test operator "bin_op_mul" overload (euint16, euint16) => euint16 test 1 (260, 3)', async function () {
    const res = await this.contract4.bin_op_mul_euint16_euint16(
      this.instances4.alice.encrypt16(260),
  ...
  it('test operator "bin_op_and" overload (euint16, euint16) => euint16 test 1 (61423, 61680)', async function () {
    const res = await this.contract4.bin_op_and_euint16_euint16(
      this.instances4.alice.encrypt16(61423),
      this.instances4.alice.encrypt16(61680),
    );
    expect(res).to.equal(57568);
  });

  it('test operator "bin_op_or" overload (euint16, euint16) => euint16 test 1 (61423, 496)', async function () {
    const res = await this.contract4.bin_op_or_euint16_euint16(
      this.instances4.alice.encrypt16(61423),
      this.instances4.alice.encrypt16(496),
    );
    expect(res).to.equal(61439);
  });

  it('test operator "bin_op_xor" overload (euint16, euint16) => euint16 test 1 (61423, 61680)', async function () {
    const res = await this.contract4.bin_op_xor_euint16_euint16(
      this.instances4.alice.encrypt16(61423),
      this.instances4.alice.encrypt16(61680),
    );
  ...
  it('test operator "unary_op_neg" overload (euint16) => euint16 test 1 (3)', async function () {
    const res = await this.contract4.unary_op_neg_euint16(this.instances4.alice.encrypt16(3));
    expect(res).to.equal(65533);
  });

  it('test operator "unary_op_not" overload (euint16) => euint16 test 1 (3855)', async function () {
    const res = await this.contract4.unary_op_not_euint16(this.instances4.alice.encrypt16(3855));
  ...
  it('test operator "bin_op_add" overload (euint32, euint32) => euint32 test 1 (1048835, 4194820)', async function () {
    const res = await this.contract4.bin_op_add_euint32_euint32(
      this.instances4.alice.encrypt32(1048835),
      this.instances4.alice.encrypt32(4194820),
    );
  ...
  it('test operator "bin_op_sub" overload (euint32, euint32) => euint32 test 1 (2415919620, 1342177539)', async function () {
    const res = await this.contract4.bin_op_sub_euint32_euint32(
      this.instances4.alice.encrypt32(2415919620),
      this.instances4.alice.encrypt32(1342177539),
    );
  ...
  it('test operator "bin_op_mul" overload (euint32, euint32) => euint32 test 1 (33554692, 3)', async function () {
    const res = await this.contract4.bin_op_mul_euint32_euint32(
      this.instances4.alice.encrypt32(33554692),
  ...
  it('test operator "bin_op_and" overload (euint32, euint32) => euint32 test 1 (4025479151, 4042322160)', async function () {
    const res = await this.contract4.bin_op_and_euint32_euint32(
      this.instances4.alice.encrypt32(4025479151),
      this.instances4.alice.encrypt32(4042322160),
    );
  ...
  it('test operator "bin_op_or" overload (euint32, euint32) => euint32 test 1 (4025479151, 32506352)', async function () {
    const res = await this.contract4.bin_op_or_euint32_euint32(
      this.instances4.alice.encrypt32(4025479151),
      this.instances4.alice.encrypt32(32506352),
    );
  ...
  it('test operator "bin_op_xor" overload (euint32, euint32) => euint32 test 1 (4025479151, 4042322160)', async function () {
    const res = await this.contract4.bin_op_xor_euint32_euint32(
      this.instances4.alice.encrypt32(4025479151),
      this.instances4.alice.encrypt32(4042322160),
    );
  ...
  it('test operator "unary_op_neg" overload (euint32) => euint32 test 1 (4)', async function () {
    const res = await this.contract4.unary_op_neg_euint32(this.instances4.alice.encrypt32(4));
    expect(res).to.equal(4294967292);
  });

  it('test operator "unary_op_not" overload (euint32) => euint32 test 1 (252645135)', async function () {
    const res = await this.contract4.unary_op_not_euint32(this.instances4.alice.encrypt32(252645135));
  ...
  it('test operator "bin_op_add" overload (euint64, euint64) => euint64 test 1 (1048835, 4194820)', async function () {
    const res = await this.contract4.bin_op_add_euint64_euint64(
      this.instances4.alice.encrypt64(1048835),
      this.instances4.alice.encrypt64(4194820),
    );
    expect(res).to.equal(5243655);
  });

  it('test operator "bin_op_sub" overload (euint64, euint64) => euint64 test 1 (2415919620, 1342177539)', async function () {
    const res = await this.contract4.bin_op_sub_euint64_euint64(
      this.instances4.alice.encrypt64(2415919620),
      this.instances4.alice.encrypt64(1342177539),
    );
    expect(res).to.equal(1073742081);
  });

  it('test operator "bin_op_mul" overload (euint64, euint64) => euint64 test 1 (33554692, 3)', async function () {
    const res = await this.contract4.bin_op_mul_euint64_euint64(
      this.instances4.alice.encrypt64(33554692),
  ...
  it('test operator "bin_op_and" overload (euint64, euint64) => euint64 test 1 (4025479151, 4042322160)', async function () {
    const res = await this.contract4.bin_op_and_euint64_euint64(
      this.instances4.alice.encrypt64(4025479151),
      this.instances4.alice.encrypt64(4042322160),
    );
    expect(res).to.equal(3772834016);
  });

  it('test operator "bin_op_or" overload (euint64, euint64) => euint64 test 1 (4025479151, 32506352)', async function () {
    const res = await this.contract4.bin_op_or_euint64_euint64(
      this.instances4.alice.encrypt64(4025479151),
      this.instances4.alice.encrypt64(32506352),
    );
    expect(res).to.equal(4026527743);
  });

  it('test operator "bin_op_xor" overload (euint64, euint64) => euint64 test 1 (4025479151, 4042322160)', async function () {
    const res = await this.contract4.bin_op_xor_euint64_euint64(
      this.instances4.alice.encrypt64(4025479151),
      this.instances4.alice.encrypt64(4042322160),
    );
    expect(res).to.equal(522133279);
  ...
  it('test operator "unary_op_neg" overload (euint64) => euint64 test 1 (4)', async function () {
    const res = await this.contract4.unary_op_neg_euint64(this.instances4.alice.encrypt64(4));
  ...
  it('test operator "unary_op_not" overload (euint64) => euint64 test 1 (252645135)', async function () {
    const res = await this.contract4.unary_op_not_euint64(this.instances4.alice.encrypt64(252645135));
