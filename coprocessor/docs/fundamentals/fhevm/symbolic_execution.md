...
Symbolic execution onchain is implemented via the [FHEVMExecutor](../../../../host-contracts/contracts/FHEVMExecutor.sol) contract. One of its main responsibilities is to deterministically generate ciphertext handles. For this, we hash the FHE operation requested and the inputs to produce the result handle H:
