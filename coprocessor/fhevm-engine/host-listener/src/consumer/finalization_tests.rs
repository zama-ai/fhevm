...
use fhevm_engine_common::{chain_id::ChainId, versioning::StackMode};
...
use crate::{
    consumer::{
        catchup::ManualCatchupArgs, ingestion::BlockIngestor, ConsumerConfig,
        STARTING_DRIFT,
    },
...
async fn ingestor(db: Database) -> BlockIngestor {
    ...
    BlockIngestor {
        ...
        last_known_drift: Arc::new(tokio::sync::RwLock::new(STARTING_DRIFT)),
    }
}
