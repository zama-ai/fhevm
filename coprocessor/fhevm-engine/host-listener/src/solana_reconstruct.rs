...
use zama_host::state::{
    ...
    computed_bound_eval_mul_div_handle, computed_bound_eval_rand_bounded_seed,
    computed_bound_eval_rand_seed, computed_bound_eval_sum_handle,
    computed_bound_eval_ternary_handle, computed_bound_eval_trivial_handle,
    computed_bound_eval_unary_handle, computed_eval_handle,
    computed_eval_is_in_handle, computed_eval_mul_div_handle,
    computed_eval_rand_bounded_seed, computed_eval_rand_seed,
...
fn compute_with_bind(
    ...
    let result = match &compute {
        ...
        SolanaHostEvent::FheUnaryOp(e) => e.result,
        SolanaHostEvent::FheSum(e) => e.result,
        SolanaHostEvent::FheIsIn(e) => e.result,
        SolanaHostEvent::FheMulDiv(e) => e.result,
...
fn map_binary_op(op: InstrBinaryOpCode) -> FheBinaryOpCode {
    match op {
        ...
        InstrBinaryOpCode::Mul => FheBinaryOpCode::Mul,
        InstrBinaryOpCode::Div => FheBinaryOpCode::Div,
        InstrBinaryOpCode::Rem => FheBinaryOpCode::Rem,
        InstrBinaryOpCode::And => FheBinaryOpCode::And,
        InstrBinaryOpCode::Or => FheBinaryOpCode::Or,
        InstrBinaryOpCode::Xor => FheBinaryOpCode::Xor,
        InstrBinaryOpCode::Shl => FheBinaryOpCode::Shl,
        InstrBinaryOpCode::Shr => FheBinaryOpCode::Shr,
        InstrBinaryOpCode::Rotl => FheBinaryOpCode::Rotl,
        InstrBinaryOpCode::Rotr => FheBinaryOpCode::Rotr,
        InstrBinaryOpCode::Eq => FheBinaryOpCode::Eq,
        InstrBinaryOpCode::Ne => FheBinaryOpCode::Ne,
        InstrBinaryOpCode::Ge => FheBinaryOpCode::Ge,
        InstrBinaryOpCode::Gt => FheBinaryOpCode::Gt,
        InstrBinaryOpCode::Le => FheBinaryOpCode::Le,
        InstrBinaryOpCode::Lt => FheBinaryOpCode::Lt,
        InstrBinaryOpCode::Min => FheBinaryOpCode::Min,
        InstrBinaryOpCode::Max => FheBinaryOpCode::Max,
    }
}
            ...
            FheEvalStep::RandBounded {
                ...
                let seed = match output {
                    FheEvalOutput::AllowedDurable {
                        ...
                        output_nonce_sequence,
                        ..
                    } => computed_bound_eval_rand_bounded_seed(
                        *upper_bound,
                        ctx.chain_id,
                        ctx.previous_bank_hash,
                        ctx.unix_timestamp,
                    ...
                    FheEvalOutput::AllowedLocal => {
                        computed_eval_rand_bounded_seed(
                            *upper_bound,
                            ctx.chain_id,
                            ctx.previous_bank_hash,
                            ctx.unix_timestamp,
    ...
    fn fhe_eval_walk_reconstructs_composite_and_unary_ops() {
        ...
        match &events[6] {
            SolanaHostEvent::FheRandBounded(e) => {
                ...
                let seed = computed_eval_rand_bounded_seed(
                    ub,
                    cx.chain_id,
                    cx.previous_bank_hash,
                    cx.unix_timestamp,
