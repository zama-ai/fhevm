...
fn build_contracts() {
    println!("cargo:rerun-if-changed=../../../gateway-contracts/contracts");
    ...
    let npm_run_status = Command::new("npx")
        .env(
            "DEPLOYER_PRIVATE_KEY",
            "0x7136d8dc72f873124f4eded25f3525a20f6cee4296564c76b44f1d582c57640f",
        )
        .args(["hardhat", "task:deployEmptyUUPSProxies"])
        .status()
