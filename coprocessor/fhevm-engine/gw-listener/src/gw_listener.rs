...
use crate::database::{insert_crs, KeyRecord, insert_key};
...
use crate::{ConfigSettings, HealthStatus, KeyId, KeyType};
    ...
    GatewayListener<P, A>
{
    ...
    async fn activate_key(
        ...
        let mut key_record = KeyRecord::default();
        key_record.key_id = key_id_bytes;
