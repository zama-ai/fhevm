...
use block_manifest::{
    ...
    DetailedRange, HistoricalRange, ManifestBlockEntry, ManifestPayload, ManifestVersion,
    SignedManifest,
};
...
fn material_manifest(publisher: Address, keyset_id: u8, ct64_digest: u8) -> AuthenticatedManifest {
    ...
    let descriptors = vec![BlockCiphertextDescriptor::computed(
        ...
        U256::from(keyset_id),
        None,
        B256::repeat_byte(ct64_digest),
        B256::repeat_byte(ct64_digest.wrapping_add(1)),
