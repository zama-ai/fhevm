    ...
    let row = sqlx::query!(
        ...
        UPDATE block_manifest_state
           SET block_content_digest = NULL,
               ...
               manifest_range_start = NULL,
               manifest_range_digest = NULL,
               manifest_revision = $4,
...
#[cfg(test)]
#[path = "publication/manifest_soak_tests.rs"]
mod soak_tests;

#[cfg(test)]
#[path = "publication/manifest_state_tests.rs"]
mod state_tests;
