...
// 2. SQL pool wait time (average measure of the connection pool), and active/idle connections.
// 3. TODO: Metric to measure the error rate (After error handling on sql.)
