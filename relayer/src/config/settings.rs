...
pub struct ListenerPoolConfig {
    ...
    /// recognised as one event, and how long an entry survives while its handlers run. The
...
/// dispatcher, or one orphaned by a former holder that died. Since step 7 it is also how a
