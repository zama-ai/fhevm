...
export interface GatewayContractUpgradedExampleInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface GatewayContractUpgradedExample extends BaseContract {
  connect(runner?: ContractRunner | null): GatewayContractUpgradedExample;
  waitForDeployment(): Promise<this>;

  interface: GatewayContractUpgradedExampleInterface;
