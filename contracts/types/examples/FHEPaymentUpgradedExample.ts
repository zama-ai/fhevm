...
export interface FHEPaymentUpgradedExampleInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface FHEPaymentUpgradedExample extends BaseContract {
  connect(runner?: ContractRunner | null): FHEPaymentUpgradedExample;
  waitForDeployment(): Promise<this>;

  interface: FHEPaymentUpgradedExampleInterface;
