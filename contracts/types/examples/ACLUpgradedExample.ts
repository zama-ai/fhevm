...
export interface ACLUpgradedExampleInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface ACLUpgradedExample extends BaseContract {
  connect(runner?: ContractRunner | null): ACLUpgradedExample;
  waitForDeployment(): Promise<this>;

  interface: ACLUpgradedExampleInterface;
