...
contract KeyManager is IKeyManager, Ownable2Step {
    ...
    mapping(uint256 preKeygenRequestId => uint256 counter) private _preKeygenResponseCounter;
    ...
    mapping(uint256 preKskgenRequestId => uint256 counter) private _preKskgenResponseCounter;
    ...
    mapping(uint256 crsgenRequestId => uint256 counter) private _crsgenResponseCounter;
