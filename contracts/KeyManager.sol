...
contract KeyManager is IKeyManager, Ownable2StepUpgradeable, UUPSUpgradeable, HttpzChecks {
    ...
    /// @custom:storage-location erc7201:httpz_gateway.storage.KeyManager
    ...
    /// @dev keccak256(abi.encode(uint256(keccak256("httpz_gateway.storage.KeyManager")) - 1)) & ~bytes32(uint256(0xff))
    bytes32 private constant KEY_MANAGER_STORAGE_LOCATION =
        0xffc36e080f83a3804864597cbf64ed4bb7db029c2482537359268813d6214200;
    ...
    function preprocessKeygenRequest(
        ...
        /// @dev https://github.com/zama-ai/httpz-gateway/issues/67
    ...
    /// @dev See {IKeyManager-fheParamsDigests}.
