...
| KMS Solana boundary                   | `cd ../kms-connector && SQLX_OFFLINE=true cargo test -p kms-worker solana -- --nocapture` | The Solana authorization pipeline as pure functions (snapshot, scope, leaf-proof read and merge, handle binding, delegation), including each public-decrypt handle proven against the store it names.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | A live chain, a live coprocessor leaf record, real relayer delivery, or full user/public-decrypt completion.                                                                                                                                                           | KMS workspace dependencies and offline SQLx metadata. Warm: focused; cold compilation can take minutes.                                                                                                                                                                                                                                |
