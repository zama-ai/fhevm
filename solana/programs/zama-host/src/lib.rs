...
pub mod zama_host {
    ...
    /// Preview-only wipe: closes the program-owned remaining accounts, rent to the upgrade authority.
    ...
    pub fn delegate_for_user_decryption(
        ...
        instructions::delegate_for_user_decryption(ctx, delegate, program, scope, expires_at)
    }
    ...
    pub fn verify_public_decrypt(
        ...
        instructions::verify_public_decrypt(ctx, handle, cleartext, signatures, extra_data, proof)
    }
}
