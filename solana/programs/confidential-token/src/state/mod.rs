...
/// Returns the mint-scoped encrypted store authority PDA for the encrypted total supply.
...
pub fn total_supply_slot(mint: Pubkey) -> (StoreId, [u8; 32]) {
    token_slot(
        mint,
