...
pub(crate) const DISCLOSURE_PROOF_V2_DOMAIN_SEPARATOR: &[u8] =
    b"zama-confidential-token-disclosure-v2";
pub(crate) const REDEMPTION_PROOF_V2_DOMAIN_SEPARATOR: &[u8] =
    b"zama-confidential-token-redemption-v2";
