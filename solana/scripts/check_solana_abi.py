...
PINNED_SCHEMAS = [
    ...
    ("zama_host", "account", "VerifierSet", True),
    ...
    ("zama_host", "type", "SolanaInputProof", True),
    ("zama_host", "type", "FheEvalArgs", True),
    ("zama_host", "instruction_args", "create_verifier_set", True),
    ("zama_host", "instruction_args", "disable_verifier_set", True),
    ("zama_host", "instruction_args", "initialize_host_config", True),
    ("zama_host", "instruction_args", "verify_input_and_bind", True),
    ...
    ("confidential_token", "account", "TransferCallbackSettlement", True),
    ...
    ("confidential_token", "instruction_args", "disclose_amount", True),
    ("confidential_token", "instruction_args", "disclose_balance", True),
    ...
    ("confidential_token", "instruction_args", "migrate_mint_verifier_sets", True),
    ...
    ("confidential_token", "instruction_args", "update_mint_verifier_sets", True),
