...
# Writes: runtime-tests/cost-snapshots/{host,token,vault,batcher,delegation}_mollusk.json
...
echo "updated: runtime-tests/cost-snapshots/delegation_mollusk.json"
