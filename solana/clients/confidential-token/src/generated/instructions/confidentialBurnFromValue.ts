...
export const CONFIDENTIAL_BURN_FROM_VALUE_DISCRIMINATOR: ReadonlyUint8Array = new Uint8Array([
  28, 103, 140, 245, 220, 114, 34, 179,
]);

export function getConfidentialBurnFromValueDiscriminatorBytes(): ReadonlyUint8Array {
  return fixEncoderSize(getBytesEncoder(), 8).encode(CONFIDENTIAL_BURN_FROM_VALUE_DISCRIMINATOR);
}

export type ConfidentialBurnFromValueInstruction<
...
export type ConfidentialBurnFromValueInstructionData = {
  discriminator: ReadonlyUint8Array;
  key: ReadonlyUint8Array;
};

export type ConfidentialBurnFromValueInstructionDataArgs = {
  key: ReadonlyUint8Array;
};

export function getConfidentialBurnFromValueInstructionDataEncoder(): FixedSizeEncoder<ConfidentialBurnFromValueInstructionDataArgs> {
  return transformEncoder(
    ...
    (value) => ({
      ...value,
      discriminator: CONFIDENTIAL_BURN_FROM_VALUE_DISCRIMINATOR,
    }),
  );
}

export function getConfidentialBurnFromValueInstructionDataDecoder(): FixedSizeDecoder<ConfidentialBurnFromValueInstructionData> {
...
export function getConfidentialBurnFromValueInstructionDataCodec(): FixedSizeCodec<
  ConfidentialBurnFromValueInstructionDataArgs,
  ConfidentialBurnFromValueInstructionData
> {
  return combineCodec(
    getConfidentialBurnFromValueInstructionDataEncoder(),
    getConfidentialBurnFromValueInstructionDataDecoder(),
  );
}
...
> {
  ...
  return Object.freeze({
    ...
    data: getConfidentialBurnFromValueInstructionDataEncoder().encode(
      args as ConfidentialBurnFromValueInstructionDataArgs,
    ),
    programAddress,
...
export type ParsedConfidentialBurnFromValueInstruction<
  TProgram extends string = typeof CONFIDENTIAL_TOKEN_PROGRAM_ADDRESS,
...
> = {
  ...
  accounts: {
     ...
     * authorizing through `invoke_signed`), or when it is one of the burner's own token values.
     */
    amountStore: TAccountMetas[10];
    zamaEventAuthority: TAccountMetas[11];
    transientStore: TAccountMetas[12];
  ...
  data: ConfidentialBurnFromValueInstructionData;
};

export function parseConfidentialBurnFromValueInstruction<
  TProgram extends string,
  TAccountMetas extends readonly AccountMeta[],
>(
  instruction: Instruction<TProgram> & InstructionWithAccounts<TAccountMetas> & InstructionWithData<ReadonlyUint8Array>,
): ParsedConfidentialBurnFromValueInstruction<TProgram, TAccountMetas> {
  ...
  return {
    ...
    data: getConfidentialBurnFromValueInstructionDataDecoder().decode(instruction.data),
  };
}
