...
export type ClaimInstruction<
  ...
  TAccountUserPayoutBalanceStore extends string | AccountMeta<string> = string,
  ...
  InstructionWithAccounts<
    [
      ...
      TAccountBatchAuthorityPayoutAta extends string
        ? ReadonlyAccount<TAccountBatchAuthorityPayoutAta>
        : TAccountBatchAuthorityPayoutAta,
      TAccountUserPayoutAta extends string ? ReadonlyAccount<TAccountUserPayoutAta> : TAccountUserPayoutAta,
      ...
      TAccountUserPayoutBalanceStore extends string
        ? WritableAccount<TAccountUserPayoutBalanceStore>
...
> {
  ...
  return Object.freeze({
    accounts: [
      ...
      getAccountMeta('userPayoutBalanceStore', accounts.userPayoutBalanceStore),
...
> = {
  ...
  accounts: {
    ...
    batchPayoutBalanceStore: TAccountMetas[15];
    userPayoutBalanceStore: TAccountMetas[16];
...
export function parseClaimInstruction<TProgram extends string, TAccountMetas extends readonly AccountMeta[]>(
  ...
  return {
    ...
    accounts: {
      ...
      userPayoutBalanceStore: getNextAccount(),
