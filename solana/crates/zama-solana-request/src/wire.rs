...
//! encrypted value account, and the only way to learn them is to read and validate that
...
//!     encrypted_value_account: vec![0; 32],
...
pub struct SolanaHandleEntryWire {
    ...
    /// Claimed 32-byte address of the encrypted value account the handle lives in.
    pub encrypted_value_account: Vec<u8>,
}
