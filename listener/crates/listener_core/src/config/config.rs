...
pub struct DatabaseConfig {
    #[derivative(Debug(format_with = "redact"))]
    pub db_url: String, // REQUIRED, REDACTED
...
mod tests {
    ...
    fn test_strategy_config_defaults() {
        ...
        assert_eq!(config.block_start, 0);
    ...
    #[test]
    fn test_broker_type_default_is_amqp() {
        assert_eq!(BrokerType::default(), BrokerType::Amqp);
    }
