...
impl Default for FetchConfig {
    fn default() -> Self {
        Self {
            ...
            verify_block: false,
            verify_block_allow_skipping: true,
...
impl EvmBlockFetcher {
    ...
    /// Set the chain ID for metric labels.
    ...
    fn build_fetched_block(
        ...
        if self.config.verify_block {
            ...
            EvmBlockComputer::verify_block(
                &block,
                &receipts_ordered,
                self.config.verify_block_allow_skipping,
