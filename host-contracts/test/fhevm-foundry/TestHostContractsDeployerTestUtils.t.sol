...
contract TestHostContractsDeployerTestUtils is HostContractsDeployerTestUtils {
    ...
    function test_DeployProtocolConfig_UsesProxyUpgradeFlow() public {
        ...
        nodes[0] = KmsNode({txSenderAddress: address(0x1111), signerAddress: address(0x2222), ipAddress: "127.0.0.1", storageUrl: "https://s0.example.com"});
        nodes[1] = KmsNode({txSenderAddress: address(0x3333), signerAddress: address(0x4444), ipAddress: "127.0.0.2", storageUrl: "https://s1.example.com"});
        IProtocolConfig.KmsThresholds memory thresholds = IProtocolConfig.KmsThresholds({decryptionThreshold: 1, kmsGenThreshold: 1});
        ...
        assertEq(pcProxy.getDecryptionThreshold(), 1, "Decryption threshold mismatch");
