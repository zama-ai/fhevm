...
describe('FHEVM operations 13', function () {
  ...
  it('test operator "not" overload (euint256) => euint256 test 1 (115792089237316195423570985008687907853269984665640564039457583351452827741945)', async function () {
    const input = this.instances.alice.createEncryptedInput(this.contract7Address, this.signers.alice.address);
    input.add256(115792089237316195423570985008687907853269984665640564039457583351452827741945n);
    ...
    expect(res).to.equal(656460301897990n);
  });
});
