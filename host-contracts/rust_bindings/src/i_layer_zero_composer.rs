...
See the [wrapper's documentation](`ILayerZeroComposerInstance`) for more details.*/
    ...
    >(
        ...
        ILayerZeroComposerInstance::<P, N>::new(address, __provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    > {
        ILayerZeroComposerInstance::<P, N>::deploy(__provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(__provider: P) -> alloy_contract::RawCallBuilder<P, N> {
        ILayerZeroComposerInstance::<P, N>::deploy_builder(__provider)
    }
