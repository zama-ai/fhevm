...
pub mod Ownable2StepUpgradeable {
    ...
    impl alloy_sol_types::SolInterface for Ownable2StepUpgradeableCalls {
        ...
        fn abi_decode_raw(selector: [u8; 4], data: &[u8]) -> alloy_sol_types::Result<Self> {
            static DECODE_SHIMS: &[fn(
                ...
                {
                    fn owner(data: &[u8]) -> alloy_sol_types::Result<Ownable2StepUpgradeableCalls> {
            ...
            static DECODE_SHIMS: &[fn(
                ...
                -> alloy_sol_types::Result<Ownable2StepUpgradeableErrors>] = &[
                {
                    ...
                    ) -> alloy_sol_types::Result<Ownable2StepUpgradeableErrors>
                    {
                        ...
                        .map(Ownable2StepUpgradeableErrors::OwnableUnauthorizedAccount)
                    }
    ...
    #[derive(Clone)]
    pub struct Ownable2StepUpgradeableInstance<P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
