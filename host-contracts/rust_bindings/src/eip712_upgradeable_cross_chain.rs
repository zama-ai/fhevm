...
pub mod EIP712UpgradeableCrossChain {
    ...
    impl alloy_sol_types::SolInterface for EIP712UpgradeableCrossChainCalls {
        ...
        fn abi_decode_raw(selector: [u8; 4], data: &[u8]) -> alloy_sol_types::Result<Self> {
            static DECODE_SHIMS: &[fn(
                ...
                EIP712UpgradeableCrossChainCalls,
            >] = &[{
                fn eip712Domain(
                    data: &[u8],
    ...
    impl alloy_sol_types::SolInterface for EIP712UpgradeableCrossChainErrors {
        ...
        fn abi_decode_raw(selector: [u8; 4], data: &[u8]) -> alloy_sol_types::Result<Self> {
            static DECODE_SHIMS: &[fn(
                ...
                EIP712UpgradeableCrossChainErrors,
            >] = &[
                {
                    fn NotInitializing(
                        data: &[u8],
                ...
                },
                {
                    ...
                    ) -> alloy_sol_types::Result<EIP712UpgradeableCrossChainErrors>
                    {
                        <InvalidInitialization as alloy_sol_types::SolError>::abi_decode_raw(data)
                            .map(EIP712UpgradeableCrossChainErrors::InvalidInitialization)
                    }
    ...
    >(
        ...
        EIP712UpgradeableCrossChainInstance::<P, N>::new(address, __provider)
    }
    ...
    > {
        EIP712UpgradeableCrossChainInstance::<P, N>::deploy(__provider)
    }
    ...
    >(
        ...
        EIP712UpgradeableCrossChainInstance::<P, N>::deploy_builder(__provider)
    }
    ...
    #[derive(Clone)]
    pub struct EIP712UpgradeableCrossChainInstance<P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
