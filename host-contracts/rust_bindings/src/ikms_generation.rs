...
interface IKMSGeneration {
    ...
    event PrepKeygenRequest(uint256 prepKeygenId, ParamsType paramsType, KeygenRequestKind requestKind, uint256 keyId, bytes extraData);
    ...
    function migrationResponse(uint256 migrationRequestId, KeyDigest[] memory keyDigests, bytes memory signature) external;
...
```*/
    ...
    pub struct KeygenRequest {
        ...
        #[allow(missing_docs)]
        pub requestKind: <KeygenRequestKind as alloy::sol_types::SolType>::RustType,
        #[allow(missing_docs)]
        pub keyId: alloy::sol_types::private::primitives::aliases::U256,
        #[allow(missing_docs)]
        pub extraData: alloy::sol_types::private::Bytes,
        ...
        impl alloy_sol_types::SolEvent for KeygenRequest {
            ...
            fn tokenize_body(&self) -> Self::DataToken<'_> {
                (
                    ...
                    <KeygenRequestKind as alloy_sol_types::SolType>::tokenize(
                        &self.requestKind,
                    ),
                    <alloy::sol_types::sol_data::Uint<
                        256,
...
```*/
    ...
    pub struct getAllKeyMaterialsReturn {
        ...
        pub _0: alloy::sol_types::private::Vec<
            <KeyMaterial as alloy::sol_types::SolType>::RustType,
        >,
    }
    #[allow(
        non_camel_case_types,
    ...
    const _: () = {
        ...
        }
        {
            #[doc(hidden)]
            type UnderlyingSolTuple<'a> = (
                alloy::sol_types::sol_data::Array<KeyMaterial>,
            );
            #[doc(hidden)]
            type UnderlyingRustTuple<'a> = (
                alloy::sol_types::private::Vec<
        ...
        impl alloy_sol_types::SolCall for getAllKeyMaterialsCall {
            ...
            type Return = alloy::sol_types::private::Vec<
                <KeyMaterial as alloy::sol_types::SolType>::RustType,
            >;
            type ReturnTuple<'a> = (alloy::sol_types::sol_data::Array<KeyMaterial>,);
            type ReturnToken<'a> = <Self::ReturnTuple<
                'a,
            > as alloy_sol_types::SolType>::Token<'a>;
                ...
                },
                {
                    fn migrateKey(
                        ...
                        <migrateKeyCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IKMSGenerationCalls::migrateKey)
                    }
                    migrateKey
                },
                {
                    fn migrationResponse(
                        ...
                        <migrationResponseCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IKMSGenerationCalls::migrationResponse)
                    }
                    migrationResponse
                },
                {
                    fn getAllKeyMaterials(
                        ...
                        <getAllKeyMaterialsCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IKMSGenerationCalls::getAllKeyMaterials)
                    }
                    getAllKeyMaterials
                },
                {
