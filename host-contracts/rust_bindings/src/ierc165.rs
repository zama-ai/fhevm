...
pub mod IERC165 {
    ...
    impl alloy_sol_types::SolInterface for IERC165Calls {
        ...
        fn abi_decode_raw(selector: [u8; 4], data: &[u8]) -> alloy_sol_types::Result<Self> {
            static DECODE_SHIMS: &[fn(&[u8]) -> alloy_sol_types::Result<IERC165Calls>] = &[{
                fn supportsInterface(data: &[u8]) -> alloy_sol_types::Result<IERC165Calls> {
        ...
        fn abi_decode_raw_validate(
            ...
            static DECODE_VALIDATE_SHIMS: &[fn(&[u8]) -> alloy_sol_types::Result<IERC165Calls>] = &[
                {
                    fn supportsInterface(data: &[u8]) -> alloy_sol_types::Result<IERC165Calls> {
    ...
    pub fn deploy<P: alloy_contract::private::Provider<N>, N: alloy_contract::private::Network>(
        provider: P,
    ) -> impl ::core::future::Future<Output = alloy_contract::Result<IERC165Instance<P, N>>> {
        ...
        IERC165Instance<P, N>
    {
        ...
        For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        #[inline]
        pub async fn deploy(provider: P) -> alloy_contract::Result<IERC165Instance<P, N>> {
