...
pub mod PausableUpgradeable {
    ...
    impl alloy_sol_types::SolInterface for PausableUpgradeableCalls {
        ...
        fn abi_decode_raw(selector: [u8; 4], data: &[u8]) -> alloy_sol_types::Result<Self> {
            static DECODE_SHIMS: &[fn(
                ...
                fn paused(data: &[u8]) -> alloy_sol_types::Result<PausableUpgradeableCalls> {
    ...
    >(
        ...
        PausableUpgradeableInstance::<P, N>::new(address, __provider)
    }
    ...
    pub fn deploy<P: alloy_contract::private::Provider<N>, N: alloy_contract::private::Network>(
        __provider: P,
    ) -> impl ::core::future::Future<Output = alloy_contract::Result<PausableUpgradeableInstance<P, N>>>
    {
        PausableUpgradeableInstance::<P, N>::deploy(__provider)
    }
    ...
    >(
        ...
        PausableUpgradeableInstance::<P, N>::deploy_builder(__provider)
    }
    ...
    impl<P, N> ::core::fmt::Debug for PausableUpgradeableInstance<P, N> {
        ...
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("PausableUpgradeableInstance")
                .field(&self.address)
                .finish()
        }
    }
