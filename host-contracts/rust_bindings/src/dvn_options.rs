...
```*/
    ...
    const _: () = {
        ...
        #[doc(hidden)]
        impl ::core::convert::From<DVN_InvalidDVNIdx> for UnderlyingRustTuple<'_> {
            fn from(value: DVN_InvalidDVNIdx) -> Self {
                ()
            }
        }
        #[automatically_derived]
        #[doc(hidden)]
        impl ::core::convert::From<UnderlyingRustTuple<'_>> for DVN_InvalidDVNIdx {
...
```*/
    ...
    pub struct DVN_InvalidDVNOptions {
        #[allow(missing_docs)]
        pub cursor: alloy::sol_types::private::primitives::aliases::U256,
    }
    #[allow(
        non_camel_case_types,
        non_snake_case,
    ...
    const _: () = {
        ...
        #[automatically_derived]
        #[doc(hidden)]
        impl ::core::convert::From<DVN_InvalidDVNOptions> for UnderlyingRustTuple<'_> {
            fn from(value: DVN_InvalidDVNOptions) -> Self {
                (value.cursor,)
            }
        }
        #[automatically_derived]
        #[doc(hidden)]
        impl ::core::convert::From<UnderlyingRustTuple<'_>> for DVN_InvalidDVNOptions {
            fn from(tuple: UnderlyingRustTuple<'_>) -> Self {
                Self { cursor: tuple.0 }
            }
        }
    ...
    pub enum DVNOptionsErrors {
        ...
        #[allow(missing_docs)]
        DVN_InvalidDVNOptions(DVN_InvalidDVNOptions),
    }
    impl DVNOptionsErrors {
        ...
        pub const VARIANT_NAMES: &'static [&'static str] = &[
            ::core::stringify!(DVN_InvalidDVNOptions),
            ::core::stringify!(DVN_InvalidDVNIdx),
        ];
        /// The signatures in the same order as `SELECTORS`.
        pub const SIGNATURES: &'static [&'static str] = &[
            <DVN_InvalidDVNOptions as alloy_sol_types::SolError>::SIGNATURE,
            <DVN_InvalidDVNIdx as alloy_sol_types::SolError>::SIGNATURE,
        ];
    ...
    impl alloy_sol_types::SolInterface for DVNOptionsErrors {
        const NAME: &'static str = "DVNOptionsErrors";
        const MIN_DATA_LENGTH: usize = 0usize;
        const COUNT: usize = 2usize;
        #[inline]
        fn selector(&self) -> [u8; 4] {
            match self {
                Self::DVN_InvalidDVNIdx(_) => {
                    <DVN_InvalidDVNIdx as alloy_sol_types::SolError>::SELECTOR
                }
                Self::DVN_InvalidDVNOptions(_) => {
                    <DVN_InvalidDVNOptions as alloy_sol_types::SolError>::SELECTOR
                }
            }
        }
        #[inline]
            ...
            static DECODE_SHIMS: &[fn(
            ...
            ) -> alloy_sol_types::Result<DVNOptionsErrors>] = &[
                {
                    fn DVN_InvalidDVNOptions(
                        ...
                        <DVN_InvalidDVNOptions as alloy_sol_types::SolError>::abi_decode_raw_with_config(
                                data,
                                config,
                            )
                ...
                },
                {
                    fn DVN_InvalidDVNIdx(
                        ...
                        <DVN_InvalidDVNIdx as alloy_sol_types::SolError>::abi_decode_raw_with_config(
                                data,
                                config,
                            )
    ...
    #[automatically_derived]
    impl DVNOptionsErrors {
        /**Creates a [`DVN_InvalidDVNIdx`] error.

```solidity
error DVN_InvalidDVNIdx()
```*/
        #[inline]
        pub fn dvn_invalid_dvn_idx() -> Self {
            Self::DVN_InvalidDVNIdx(DVN_InvalidDVNIdx)
        }
        /**Creates a [`DVN_InvalidDVNOptions`] error.

```solidity
error DVN_InvalidDVNOptions(uint256)
```*/
        #[inline]
        pub fn dvn_invalid_dvn_options(
            cursor: alloy::sol_types::private::primitives::aliases::U256,
        ) -> Self {
            Self::DVN_InvalidDVNOptions(DVN_InvalidDVNOptions {
                cursor: cursor,
            })
        }
    }
...
See the [wrapper's documentation](`DVNOptionsInstance`) for more details.*/
    ...
    >(
        ...
        DVNOptionsInstance::<P, N>::new(address, __provider)
    }
...
See the [wrapper's documentation](`DVNOptionsInstance`) for more details.*/
    ...
    impl<P: ::core::clone::Clone, N> DVNOptionsInstance<&P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> DVNOptionsInstance<P, N> {
            DVNOptionsInstance {
