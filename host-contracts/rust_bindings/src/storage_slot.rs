...
pub mod StorageSlot {
    ...
    pub fn deploy<P: alloy_contract::private::Provider<N>, N: alloy_contract::private::Network>(
        __provider: P,
    ) -> impl ::core::future::Future<Output = alloy_contract::Result<StorageSlotInstance<P, N>>>
    {
    ...
    impl<P, N> ::core::fmt::Debug for StorageSlotInstance<P, N> {
        ...
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("StorageSlotInstance")
                .field(&self.address)
                .finish()
        }
    }
        ...
        StorageSlotInstance<P, N>
    {
        ...
        For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        #[inline]
        pub async fn deploy(__provider: P) -> alloy_contract::Result<StorageSlotInstance<P, N>> {
