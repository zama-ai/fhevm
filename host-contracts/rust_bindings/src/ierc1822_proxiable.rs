...
pub mod IERC1822Proxiable {
    ...
    impl IERC1822ProxiableCalls {
        ...
        pub const VARIANT_NAMES: &'static [&'static str] = &[::core::stringify!(proxiableUUID)];
    ...
    impl alloy_sol_types::SolInterface for IERC1822ProxiableCalls {
        ...
        fn abi_decode_raw(selector: [u8; 4], data: &[u8]) -> alloy_sol_types::Result<Self> {
            static DECODE_SHIMS: &[fn(&[u8]) -> alloy_sol_types::Result<IERC1822ProxiableCalls>] =
                &[{
                    fn proxiableUUID(
                        data: &[u8],
        ...
        fn abi_decode_raw_validate(
            ...
            static DECODE_VALIDATE_SHIMS: &[fn(
                ...
                IERC1822ProxiableCalls,
            >] = &[{
                fn proxiableUUID(data: &[u8]) -> alloy_sol_types::Result<IERC1822ProxiableCalls> {
                    <proxiableUUIDCall as alloy_sol_types::SolCall>::abi_decode_raw_validate(data)
                        .map(IERC1822ProxiableCalls::proxiableUUID)
                }
                proxiableUUID
            }];
    ...
    pub fn deploy<P: alloy_contract::private::Provider<N>, N: alloy_contract::private::Network>(
        __provider: P,
    ) -> impl ::core::future::Future<Output = alloy_contract::Result<IERC1822ProxiableInstance<P, N>>>
    {
    ...
    impl<P, N> ::core::fmt::Debug for IERC1822ProxiableInstance<P, N> {
        ...
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("IERC1822ProxiableInstance")
                .field(&self.address)
                .finish()
        }
    }
