...
pub mod IInputVerifier {
    ...
    impl IInputVerifierCalls {
        ...
        pub const SELECTORS: &'static [[u8; 4usize]] = &[[230u8, 49u8, 125u8, 245u8]];
        /// The names of the variants in the same order as `SELECTORS`.
        pub const VARIANT_NAMES: &'static [&'static str] = &[::core::stringify!(verifyInput)];
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for IInputVerifierCalls {
        const NAME: &'static str = "IInputVerifierCalls";
    ...
    >(
        ...
        IInputVerifierInstance::<P, N>::new(address, __provider)
    }
    ...
    {
        IInputVerifierInstance::<P, N>::deploy(__provider)
    }
    ...
    >(
        ...
        IInputVerifierInstance::<P, N>::deploy_builder(__provider)
    }
        ...
        IInputVerifierInstance<P, N>
    {
        ...
        For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        #[inline]
        pub async fn deploy(__provider: P) -> alloy_contract::Result<IInputVerifierInstance<P, N>> {
    ...
    impl<P: ::core::clone::Clone, N> IInputVerifierInstance<&P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> IInputVerifierInstance<P, N> {
            IInputVerifierInstance {
                address: self.address,
                provider: ::core::clone::Clone::clone(&self.provider),
                _network: ::core::marker::PhantomData,
            }
