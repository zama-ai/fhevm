...
```*/
            ...
            static DECODE_SHIMS: &[fn(
                ...
                },
                {
                    fn SafeERC20FailedDecreaseAllowance(
                        ...
                        <SafeERC20FailedDecreaseAllowance as alloy_sol_types::SolError>::abi_decode_raw_with_config(
                                data,
                                config,
                            )
    ...
    #[automatically_derived]
    impl SafeERC20Errors {
        /**Creates a [`SafeERC20FailedDecreaseAllowance`] error.

```solidity
error SafeERC20FailedDecreaseAllowance(address,uint256,uint256)
```*/
        #[inline]
        pub fn safe_erc_20_failed_decrease_allowance(
            spender: alloy::sol_types::private::Address,
            current_allowance: alloy::sol_types::private::primitives::aliases::U256,
            requested_decrease: alloy::sol_types::private::primitives::aliases::U256,
        ) -> Self {
            Self::SafeERC20FailedDecreaseAllowance(SafeERC20FailedDecreaseAllowance {
                spender: spender,
