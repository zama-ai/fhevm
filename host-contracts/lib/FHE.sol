...
library FHE {
    ...
    function sum(euint8[] memory values) internal returns (euint8) {
        bytes32[] memory handles = new bytes32[](values.length == 0 ? 1 : values.length);
        if (values.length == 0) {
            handles[0] = euint8.unwrap(asEuint8(0));
        } else {
    ...
    function sum(euint16[] memory values) internal returns (euint16) {
        bytes32[] memory handles = new bytes32[](values.length == 0 ? 1 : values.length);
        if (values.length == 0) {
            handles[0] = euint16.unwrap(asEuint16(0));
        } else {
            for (uint256 i = 0; i < values.length; i++) {
                euint16 v = values[i];
    ...
    function sum(euint32[] memory values) internal returns (euint32) {
        bytes32[] memory handles = new bytes32[](values.length == 0 ? 1 : values.length);
        if (values.length == 0) {
            handles[0] = euint32.unwrap(asEuint32(0));
        } else {
            for (uint256 i = 0; i < values.length; i++) {
                euint32 v = values[i];
    ...
    function sum(euint64[] memory values) internal returns (euint64) {
        bytes32[] memory handles = new bytes32[](values.length == 0 ? 1 : values.length);
        if (values.length == 0) {
            handles[0] = euint64.unwrap(asEuint64(0));
        } else {
            for (uint256 i = 0; i < values.length; i++) {
                euint64 v = values[i];
    ...
    function sum(euint128[] memory values) internal returns (euint128) {
        bytes32[] memory handles = new bytes32[](values.length == 0 ? 1 : values.length);
        if (values.length == 0) {
            handles[0] = euint128.unwrap(asEuint128(0));
        } else {
            for (uint256 i = 0; i < values.length; i++) {
                euint128 v = values[i];
