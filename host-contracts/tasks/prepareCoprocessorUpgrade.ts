...
import { requireProtocolConfigAddress, resolveProtocolConfigAddress } from './kmsContext';
import {
  bufferViolations,
...
task(
  ...
  .addParam('softwareVersion', 'Coprocessor software version string (e.g. v0.15.0)')
  .addOptionalParam(
