...
interface IProtocolConfigMultichain is IProtocolConfigCommon {
     ...
     */
    event MirroredPublicDecryptionThreshold(uint256 indexed contextId, uint256 threshold);
     ...
     */
    event MirroredUserDecryptionThreshold(uint256 indexed contextId, uint256 threshold);
     ...
     */
    event MirroredKmsGenThreshold(uint256 indexed contextId, uint256 threshold);
     ...
     */
    event MirroredMpcThreshold(uint256 indexed contextId, uint256 threshold);
     ...
     * @param sourceProtocolConfig The canonical `ProtocolConfig` address.
     */
    event MirroredKmsContextDestroyed(
        uint256 indexed contextId,
        uint256 indexed sourceChainId,
        uint256 sourceBlockNumber,
        address indexed sourceProtocolConfig
