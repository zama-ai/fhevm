    ...
    <>
      {items.map((item) => {
        ...
        if (!foundPlan || !foundPrice) {
          return (
            <div key={planId} className="price--tile">
              <div className="plan--content">
                ...
                <p className="text-muted">
                  ...
                  <code>{priceId}</code> exists in your list of plans.
                </p>
              </div>
            </div>
          );
...
SubDisplay.propTypes = {
  sub: PropTypes.shape({
    ...
    current_period_start: PropTypes.string.isRequired,
    current_period_end: PropTypes.string.isRequired,
