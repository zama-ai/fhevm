...
export type SignInMutation = { __typename?: 'Mutation', login: { __typename?: 'auth', token: string, user: { __typename?: 'User', id: string, email: string, teams: Array<{ __typename?: 'Team', id: string }> } } };
