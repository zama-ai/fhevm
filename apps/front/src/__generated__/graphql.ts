...
export type GetDappDetailsQuery = { __typename?: 'Query', dapp: { __typename?: 'Dapp', id: string, name: string, status: DappStatus, stats: Array<{ __typename?: 'RawStats', id: string, name: string, timestamp: number, externalRef: string }> } };
