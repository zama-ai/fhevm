...
export type GetDappDetailsQuery = { __typename?: 'Query', dapp: { __typename?: 'Dapp', id: string, name: string, status: DappStatus, rawStats: Array<{ __typename?: 'RawStats', id: string, name: string, timestamp: number, externalRef: string }>, stats: { __typename?: 'DappStats', id: string, cumulative: { __typename?: 'CumulativeDappStats', total: number, FheAdd: number, FheBitAnd: number, FheIfThenElse: number, FheLe: number, FheOr: number, FheSub: number, TrivialEncrypt: number, VerifyCiphertext: number, FheMul: number, FheDiv: number }, byDay: Array<{ __typename?: 'DailyDappStats', id: string, day: string, cumulative: { __typename?: 'CumulativeDappStats', total: number } }> } } };
...
export type DappUpdatedSubscription = { __typename?: 'Subscription', dappUpdated: { __typename?: 'Dapp', id: string, name: string, status: DappStatus, rawStats: Array<{ __typename?: 'RawStats', id: string, name: string, timestamp: number, externalRef: string }>, stats: { __typename?: 'DappStats', id: string, cumulative: { __typename?: 'CumulativeDappStats', total: number, FheAdd: number, FheBitAnd: number, FheIfThenElse: number, FheLe: number, FheOr: number, FheSub: number, TrivialEncrypt: number, VerifyCiphertext: number, FheMul: number, FheDiv: number }, byDay: Array<{ __typename?: 'DailyDappStats', id: string, day: string, cumulative: { __typename?: 'CumulativeDappStats', total: number, FheAdd: number, FheBitAnd: number, FheIfThenElse: number, FheLe: number, FheOr: number, FheSub: number, TrivialEncrypt: number, VerifyCiphertext: number, FheMul: number, FheDiv: number } }> } } };
