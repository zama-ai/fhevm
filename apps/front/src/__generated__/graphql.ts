...
export type DailyDappStats = {
  ...
  fhe: Scalars['Int']['output'];
  /** The id of the day */
  id: Scalars['ID']['output'];
  symbolic: Scalars['Int']['output'];
  total: Scalars['Int']['output'];
};
