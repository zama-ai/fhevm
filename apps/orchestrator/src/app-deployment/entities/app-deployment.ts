...
import { AppDeploymentEvents, completed } from './app-deployment.events';
import {
  AppDeploymentCommands,
  confirmSM,
  discoverSM,
  registerSM,
} from './app-deployment.commands';

export type AppDeploymentMessage = AppDeploymentCommands | AppDeploymentEvents;
...
export class AppDeployment {
  ...
  notify(event: AppDeploymentEvents): AppDeploymentMessage[] {
