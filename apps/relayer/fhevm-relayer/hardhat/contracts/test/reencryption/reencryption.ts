...
describe('Reencryption', function () {
  ...
  it('test reencrypt ebool', async function () {
    ...
    expect(decryptedValue[0]).to.equal(1);
  });
  ...
  it('test reencrypt euint8', async function () {
    ...
    expect(decryptedValue[0]).to.equal(42);
  });
  ...
  it('test reencrypt euint16', async function () {
    ...
    expect(decryptedValue[0]).to.equal(16);
  });
  ...
  it('test reencrypt euint32', async function () {
    ...
    expect(decryptedValue[0]).to.equal(32);
  });
  ...
  it('test reencrypt euint64', async function () {
    ...
    expect(decryptedValue[0]).to.equal(18446744073709551600n);
  });
  ...
  it('test reencrypt euint128', async function () {
    ...
    expect(decryptedValue[0]).to.equal(145275933516363203950142179850024740765n);
  });
  ...
  it('test reencrypt eaddress', async function () {
    ...
    expect(decryptedValue[0]).to.equal(BigInt('0x8ba1f109551bD432803012645Ac136ddd64DBA72'));
  });
  ...
  it('test reencrypt euint256', async function () {
    ...
    expect(decryptedValue[0]).to.equal(74285495974541385002137713624115238327312291047062397922780925695323480915729n);
  });
  ...
  it('test reencrypt ebytes64', async function () {
    ...
    expect(decryptedValue[0]).to.equal(
      BigInt(
