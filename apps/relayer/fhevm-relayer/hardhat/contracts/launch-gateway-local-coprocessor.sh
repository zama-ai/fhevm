...
npx hardhat task:deployHttpz --private-key "$PRIVATE_KEY_FHEVM_DEPLOYER" --network localCoprocessorL2
npx hardhat task:deployZkPoKManager --private-key "$PRIVATE_KEY_FHEVM_DEPLOYER" --network localCoprocessorL2
