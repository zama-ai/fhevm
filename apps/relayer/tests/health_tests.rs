...
/// Checks gateway_rpc, gateway_websocket, and database dependencies.
#[rstest]
#[tokio::test]
async fn test_health_endpoint_all_healthy() {
    ...
    assert!(dependencies.contains_key("gateway_rpc"));
    assert!(dependencies.contains_key("gateway_websocket"));
