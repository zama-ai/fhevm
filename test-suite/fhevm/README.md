...
| `rollouts/v0.13-to-v0.14/run.ts`                        | `two-of-three-multi-chain` | v0.13.2 → v0.14 in the documented component order, with the mandatory kms-core PRSS bridge stop and the canonical ProtocolConfig mirror across two host chains. |
