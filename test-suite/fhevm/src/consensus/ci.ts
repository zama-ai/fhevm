...
export const CI_STACK_LEGS = ["byte-agreement", "bridge", "backlog", "object-integrity", "host-rpc", "broker-redelivery", "storage-pressure", "submission-partition", "cpu-scheduling", "degraded", "fork", "crash-retry", "failure-matrix", "failure-matrix-db"] as const;
