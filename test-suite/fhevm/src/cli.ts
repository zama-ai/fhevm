...
const upCommandDefinition = {
  args: {
    ...
    local: { type: "boolean", description: "Compatibility alias for local workspace execution; Bun runtime already runs locally by default." },
    solana: { type: "boolean", description: "Boot the Solana-host stack using the Bun runtime." },
    "multi-chain": { type: "boolean", description: "Boot the mixed EVM + Solana host stack using the Bun runtime." },
