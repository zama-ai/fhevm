...
const TEST_PROFILE_DESCRIPTIONS: Partial<Record<(typeof TEST_PROFILE_NAMES)[number], string>> = {
  ...
  "erc1271-user-decryption": "Run ERC-1271 smart-account signature verification coverage (RFC-012).",
  "unified-user-decryption": "Run unified EIP-712 user decryption coverage: allowedContracts modes, mixed direct+delegated batches (RFC-016).",
  "decryption-signature-invalidation": "Run on-chain decryption-signature invalidation coverage (RFC-016).",
