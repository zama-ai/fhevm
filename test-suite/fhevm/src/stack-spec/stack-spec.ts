...
export type StackSpec = {
  ...
  kmsMigrationByNodeId?: State["kmsMigrationByNodeId"];
...
const stackSpecFromResolved = (input: {
  ...
  if (input.scenario.kind === "blue-green") {
    ...
    return {
      ...
      kmsMigrationByNodeId: input.kmsMigrationByNodeId,
...
export const stackSpecForState = (
  state: Pick<State, "requiresGitHub" | "target" | "versions" | "kmsCoreVersionByNodeId" | "kmsMigrationByNodeId" | "kmsConnectorDeploymentByNodeId" | "overrides" | "e2ePublicRuntime" | "scenario">,
): StackSpec =>
