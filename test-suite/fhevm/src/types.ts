...
/**
 * KMS core version to boot with so the key material is generated by a release the pinned Blue
 * coprocessor can read. Once the operators have ingested it, `up` upgrades the core to the
