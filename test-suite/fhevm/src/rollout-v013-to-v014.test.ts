...
test("keeps the kms-core PRSS bridge as a mandatory stop between 0.13.x and 0.14", () => {
  // The baseline core must stay on the tfhe 1.5.4 side of the serialization break: it mints
  // the key material the whole rollout runs on, and relayer-sdk 0.4.4 cannot deserialize a
  // public key generated by a tfhe 1.6 core (kms-core v0.13.20-0 and later).
  expect(phaseVersions.baseline.CORE_VERSION).toBe("v0.13.11");
