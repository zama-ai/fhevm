...
contract FHEVMTestSuite7 is E2EFHEVMConfig {
    ...
    function rand_euint16(bytes calldata inputProof) public {
        euint16 result = FHE.randeuint16();
    ...
    function rand_euint8(bytes calldata inputProof) public {
        euint8 result = FHE.randeuint8();
    ...
    function rand_euint256(bytes calldata inputProof) public {
        euint256 result = FHE.randeuint256();
    ...
    function rand_euint64(bytes calldata inputProof) public {
        euint64 result = FHE.randeuint64();
