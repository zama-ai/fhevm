...
contract DelegateUserDecryptDelegator is E2ECoprocessorConfig {
    ...
    function delegateUserDecryption(address delegate, address delegateContractAddress) public {
        FHE.allow(xBool, delegateContractAddress);
        FHE.allow(xUint8, delegateContractAddress);
        FHE.allow(xUint16, delegateContractAddress);
    ...
    function revokeUserDecryptionDelegation(address delegate, address delegateContractAddress) public {
