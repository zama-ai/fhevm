...
import type {
  OFTAdapter,
  OFTAdapterInterface,
} from "../../../../@layerzerolabs/oft-evm/contracts/OFTAdapter";
...
export class OFTAdapter__factory {
  ...
  static createInterface(): OFTAdapterInterface {
    return new Interface(_abi) as OFTAdapterInterface;
  }
  static connect(address: string, runner?: ContractRunner | null): OFTAdapter {
    return new Contract(address, _abi, runner) as unknown as OFTAdapter;
  }
}
