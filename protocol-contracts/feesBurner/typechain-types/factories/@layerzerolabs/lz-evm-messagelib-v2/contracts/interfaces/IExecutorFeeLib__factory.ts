...
import type {
  IExecutorFeeLib,
  IExecutorFeeLibInterface,
} from "../../../../../@layerzerolabs/lz-evm-messagelib-v2/contracts/interfaces/IExecutorFeeLib";
...
export class IExecutorFeeLib__factory {
  static readonly abi = _abi;
  static createInterface(): IExecutorFeeLibInterface {
    return new Interface(_abi) as IExecutorFeeLibInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): IExecutorFeeLib {
    return new Contract(address, _abi, runner) as unknown as IExecutorFeeLib;
  }
}
