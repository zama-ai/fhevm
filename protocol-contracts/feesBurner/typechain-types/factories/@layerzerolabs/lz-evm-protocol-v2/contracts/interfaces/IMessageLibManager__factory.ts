...
} from "../../../../../@layerzerolabs/lz-evm-protocol-v2/contracts/interfaces/IMessageLibManager";
...
export class IMessageLibManager__factory {
  ...
  static createInterface(): IMessageLibManagerInterface {
    return new Interface(_abi) as IMessageLibManagerInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): IMessageLibManager {
    return new Contract(address, _abi, runner) as unknown as IMessageLibManager;
  }
}
