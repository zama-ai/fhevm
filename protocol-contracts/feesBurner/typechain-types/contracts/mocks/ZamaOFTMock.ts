...
export interface ZamaOFTMockInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "SEND"
      | "SEND_AND_CALL"
...
export interface ZamaOFTMock extends BaseContract {
  connect(runner?: ContractRunner | null): ZamaOFTMock;
  waitForDeployment(): Promise<this>;

  interface: ZamaOFTMockInterface;
