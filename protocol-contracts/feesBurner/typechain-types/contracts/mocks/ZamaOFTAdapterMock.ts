...
export interface ZamaOFTAdapterMockInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "SEND"
      | "SEND_AND_CALL"
...
export interface ZamaOFTAdapterMock extends BaseContract {
  connect(runner?: ContractRunner | null): ZamaOFTAdapterMock;
  waitForDeployment(): Promise<this>;

  interface: ZamaOFTAdapterMockInterface;
