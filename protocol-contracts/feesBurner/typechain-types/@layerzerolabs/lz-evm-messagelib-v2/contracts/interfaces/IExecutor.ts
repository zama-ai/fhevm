...
export declare namespace IExecutor {
  ...
  export type NativeDropParamsStructOutput = [
    receiver: string,
    amount: bigint
...
export namespace DstConfigSetEvent {
  export type InputTuple = [params: IExecutor.DstConfigParamStruct[]];
  export type OutputTuple = [params: IExecutor.DstConfigParamStructOutput[]];
...
export namespace NativeDropAppliedEvent {
  export type InputTuple = [
    ...
    dstEid: BigNumberish,
    oapp: AddressLike,
    params: IExecutor.NativeDropParamsStruct[],
    success: boolean[]
  ];
...
export interface IExecutor extends BaseContract {
  ...
  "assignJob(uint32,address,uint256,bytes)": TypedContractMethod<
    [
  ...
  "assignJob(address,bytes)": TypedContractMethod<
    [_sender: AddressLike, _options: BytesLike],
    [bigint],
    "nonpayable"
  >;
  ...
  "getFee(uint32,address,uint256,bytes)": TypedContractMethod<
    [
      _dstEid: BigNumberish,
      _sender: AddressLike,
      _calldataSize: BigNumberish,
  ...
  "getFee(address,bytes)": TypedContractMethod<
    [_sender: AddressLike, _options: BytesLike],
    [bigint],
    "view"
  >;
  ...
  getFunction(
    nameOrSignature: "assignJob(uint32,address,uint256,bytes)"
  ): TypedContractMethod<
    [
      _dstEid: BigNumberish,
      _sender: AddressLike,
  ...
  >;
  getFunction(
    nameOrSignature: "assignJob(address,bytes)"
  ): TypedContractMethod<
    [_sender: AddressLike, _options: BytesLike],
    [bigint],
    "nonpayable"
  ...
  >;
  getFunction(
    nameOrSignature: "getFee(uint32,address,uint256,bytes)"
  ): TypedContractMethod<
    [
      _dstEid: BigNumberish,
      _sender: AddressLike,
  ...
  >;
  getFunction(
    nameOrSignature: "getFee(address,bytes)"
  ): TypedContractMethod<
    [_sender: AddressLike, _options: BytesLike],
    [bigint],
    "view"
  ...
  getEvent(
    ...
    DstConfigSetEvent.InputTuple,
    DstConfigSetEvent.OutputTuple,
    DstConfigSetEvent.OutputObject
  >;
  getEvent(
  ...
  filters: {
    "DstConfigSet(tuple[])": TypedContractEvent<
      DstConfigSetEvent.InputTuple,
      DstConfigSetEvent.OutputTuple,
      DstConfigSetEvent.OutputObject
    >;
    DstConfigSet: TypedContractEvent<
      DstConfigSetEvent.InputTuple,
      DstConfigSetEvent.OutputTuple,
      DstConfigSetEvent.OutputObject
    >;

    "NativeDropApplied(tuple,uint32,address,tuple[],bool[])": TypedContractEvent<
      NativeDropAppliedEvent.InputTuple,
      NativeDropAppliedEvent.OutputTuple,
      NativeDropAppliedEvent.OutputObject
    >;
