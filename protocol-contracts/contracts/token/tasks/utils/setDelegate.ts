...
export interface SetDelegateProps {
    address: string
    fromDeployment: boolean
    contractAddress?: string
}

export const setDelegateAction = async (
    contractName: string,
    ...
    console.log(`Setting delegate to ${address} on ${contractName} ${deploymentAddress} using signer ${signer.address}`)
