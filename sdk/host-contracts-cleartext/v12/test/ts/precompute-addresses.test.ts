 ...
 *
 * The fourth copy of this ordering (pkg/ts/addresses.ts HOST_NONCE_OFFSET, internal/constants.ts
 * NONCE_OFFSET, and pkg/forge/script/ComputeAddresses.s.sol are the others) — but the only one that is an assertion rather
...
const LAYOUT = {
  ...
  hcuLimitAddress: 6n,
  cleartextArithmeticAddress: 7n,
  cleartextDbAddress: 8n,
  pauserSetAddress: 9n,
} as const;
...
const LOCALHOST_ADDRESSES: Readonly<Record<keyof typeof LAYOUT, string>> = {
  ...
  // Verified with `cast compute-address <deployer> --nonce {7,8,9}`. The pre-split v12 package's own
  // committed PAUSER_SET_ADDRESS is the nonce-9 value, which is a second source for this shift.
  cleartextArithmeticAddress: '0x44aA028fd264C76BF4A8f8B4d8A5272f6AE25CAc',
  cleartextDbAddress: '0x216be43148dB537BeddBC268163deb1a802b5553',
