...
// `compute` stage, reads the manifest it seals, and requires every role in it to agree. This
// generation has no `ProtocolConfig` or `KMSGeneration`, so its seal carries eleven rather than thirteen.
//
