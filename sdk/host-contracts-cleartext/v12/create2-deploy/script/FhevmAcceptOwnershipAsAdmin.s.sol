 ...
 *         ends the deployment.
 *
 * There is no step F in the plan. The step sequence stops at E and the terminal conditions describes this only as prose — "the admin
 ...
 * is a multisig — which is the case the terminal conditions is really written for — nobody runs this: the multisig
 ...
 * The owner — which is what makes the terminal conditions's "no dangling pendingOwner" condition satisfiable at all. A
