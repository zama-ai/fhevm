...
(`sdk/host-contracts-cleartext/v12`).
...
```json
{
  ...
  "deploymentId": "cleartext-v12-sepolia-2026-08",
  "outDir": ".out-cleartext-v12-sepolia-2026-08",
  "confirmations": 3
}
```
...
```
📋  report  cleartext-v12-sepolia-2026-08
  chain      11155111
  deployer   0x1111…
  admin      0x2222…
...
```sh
$D --deployment-id cleartext-v12-sepolia-2026-09 \
   --out-dir .out-cleartext-v12-sepolia-2026-09 --stage compute
```
...
```
sdk/host-contracts-cleartext/v12/foundry.toml
```
