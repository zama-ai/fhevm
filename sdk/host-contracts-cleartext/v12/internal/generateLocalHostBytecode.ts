...
function _render(
  ...
  // Named apart and documented in the header, because the two blobs are otherwise indistinguishable by
  // eye and land in the same file that DeployLocalStack.s.sol imports.
