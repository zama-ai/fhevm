...
FHEVM host contracts cleartext Solidity contracts. This is generation **v13** of the FHEVM protocol, published as `@fhevm/host-contracts-cleartext@0.13.0`:
the version's minor number is the protocol generation, so pin it with a caret (`^0.13.0`) to stay on this generation.
...
```sh
npm install @fhevm/host-contracts-cleartext@^0.13.0
```
