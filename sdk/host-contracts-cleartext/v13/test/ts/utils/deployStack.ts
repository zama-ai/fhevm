// Deploys a full cleartext v13 stack onto an already-running anvil node, then prints the addresses.
//
...
async function main(): Promise<void> {
  ...
  const rows: ReadonlyArray<readonly [string, string]> = [
    ...
    ['ProtocolConfig', deployed.fhevmAddresses.protocolConfigAddress],
    ['KMSGeneration', deployed.fhevmAddresses.kmsGenerationAddress],
  ...
  console.log('');
  console.log('  cleartext v13 stack deployed');
