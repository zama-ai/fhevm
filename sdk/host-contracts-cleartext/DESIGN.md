...
> `sdk/host-contracts-cleartext-v12` and `-v13` sit in this repo only for ease of development.
> They are destined for the corresponding previous release branches of the fhevm repo; this
> directory (`host-contracts-cleartext`) is the current version (v0.14).
