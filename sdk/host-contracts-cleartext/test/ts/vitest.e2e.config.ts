...
// The e2e test consumes BOTH published packages: v13 (to deploy the "before" stack) and v14 (to upgrade).
for (const pkg of ['host-contracts-cleartext', 'host-contracts-cleartext-v13']) {
