...
import type { AddressReplacement, ContractUpgradeSpec, DeployedImplementation, UpgradeTarget } from './private.js';
import type {
...
export type FhevmAddressAllocationV13 = {
...
export function precomputeFhevmAddressesV13(parameters: {
  readonly ethUtils: AbstractEthereumUtils;
  readonly from: `0x${string}`;
  readonly startNonce: bigint;
...
export async function deployEmptyProxiesV13(parameters: {
  readonly ethProvider: AbstractEthereumProvider;
  readonly ethUtils: AbstractEthereumUtils;
  readonly deployer: AbstractEthereumSigner;
 ...
 */
export function kmsVerifierInitArgsV13(config: {
  readonly verifyingContractSource: string;
  readonly chainIDSource: bigint;
}): readonly unknown[] {
 ...
 */
export async function buildUpdateV12ToV13Plan(parameters: {
  readonly ethUtils: AbstractEthereumUtils;
  readonly deployer: AbstractEthereumSigner;
  readonly fhevmAddresses: FhevmAddressesV13;
  readonly pauserSetAddress: string;
 ...
 */
function buildHostAddressReplacementsV13(parameters: {
  readonly fhevmAddresses: FhevmAddressesV13;
  readonly pauserSetAddress: string;
