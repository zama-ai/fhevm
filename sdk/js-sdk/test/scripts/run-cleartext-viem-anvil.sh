...
#   4. Run only test/fheTest/cleartext-viem.
...
TEST_TARGET="test/fheTest/cleartext-viem"
...
################################################################################
#
# Run cleartext-viem tests
#
################################################################################

echo "🧪 Running cleartext-viem tests..."
(
    cd "$JS_SDK_DIR"
    CHAIN=localhost npx vitest run --config test/fheTest/vitest.config.ts "$TEST_TARGET"
)

echo "✅ cleartext-viem tests passed."
