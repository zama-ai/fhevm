...
// Mirrors test/multi-wasm/support/localstack.ts — same restart script, same
// idempotent "already running? just verify" behavior. Kept as a separate copy
// (not a shared import) because the two test projects intentionally don't
// depend on each other; ports the pattern, not the module.
