...
import { DiagnosticsView } from './_diag/diagnostics.jsx';
...
export default function Page() {
  ...
  return <DiagnosticsView title="Packed SDK Next.js smoke test" status={diagnostics.status} logs={diagnostics.logs} />;
}
