...
import type { FhevmChainName } from "./const"
import type { DecryptType } from "./decrypt"
...
export const testnetUserHandlesMirror: UserDecryptHandles = {
    ...
    uint128: {
        clear: ["325251480655372520175462643345601539450n"],
        handle: [
    ...
    mixed: {
        clear: [
            "false",
            "225",
            "325251480655372520175462643345601539450n",
