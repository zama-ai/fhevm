...
// localhost:
// ----------
// CHAIN=localhost npx vitest run --config test/fheTest/vitest.config.ts cleartext-ethers/clientDecrypt.delegateDecrypt.test.ts
//
////////////////////////////////////////////////////////////////////////////////
...
async function delegateForUserDecryption(parameters: {
  ...
  const aclContract = new Contract(parameters.aclAddress, ACL_DELEGATE_ABI, parameters.delegatorSigner);
...
async function getUserDecryptionDelegationExpirationDate(parameters: {
  ...
  const aclContract = new Contract(parameters.aclAddress, ACL_DELEGATE_ABI, parameters.provider);
