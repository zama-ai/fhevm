...
// localhost:
// ----------
// CHAIN=localhost npx vitest run --config test/fheTest/vitest.config.ts viem-cleartext/clientDecrypt.decrypt.test.ts
//
////////////////////////////////////////////////////////////////////////////////
...
describe.runIf(isV2(getViemTestConfig().chainName))('Decrypt client — user decrypt', () => {
