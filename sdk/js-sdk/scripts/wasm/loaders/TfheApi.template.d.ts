...
export type {
  ...
  ZkComputeLoad,
} from '../../../src/wasm/tfhe/v1.5.3/tfhe.js';

/** The subset you actually use - the runtime contract callers depend on. */
export interface TfheLibApi {
  initAsync: typeof import('../../../src/wasm/tfhe/v1.5.3/tfhe.js').initAsync;

  // --- Free functions used by encrypt/init-p.ts -----------------------------
  init_panic_hook: typeof import('../../../src/wasm/tfhe/v1.5.3/tfhe.js').init_panic_hook;
  initThreadPool: typeof import('../../../src/wasm/tfhe/v1.5.3/tfhe.js').initThreadPool;
  setWorkerUrlConfig: typeof import('../../../src/wasm/tfhe/v1.5.3/tfhe.js').setWorkerUrlConfig;
  getWasmInfo: typeof import('../../../src/wasm/tfhe/v1.5.3/tfhe.js').getWasmInfo;
  ...
  CompactCiphertextList: typeof import('../../../src/wasm/tfhe/v1.5.3/tfhe.js').CompactCiphertextList;
  CompactPkeCrs: typeof import('../../../src/wasm/tfhe/v1.5.3/tfhe.js').CompactPkeCrs;
  ProvenCompactCiphertextList: typeof import('../../../src/wasm/tfhe/v1.5.3/tfhe.js').ProvenCompactCiphertextList;
  TfheCompactPublicKey: typeof import('../../../src/wasm/tfhe/v1.5.3/tfhe.js').TfheCompactPublicKey;

  // --- Enum used as a value (e.g. ZkComputeLoad.Verify) ---------------------
  ZkComputeLoad: typeof import('../../../src/wasm/tfhe/v1.5.3/tfhe.js').ZkComputeLoad;
}

export type TfheVersion = '1.5.3';
