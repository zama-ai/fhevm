...
// Shared opaque types from tfhe. We pick v1.8.1 as the canonical source.
...
export type {
  ...
  ZkComputeLoad,
} from '../../../src/wasm/tfhe/v1.8.1/tfhe.js';

/** The subset you actually use - the runtime contract callers depend on. */
export interface TfheLibApi {
  initAsync: typeof import('../../../src/wasm/tfhe/v1.8.1/tfhe.js').initAsync;

  // --- Free functions used by encrypt/init-p.ts -----------------------------
  init_panic_hook: typeof import('../../../src/wasm/tfhe/v1.8.1/tfhe.js').init_panic_hook;
  initThreadPool: typeof import('../../../src/wasm/tfhe/v1.8.1/tfhe.js').initThreadPool;
  setWorkerUrlConfig: typeof import('../../../src/wasm/tfhe/v1.8.1/tfhe.js').setWorkerUrlConfig;
  getWasmInfo: typeof import('../../../src/wasm/tfhe/v1.8.1/tfhe.js').getWasmInfo;
  ...
  CompactCiphertextList: typeof import('../../../src/wasm/tfhe/v1.8.1/tfhe.js').CompactCiphertextList;
  CompactPkeCrs: typeof import('../../../src/wasm/tfhe/v1.8.1/tfhe.js').CompactPkeCrs;
  ProvenCompactCiphertextList: typeof import('../../../src/wasm/tfhe/v1.8.1/tfhe.js').ProvenCompactCiphertextList;
  TfheCompactPublicKey: typeof import('../../../src/wasm/tfhe/v1.8.1/tfhe.js').TfheCompactPublicKey;

  // --- Enum used as a value (e.g. ZkComputeLoad.Verify) ---------------------
  ZkComputeLoad: typeof import('../../../src/wasm/tfhe/v1.8.1/tfhe.js').ZkComputeLoad;
}

// Default version
export type TfheVersion = '1.8.1';
