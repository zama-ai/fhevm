...
const input = join(dir, `../src/wasm/tfhe/tfhe-worker.${version}.mjs`);
const output = join(dir, `../src/wasm/tfhe/tfhe-worker.${version}.inline.js`);
...
writeFileSync(
  output,
  `// Auto-generated — do not edit. Run: node scripts/tfhe-worker.v1.6.0.inline.build.mjs
// SHA-256: ${sha256}
