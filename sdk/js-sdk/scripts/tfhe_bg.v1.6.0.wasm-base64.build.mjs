...
const wasmPath = join(dir, `../src/wasm/tfhe/tfhe_bg.${version}.wasm`);
const outPath = join(dir, `../src/wasm/tfhe/tfhe_bg.${version}.wasm.base64.js`);
...
writeFileSync(
  outPath,
  `// Auto-generated — do not edit. Run: node scripts/tfhe_bg.v1.6.0.wasm-base64.build.mjs
// SHA-256: ${sha256}
