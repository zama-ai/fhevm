...
Definitions:
- fhevmClient = 1 fhevmRuntime + 1 chain-provider/client ( 1 viem client+chain or 1 viem provider+chain)
...
Option A: use 'Client' suffix : ok for Viem because there is a notion of Client, not ok for viem, because the term is provider
