...
import type {
  FetchGlobalFhePkeParamsSourceParameters,
  FetchGlobalFhePkeParamsSourceReturnType,
  RelayerClient,
} from "../types.js";
...
export async function fetchGlobalFhePkeParamsSource(
  relayerClient: RelayerClient,
  parameters: FetchGlobalFhePkeParamsSourceParameters,
): Promise<FetchGlobalFhePkeParamsSourceReturnType> {
  const options = parameters.options as RelayerKeyUrlOptions | undefined;
