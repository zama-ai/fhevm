...
import init_tfhe_lib from '../../../../wasm/tfhe/tfhe.v1.6.0.js';
import { init_panic_hook, initThreadPool, setWorkerUrlConfig, getWasmInfo } from '../../../../wasm/tfhe/tfhe.v1.6.0.js';
...
function dynamicImportWasmBase64(): Promise<{
  ...
  return import('../../../../wasm/tfhe/tfhe_bg.v1.6.0.wasm.base64.js');
}

const TFHE_WORKER_JS_FILENAME = 'tfhe-worker.v1.6.0.mjs';
const TFHE_BG_WASM_FILENAME = 'tfhe_bg.v1.6.0.wasm';
