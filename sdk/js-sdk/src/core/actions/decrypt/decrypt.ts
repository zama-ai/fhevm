...
import type { ClearValue, EncryptedValueLike } from '../../types/encryptedTypes.js';
...
export async function decrypt(
  ...
  const orderedDecryptedHandles: readonly ClearValue[] = await decryptKmsSignedcryptedShares(fhevm, {
