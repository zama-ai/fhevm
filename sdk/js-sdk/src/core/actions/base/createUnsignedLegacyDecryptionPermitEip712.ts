...
import { createUnsignedDecryptionPermitEip712V1 as _createUnsignedDecryptionPermitEip712V1 } from '../../kms/SignedDecryptionPermitV1-p.js';
...
export async function createUnsignedLegacyDecryptionPermitEip712(
  ...
  return _createUnsignedDecryptionPermitEip712V1(fhevm, parameters);
}
