 ...
 */
export function process_user_decryption_resp_solana_from_js(request: any, solana_user_pubkey: Uint8Array, host_chain_id: bigint, agg_resp: any, enc_pk: PublicEncKeyMlKem512, enc_sk: PrivateEncKeyMlKem512): TypedPlaintext[];
...
export interface InitOutput {
    ...
    readonly process_user_decryption_resp_solana_from_js: (a: any, b: number, c: number, d: bigint, e: any, f: number, g: number) => [number, number, number, number];
