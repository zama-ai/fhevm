...
export type {
  ...
  ServerIdAddr,
  TypedPlaintext,
} from './v0.15.0-0/kms_lib.js';

/** The subset you actually use - the runtime contract callers depend on. */
export interface KmsLibApi {
  initAsync: typeof import('./v0.15.0-0/kms_lib.js').initAsync;
  getWasmInfo: typeof import('./v0.15.0-0/kms_lib.js').getWasmInfo;

  ml_kem_pke_keygen: typeof import('./v0.15.0-0/kms_lib.js').ml_kem_pke_keygen;
  ml_kem_pke_get_pk: typeof import('./v0.15.0-0/kms_lib.js').ml_kem_pke_get_pk;
  ml_kem_pke_pk_to_u8vec: typeof import('./v0.15.0-0/kms_lib.js').ml_kem_pke_pk_to_u8vec;
  new_server_id_addr: typeof import('./v0.15.0-0/kms_lib.js').new_server_id_addr;
  new_client: typeof import('./v0.15.0-0/kms_lib.js').new_client;
  process_user_decryption_resp_from_js: typeof import('./v0.15.0-0/kms_lib.js').process_user_decryption_resp_from_js;
  ml_kem_pke_sk_to_u8vec: typeof import('./v0.15.0-0/kms_lib.js').ml_kem_pke_sk_to_u8vec;
  u8vec_to_ml_kem_pke_sk: typeof import('./v0.15.0-0/kms_lib.js').u8vec_to_ml_kem_pke_sk;
}
