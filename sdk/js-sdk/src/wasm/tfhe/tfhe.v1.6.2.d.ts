...
// Custom additions — re-exported from startWorkers.v1.6.2.js
export function getTfheWorkers(): Worker[] | undefined;
export function terminateWorkers(): Promise<unknown>;
export function setWorkerUrlConfig(config: { workerUrl?: string | URL | undefined; logger?: unknown }): void;
