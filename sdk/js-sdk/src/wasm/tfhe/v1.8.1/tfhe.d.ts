...
export class AesFheKey {
     ...
     */
    decrypt(client_key: TfheClientKey): AesPlainKey;
    /**
     * Encrypt an AES-128 master key under the client key.
     */
    static encrypt(plain: AesPlainKey, client_key: TfheClientKey): AesFheKey;
    static safe_deserialize(buffer: Uint8Array, serialized_size_limit: bigint): AesFheKey;
...
export class AesPlainState {
    free(): void;
    [Symbol.dispose](): void;
    decrypt(encrypted: StreamCiphertext): any;
    encrypt(value: any, kind: FheTypes): StreamCiphertext;
    encrypt_with_num_bits(value: any, kind: FheTypes, n_bits: number): StreamCiphertext;
    constructor(key: AesPlainKey, iv: AesIv);
}
...
export class KreyviumFheKey {
     ...
     */
    decrypt(client_key: TfheClientKey): KreyviumPlainKey;
    /**
     * Encrypt a Kreyvium master key under the client key.
     */
    static encrypt(plain: KreyviumPlainKey, client_key: TfheClientKey): KreyviumFheKey;
    static safe_deserialize(buffer: Uint8Array, serialized_size_limit: bigint): KreyviumFheKey;
    safe_serialize(serialized_size_limit: bigint): Uint8Array;
}
...
export class KreyviumPlainState {
     ...
     */
    encrypt_with_num_bits(value: any, kind: FheTypes, n_bits: number): StreamCiphertext;
    constructor(key: KreyviumPlainKey, iv: KreyviumIV);
}
...
export class OneTimePadFheSecretMask {
     ...
     */
    decrypt(client_key: TfheClientKey): OneTimePadPlainSecretMask;
    /**
     * Encrypt a one-time pad under the client key.
     */
    static encrypt(plain: OneTimePadPlainSecretMask, client_key: TfheClientKey): OneTimePadFheSecretMask;
    static safe_deserialize(buffer: Uint8Array, serialized_size_limit: bigint): OneTimePadFheSecretMask;
    safe_serialize(serialized_size_limit: bigint): Uint8Array;
}
...
export class OneTimePadPlainSecretMask {
     ...
     */
    constructor(bytes: Uint8Array, bit_count: number);
    static safe_deserialize(buffer: Uint8Array, serialized_size_limit: bigint): OneTimePadPlainSecretMask;
    static safe_deserialize_conformant(buffer: Uint8Array, serialized_size_limit: bigint, n_bits: number): OneTimePadPlainSecretMask;
    safe_serialize(serialized_size_limit: bigint): Uint8Array;
}
...
export class StreamCiphertext {
    ...
    free(): void;
    [Symbol.dispose](): void;
    cipher_kind(): StreamCipherKind;
    encryption_counter(): bigint;
    n_bits(): number;
    static safe_deserialize(buffer: Uint8Array, serialized_size_limit: bigint): StreamCiphertext;
    safe_serialize(serialized_size_limit: bigint): Uint8Array;
}
...
export interface InitOutput {
    ...
    readonly __wbg_aesfhekey_free: (a: number, b: number) => void;
    readonly __wbg_aesiv_free: (a: number, b: number) => void;
    readonly __wbg_aesplainkey_free: (a: number, b: number) => void;
    readonly __wbg_aesplainstate_free: (a: number, b: number) => void;
    ...
    readonly __wbg_kreyviumplainstate_free: (a: number, b: number) => void;
    readonly __wbg_onetimepadfhesecretmask_free: (a: number, b: number) => void;
    readonly __wbg_onetimepadplainsecretmask_free: (a: number, b: number) => void;
    readonly __wbg_onetimepadplainstate_free: (a: number, b: number) => void;
    readonly __wbg_provencompactciphertextlist_free: (a: number, b: number) => void;
    readonly __wbg_streamciphertext_free: (a: number, b: number) => void;
    readonly __wbg_tfheclientkey_free: (a: number, b: number) => void;
    readonly __wbg_tfhecompactpublickey_free: (a: number, b: number) => void;
    readonly aesfhekey_decrypt: (a: number, b: number) => [number, number, number];
    readonly aesfhekey_encrypt: (a: number, b: number) => [number, number, number];
    readonly aesfhekey_safe_deserialize: (a: number, b: number, c: bigint) => [number, number, number];
    readonly aesfhekey_safe_serialize: (a: number, b: bigint) => [number, number, number, number];
    readonly aesiv_new: (a: number, b: number) => [number, number, number];
    readonly aesplainkey_new: (a: number, b: number) => [number, number, number];
    readonly aesplainstate_decrypt: (a: number, b: number) => [number, number, number];
    readonly aesplainstate_encrypt: (a: number, b: any, c: number) => [number, number, number];
    readonly aesplainstate_encrypt_with_num_bits: (a: number, b: any, c: number, d: number) => [number, number, number];
    readonly aesplainstate_new: (a: number, b: number) => [number, number, number];
    ...
    readonly kreyviumfhekey_decrypt: (a: number, b: number) => [number, number, number];
    readonly kreyviumfhekey_encrypt: (a: number, b: number) => [number, number, number];
    readonly kreyviumfhekey_safe_deserialize: (a: number, b: number, c: bigint) => [number, number, number];
    readonly kreyviumfhekey_safe_serialize: (a: number, b: bigint) => [number, number, number, number];
    readonly kreyviumiv_new: (a: number, b: number) => [number, number, number];
    readonly kreyviumplainkey_new: (a: number, b: number) => [number, number, number];
    readonly kreyviumplainstate_decrypt: (a: number, b: number) => [number, number, number];
    readonly kreyviumplainstate_encrypt: (a: number, b: any, c: number) => [number, number, number];
    readonly kreyviumplainstate_encrypt_with_num_bits: (a: number, b: any, c: number, d: number) => [number, number, number];
    readonly kreyviumplainstate_new: (a: number, b: number) => [number, number, number];
    readonly onetimepadfhesecretmask_decrypt: (a: number, b: number) => [number, number, number];
    readonly onetimepadfhesecretmask_encrypt: (a: number, b: number) => [number, number, number];
    readonly onetimepadfhesecretmask_safe_deserialize: (a: number, b: number, c: bigint) => [number, number, number];
    readonly onetimepadfhesecretmask_safe_serialize: (a: number, b: bigint) => [number, number, number, number];
    readonly onetimepadplainsecretmask_new: (a: number, b: number, c: number) => [number, number, number];
    readonly onetimepadplainsecretmask_safe_deserialize: (a: number, b: number, c: bigint) => [number, number, number];
    readonly onetimepadplainsecretmask_safe_deserialize_conformant: (a: number, b: number, c: bigint, d: number) => [number, number, number];
    readonly onetimepadplainsecretmask_safe_serialize: (a: number, b: bigint) => [number, number, number, number];
    readonly onetimepadplainstate_decrypt: (a: number, b: number) => [number, number, number];
    readonly onetimepadplainstate_encrypt: (a: number, b: any, c: number) => [number, number, number];
    readonly onetimepadplainstate_encrypt_with_num_bits: (a: number, b: any, c: number, d: number) => [number, number, number];
    readonly onetimepadplainstate_new: (a: number) => [number, number, number];
    readonly onetimepadplainstate_remaining_bits: (a: number) => bigint;
    ...
    readonly streamciphertext_cipher_kind: (a: number) => number;
    readonly streamciphertext_encryption_counter: (a: number) => bigint;
    readonly streamciphertext_n_bits: (a: number) => number;
    readonly streamciphertext_safe_deserialize: (a: number, b: number, c: bigint) => [number, number, number];
    readonly streamciphertext_safe_serialize: (a: number, b: bigint) => [number, number, number, number];
    ...
    readonly __wbg_kreyviumiv_free: (a: number, b: number) => void;
    readonly __wbg_kreyviumplainkey_free: (a: number, b: number) => void;
    readonly __wbg_kreyviumfhekey_free: (a: number, b: number) => void;
