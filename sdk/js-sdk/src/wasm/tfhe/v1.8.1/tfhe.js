...
export class AesFheKey {
    static __wrap(ptr) {
        ptr = ptr >>> 0;
        const obj = Object.create(AesFheKey.prototype);
        obj.__wbg_ptr = ptr;
        AesFheKeyFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        AesFheKeyFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_aesfhekey_free(ptr, 0);
    }
    /**
    ...
    decrypt(client_key) {
        ...
        const ret = wasm.aesfhekey_decrypt(this.__wbg_ptr, client_key.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return AesPlainKey.__wrap(ret[0]);
    }
    /**
     * Encrypt an AES-128 master key under the client key.
     * @param {AesPlainKey} plain
     * @param {TfheClientKey} client_key
     * @returns {AesFheKey}
     */
    static encrypt(plain, client_key) {
        _assertClass(plain, AesPlainKey);
        _assertClass(client_key, TfheClientKey);
        const ret = wasm.aesfhekey_encrypt(plain.__wbg_ptr, client_key.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return AesFheKey.__wrap(ret[0]);
    }
    /**
    ...
    static safe_deserialize(buffer, serialized_size_limit) {
        ...
        const ret = wasm.aesfhekey_safe_deserialize(ptr0, len0, serialized_size_limit);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return AesFheKey.__wrap(ret[0]);
    ...
    safe_serialize(serialized_size_limit) {
        const ret = wasm.aesfhekey_safe_serialize(this.__wbg_ptr, serialized_size_limit);
        if (ret[3]) {
...
if (Symbol.dispose) AesFheKey.prototype[Symbol.dispose] = AesFheKey.prototype.free;

export class AesIv {
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        AesIvFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_aesiv_free(ptr, 0);
    }
    /**
    ...
    constructor(bytes) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.aesiv_new(ptr0, len0);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        this.__wbg_ptr = ret[0] >>> 0;
        AesIvFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
}
if (Symbol.dispose) AesIv.prototype[Symbol.dispose] = AesIv.prototype.free;

export class AesPlainKey {
    static __wrap(ptr) {
        ptr = ptr >>> 0;
        const obj = Object.create(AesPlainKey.prototype);
        obj.__wbg_ptr = ptr;
        AesPlainKeyFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        AesPlainKeyFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_aesplainkey_free(ptr, 0);
    }
    /**
     * @param {Uint8Array} bytes
     */
    constructor(bytes) {
        const ptr0 = passArray8ToWasm0(bytes, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.aesplainkey_new(ptr0, len0);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        this.__wbg_ptr = ret[0] >>> 0;
        AesPlainKeyFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
}
if (Symbol.dispose) AesPlainKey.prototype[Symbol.dispose] = AesPlainKey.prototype.free;

export class AesPlainState {
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        AesPlainStateFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_aesplainstate_free(ptr, 0);
    }
    /**
     * @param {StreamCiphertext} encrypted
     * @returns {any}
     */
    decrypt(encrypted) {
        _assertClass(encrypted, StreamCiphertext);
        const ret = wasm.aesplainstate_decrypt(this.__wbg_ptr, encrypted.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
     ...
     * @param {any} value
     * @param {FheTypes} kind
     * @returns {StreamCiphertext}
     */
    encrypt(value, kind) {
        const ret = wasm.aesplainstate_encrypt(this.__wbg_ptr, value, kind);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return StreamCiphertext.__wrap(ret[0]);
    }
    /**
     * @param {any} value
     * @param {FheTypes} kind
     ...
     * @returns {StreamCiphertext}
     */
    encrypt_with_num_bits(value, kind, n_bits) {
        const ret = wasm.aesplainstate_encrypt_with_num_bits(this.__wbg_ptr, value, kind, n_bits);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return StreamCiphertext.__wrap(ret[0]);
    ...
    /**
     * @param {AesPlainKey} key
     * @param {AesIv} iv
     */
    constructor(key, iv) {
        _assertClass(key, AesPlainKey);
        _assertClass(iv, AesIv);
        const ret = wasm.aesplainstate_new(key.__wbg_ptr, iv.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        this.__wbg_ptr = ret[0] >>> 0;
        AesPlainStateFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
}
if (Symbol.dispose) AesPlainState.prototype[Symbol.dispose] = AesPlainState.prototype.free;
...
export class KreyviumFheKey {
    static __wrap(ptr) {
        ptr = ptr >>> 0;
        const obj = Object.create(KreyviumFheKey.prototype);
        obj.__wbg_ptr = ptr;
        KreyviumFheKeyFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        KreyviumFheKeyFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_kreyviumfhekey_free(ptr, 0);
    }
    /**
     ...
     * @param {TfheClientKey} client_key
     * @returns {KreyviumPlainKey}
     */
    decrypt(client_key) {
        _assertClass(client_key, TfheClientKey);
        const ret = wasm.kreyviumfhekey_decrypt(this.__wbg_ptr, client_key.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return KreyviumPlainKey.__wrap(ret[0]);
    }
    /**
     * Encrypt a Kreyvium master key under the client key.
     * @param {KreyviumPlainKey} plain
     * @param {TfheClientKey} client_key
     * @returns {KreyviumFheKey}
     */
    static encrypt(plain, client_key) {
        _assertClass(plain, KreyviumPlainKey);
        _assertClass(client_key, TfheClientKey);
        const ret = wasm.kreyviumfhekey_encrypt(plain.__wbg_ptr, client_key.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return KreyviumFheKey.__wrap(ret[0]);
    }
    /**
     * @param {Uint8Array} buffer
     * @param {bigint} serialized_size_limit
    ...
    static safe_deserialize(buffer, serialized_size_limit) {
        const ptr0 = passArray8ToWasm0(buffer, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.kreyviumfhekey_safe_deserialize(ptr0, len0, serialized_size_limit);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return KreyviumFheKey.__wrap(ret[0]);
     ...
     */
    safe_serialize(serialized_size_limit) {
        const ret = wasm.kreyviumfhekey_safe_serialize(this.__wbg_ptr, serialized_size_limit);
        if (ret[3]) {
            throw takeFromExternrefTable0(ret[2]);
        }
        var v1 = getArrayU8FromWasm0(ret[0], ret[1]).slice();
...
if (Symbol.dispose) KreyviumFheKey.prototype[Symbol.dispose] = KreyviumFheKey.prototype.free;

export class KreyviumIV {
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        KreyviumIVFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_kreyviumiv_free(ptr, 0);
    }
    /**
     * @param {Uint8Array} bytes
     */
    constructor(bytes) {
        const ptr0 = passArray8ToWasm0(bytes, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.kreyviumiv_new(ptr0, len0);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        this.__wbg_ptr = ret[0] >>> 0;
        KreyviumIVFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
}
if (Symbol.dispose) KreyviumIV.prototype[Symbol.dispose] = KreyviumIV.prototype.free;

export class KreyviumPlainKey {
    static __wrap(ptr) {
        ptr = ptr >>> 0;
        const obj = Object.create(KreyviumPlainKey.prototype);
        obj.__wbg_ptr = ptr;
        KreyviumPlainKeyFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        KreyviumPlainKeyFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_kreyviumplainkey_free(ptr, 0);
    }
    /**
     * @param {Uint8Array} bytes
     */
    constructor(bytes) {
        const ptr0 = passArray8ToWasm0(bytes, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.kreyviumplainkey_new(ptr0, len0);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        this.__wbg_ptr = ret[0] >>> 0;
        KreyviumPlainKeyFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
}
if (Symbol.dispose) KreyviumPlainKey.prototype[Symbol.dispose] = KreyviumPlainKey.prototype.free;

export class KreyviumPlainState {
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        KreyviumPlainStateFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_kreyviumplainstate_free(ptr, 0);
    }
    /**
    ...
    decrypt(encrypted) {
        _assertClass(encrypted, StreamCiphertext);
        const ret = wasm.kreyviumplainstate_decrypt(this.__wbg_ptr, encrypted.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
     ...
     */
    encrypt(value, kind) {
        const ret = wasm.kreyviumplainstate_encrypt(this.__wbg_ptr, value, kind);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return StreamCiphertext.__wrap(ret[0]);
     ...
     */
    encrypt_with_num_bits(value, kind, n_bits) {
        const ret = wasm.kreyviumplainstate_encrypt_with_num_bits(this.__wbg_ptr, value, kind, n_bits);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return StreamCiphertext.__wrap(ret[0]);
    ...
    /**
     * @param {KreyviumPlainKey} key
     * @param {KreyviumIV} iv
     */
    constructor(key, iv) {
        _assertClass(key, KreyviumPlainKey);
        _assertClass(iv, KreyviumIV);
        const ret = wasm.kreyviumplainstate_new(key.__wbg_ptr, iv.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        this.__wbg_ptr = ret[0] >>> 0;
        KreyviumPlainStateFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
}
if (Symbol.dispose) KreyviumPlainState.prototype[Symbol.dispose] = KreyviumPlainState.prototype.free;

export class OneTimePadFheSecretMask {
    static __wrap(ptr) {
        ptr = ptr >>> 0;
        const obj = Object.create(OneTimePadFheSecretMask.prototype);
        obj.__wbg_ptr = ptr;
        OneTimePadFheSecretMaskFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        OneTimePadFheSecretMaskFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_onetimepadfhesecretmask_free(ptr, 0);
    }
    /**
     ...
     * @param {TfheClientKey} client_key
     * @returns {OneTimePadPlainSecretMask}
     */
    decrypt(client_key) {
        _assertClass(client_key, TfheClientKey);
        const ret = wasm.onetimepadfhesecretmask_decrypt(this.__wbg_ptr, client_key.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return OneTimePadPlainSecretMask.__wrap(ret[0]);
    }
    /**
     * Encrypt a one-time pad under the client key.
     * @param {OneTimePadPlainSecretMask} plain
     * @param {TfheClientKey} client_key
     * @returns {OneTimePadFheSecretMask}
     */
    static encrypt(plain, client_key) {
        _assertClass(plain, OneTimePadPlainSecretMask);
        _assertClass(client_key, TfheClientKey);
        const ret = wasm.onetimepadfhesecretmask_encrypt(plain.__wbg_ptr, client_key.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return OneTimePadFheSecretMask.__wrap(ret[0]);
    }
    /**
     * @param {Uint8Array} buffer
     * @param {bigint} serialized_size_limit
    ...
    static safe_deserialize(buffer, serialized_size_limit) {
        const ptr0 = passArray8ToWasm0(buffer, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.onetimepadfhesecretmask_safe_deserialize(ptr0, len0, serialized_size_limit);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return OneTimePadFheSecretMask.__wrap(ret[0]);
     ...
     */
    safe_serialize(serialized_size_limit) {
        const ret = wasm.onetimepadfhesecretmask_safe_serialize(this.__wbg_ptr, serialized_size_limit);
        if (ret[3]) {
            throw takeFromExternrefTable0(ret[2]);
        }
        var v1 = getArrayU8FromWasm0(ret[0], ret[1]).slice();
...
if (Symbol.dispose) OneTimePadFheSecretMask.prototype[Symbol.dispose] = OneTimePadFheSecretMask.prototype.free;

export class OneTimePadPlainSecretMask {
    static __wrap(ptr) {
        ptr = ptr >>> 0;
        const obj = Object.create(OneTimePadPlainSecretMask.prototype);
        obj.__wbg_ptr = ptr;
        OneTimePadPlainSecretMaskFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        OneTimePadPlainSecretMaskFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_onetimepadplainsecretmask_free(ptr, 0);
    }
    /**
     ...
     */
    constructor(bytes, bit_count) {
        const ptr0 = passArray8ToWasm0(bytes, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.onetimepadplainsecretmask_new(ptr0, len0, bit_count);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        this.__wbg_ptr = ret[0] >>> 0;
        OneTimePadPlainSecretMaskFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    /**
     * @param {Uint8Array} buffer
    ...
    static safe_deserialize(buffer, serialized_size_limit) {
        const ptr0 = passArray8ToWasm0(buffer, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.onetimepadplainsecretmask_safe_deserialize(ptr0, len0, serialized_size_limit);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return OneTimePadPlainSecretMask.__wrap(ret[0]);
     ...
     * @returns {OneTimePadPlainSecretMask}
     */
    static safe_deserialize_conformant(buffer, serialized_size_limit, n_bits) {
        const ptr0 = passArray8ToWasm0(buffer, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.onetimepadplainsecretmask_safe_deserialize_conformant(ptr0, len0, serialized_size_limit, n_bits);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return OneTimePadPlainSecretMask.__wrap(ret[0]);
     ...
     */
    safe_serialize(serialized_size_limit) {
        const ret = wasm.onetimepadplainsecretmask_safe_serialize(this.__wbg_ptr, serialized_size_limit);
        if (ret[3]) {
            throw takeFromExternrefTable0(ret[2]);
        }
        var v1 = getArrayU8FromWasm0(ret[0], ret[1]).slice();
...
if (Symbol.dispose) OneTimePadPlainSecretMask.prototype[Symbol.dispose] = OneTimePadPlainSecretMask.prototype.free;

export class OneTimePadPlainState {
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        OneTimePadPlainStateFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_onetimepadplainstate_free(ptr, 0);
    }
    /**
     * Decrypt a [`StreamCiphertext`] produced by an earlier call to
     * [`Self::encrypt`] / [`Self::encrypt_with_num_bits`]. Returns a JS
    ...
    decrypt(encrypted) {
        _assertClass(encrypted, StreamCiphertext);
        const ret = wasm.onetimepadplainstate_decrypt(this.__wbg_ptr, encrypted.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
     ...
     */
    encrypt(value, kind) {
        const ret = wasm.onetimepadplainstate_encrypt(this.__wbg_ptr, value, kind);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return StreamCiphertext.__wrap(ret[0]);
     ...
     */
    encrypt_with_num_bits(value, kind, n_bits) {
        const ret = wasm.onetimepadplainstate_encrypt_with_num_bits(this.__wbg_ptr, value, kind, n_bits);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return StreamCiphertext.__wrap(ret[0]);
     ...
     * @param {OneTimePadPlainSecretMask} mask
     */
    constructor(mask) {
        _assertClass(mask, OneTimePadPlainSecretMask);
        const ret = wasm.onetimepadplainstate_new(mask.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        this.__wbg_ptr = ret[0] >>> 0;
        OneTimePadPlainStateFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    /**
     ...
     */
    remaining_bits() {
        const ret = wasm.onetimepadplainstate_remaining_bits(this.__wbg_ptr);
        return BigInt.asUintN(64, ret);
    }
}
if (Symbol.dispose) OneTimePadPlainState.prototype[Symbol.dispose] = OneTimePadPlainState.prototype.free;
 ...
 * @enum {0 | 1 | 2 | 3}
 */
export const StreamCipherKind = Object.freeze({
    Dynamic: 0, "0": "Dynamic",
    Kreyvium: 1, "1": "Kreyvium",
    Aes: 2, "2": "Aes",
    OneTimePad: 3, "3": "OneTimePad",
});

export class StreamCiphertext {
    static __wrap(ptr) {
        ptr = ptr >>> 0;
        const obj = Object.create(StreamCiphertext.prototype);
        obj.__wbg_ptr = ptr;
        StreamCiphertextFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        StreamCiphertextFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_streamciphertext_free(ptr, 0);
    }
    /**
     * @returns {StreamCipherKind}
     */
    cipher_kind() {
        const ret = wasm.streamciphertext_cipher_kind(this.__wbg_ptr);
        return ret;
    }
    /**
     * @returns {bigint}
     */
    encryption_counter() {
        const ret = wasm.streamciphertext_encryption_counter(this.__wbg_ptr);
        return BigInt.asUintN(64, ret);
    }
    /**
     * @returns {number}
     */
    n_bits() {
        const ret = wasm.streamciphertext_n_bits(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     * @param {Uint8Array} buffer
    ...
    static safe_deserialize(buffer, serialized_size_limit) {
        const ptr0 = passArray8ToWasm0(buffer, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.streamciphertext_safe_deserialize(ptr0, len0, serialized_size_limit);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return StreamCiphertext.__wrap(ret[0]);
     ...
     */
    safe_serialize(serialized_size_limit) {
        const ret = wasm.streamciphertext_safe_serialize(this.__wbg_ptr, serialized_size_limit);
        if (ret[3]) {
            throw takeFromExternrefTable0(ret[2]);
        }
        var v1 = getArrayU8FromWasm0(ret[0], ret[1]).slice();
...
if (Symbol.dispose) StreamCiphertext.prototype[Symbol.dispose] = StreamCiphertext.prototype.free;
...
const AesFheKeyFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_aesfhekey_free(ptr >>> 0, 1));
const AesIvFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_aesiv_free(ptr >>> 0, 1));
const AesPlainKeyFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_aesplainkey_free(ptr >>> 0, 1));
const AesPlainStateFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_aesplainstate_free(ptr >>> 0, 1));
...
const KreyviumFheKeyFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_kreyviumfhekey_free(ptr >>> 0, 1));
const KreyviumIVFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_kreyviumiv_free(ptr >>> 0, 1));
const KreyviumPlainKeyFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_kreyviumplainkey_free(ptr >>> 0, 1));
const KreyviumPlainStateFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_kreyviumplainstate_free(ptr >>> 0, 1));
const OneTimePadFheSecretMaskFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_onetimepadfhesecretmask_free(ptr >>> 0, 1));
const OneTimePadPlainSecretMaskFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_onetimepadplainsecretmask_free(ptr >>> 0, 1));
const OneTimePadPlainStateFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_onetimepadplainstate_free(ptr >>> 0, 1));
...
const StreamCiphertextFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_streamciphertext_free(ptr >>> 0, 1));
