...
export interface TfheLibApi {
  initAsync: typeof import('./v1.7.0/tfhe.js').initAsync;

  // --- Free functions used by encrypt/init-p.ts -----------------------------
  init_panic_hook: typeof import('./v1.7.0/tfhe.js').init_panic_hook;
  initThreadPool: typeof import('./v1.7.0/tfhe.js').initThreadPool;
  setWorkerUrlConfig: typeof import('./v1.7.0/tfhe.js').setWorkerUrlConfig;
  getWasmInfo: typeof import('./v1.7.0/tfhe.js').getWasmInfo;
  ...
  CompactCiphertextList: typeof import('./v1.7.0/tfhe.js').CompactCiphertextList;
  CompactPkeCrs: typeof import('./v1.7.0/tfhe.js').CompactPkeCrs;
  ProvenCompactCiphertextList: typeof import('./v1.7.0/tfhe.js').ProvenCompactCiphertextList;
  TfheCompactPublicKey: typeof import('./v1.7.0/tfhe.js').TfheCompactPublicKey;

  // --- Enum used as a value (e.g. ZkComputeLoad.Verify) ---------------------
  ZkComputeLoad: typeof import('./v1.7.0/tfhe.js').ZkComputeLoad;
}
