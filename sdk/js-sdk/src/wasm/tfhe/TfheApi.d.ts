...
export interface TfheLibApi {
  initAsync: typeof import('./v1.8.1/tfhe.js').initAsync;

  // --- Free functions used by encrypt/init-p.ts -----------------------------
  init_panic_hook: typeof import('./v1.8.1/tfhe.js').init_panic_hook;
  initThreadPool: typeof import('./v1.8.1/tfhe.js').initThreadPool;
  setWorkerUrlConfig: typeof import('./v1.8.1/tfhe.js').setWorkerUrlConfig;
  getWasmInfo: typeof import('./v1.8.1/tfhe.js').getWasmInfo;
  ...
  CompactCiphertextList: typeof import('./v1.8.1/tfhe.js').CompactCiphertextList;
  CompactPkeCrs: typeof import('./v1.8.1/tfhe.js').CompactPkeCrs;
  ProvenCompactCiphertextList: typeof import('./v1.8.1/tfhe.js').ProvenCompactCiphertextList;
  TfheCompactPublicKey: typeof import('./v1.8.1/tfhe.js').TfheCompactPublicKey;

  // --- Enum used as a value (e.g. ZkComputeLoad.Verify) ---------------------
  ZkComputeLoad: typeof import('./v1.8.1/tfhe.js').ZkComputeLoad;
}
