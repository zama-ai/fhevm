...
//!
//! Pure data transformation — no network, no filesystem.
...
/// Generate calldata for public decryption.
...
/// Generate calldata for user decryption.
...
/// Compute calldata for verifyProofRequest function.
