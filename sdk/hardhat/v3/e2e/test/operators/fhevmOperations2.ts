...
describe('FHEVM operations 2', function () {
  ...
  it('test operator "le" overload (euint8, euint64) => ebool test 1 (82, 18442538173712758245)', async function () {
    const input = fhevm.createEncryptedInput(this.contract1Address, this.signers.alice.address);
    input.add8(82n);
    ...
    await tx.wait();
    const res = await fhevm.debugger.decryptEbool(await this.contract1.resEbool());
  ...
  it('test operator "min" overload (euint8, euint64) => euint64 test 1 (73, 18440064211635517333)', async function () {
    ...
    await tx.wait();
    const res = await fhevm.debugger.decryptEuint(FhevmType.euint64, await this.contract1.resEuint64());
  ...
  it('test operator "add" overload (euint8, euint128) => euint128 test 1 (2, 129)', async function () {
    ...
    await tx.wait();
    const res = await fhevm.debugger.decryptEuint(FhevmType.euint128, await this.contract1.resEuint128());
  ...
  it('test operator "and" overload (euint8, euint256) => euint256 test 1 (9, 115792089237316195423570985008687907853269984665640564039457575680225403883879)', async function () {
    ...
    await tx.wait();
    const res = await fhevm.debugger.decryptEuint(FhevmType.euint256, await this.contract1.resEuint256());
  ...
  it('test operator "add" overload (euint16, euint8) => euint16 test 1 (154, 2)', async function () {
    ...
    await tx.wait();
    const res = await fhevm.debugger.decryptEuint(FhevmType.euint16, await this.contract1.resEuint16());
    expect(res).to.equal(156n);
  });
  ...
  it('test operator "sub" overload (euint16, euint16) => euint16 test 1 (48348, 48348)', async function () {
    const input = fhevm.createEncryptedInput(this.contract2Address, this.signers.alice.address);
    input.add16(48348n);
    input.add16(48348n);
    const encryptedAmount = await input.encrypt();
    ...
    await tx.wait();
    const res = await fhevm.debugger.decryptEuint(FhevmType.euint16, await this.contract2.resEuint16());
    expect(res).to.equal(0n);
  });
  ...
  it('test operator "eq" overload (euint16, euint16) => ebool test 1 (56747, 20695)', async function () {
    ...
    await tx.wait();
    const res = await fhevm.debugger.decryptEbool(await this.contract2.resEbool());
    expect(res).to.equal(false);
  });
  ...
  it('test operator "add" overload (euint16, euint32) => euint32 test 1 (2, 54917)', async function () {
    ...
    await tx.wait();
    const res = await fhevm.debugger.decryptEuint(FhevmType.euint32, await this.contract2.resEuint32());
