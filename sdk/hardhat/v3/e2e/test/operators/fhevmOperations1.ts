...
describe('FHEVM operations 1', function () {
  ...
  it('test operator "add" overload (euint8, euint8) => euint8 test 1 (80, 133)', async function () {
    ...
    await tx.wait();
    const res = await fhevm.debugger.decryptEuint(FhevmType.euint8, await this.contract1.resEuint8());
  ...
  it('test operator "add" overload (euint8, euint32) => euint32 test 1 (2, 183)', async function () {
    ...
    await tx.wait();
    const res = await fhevm.debugger.decryptEuint(FhevmType.euint32, await this.contract1.resEuint32());
