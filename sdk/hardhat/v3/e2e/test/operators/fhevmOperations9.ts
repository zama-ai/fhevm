...
describe('FHEVM operations 9', function () {
  ...
  it('test operator "or" overload (uint8, euint8) => euint8 test 1 (99, 140)', async function () {
    ...
    const tx = await this.contract5.or_uint8_euint8(99n, at(encryptedAmount.handles, 0), encryptedAmount.inputProof);
    await tx.wait();
  ...
  it('test operator "or" overload (uint8, euint8) => euint8 test 2 (33, 37)', async function () {
    ...
    input.add8(37n);
    const encryptedAmount = await input.encrypt();
    const tx = await this.contract5.or_uint8_euint8(33n, at(encryptedAmount.handles, 0), encryptedAmount.inputProof);
    await tx.wait();
    const res = await fhevm.debugger.decryptEuint(FhevmType.euint8, await this.contract5.resEuint8());
  ...
  it('test operator "or" overload (uint8, euint8) => euint8 test 3 (37, 37)', async function () {
    ...
    input.add8(37n);
    const encryptedAmount = await input.encrypt();
    const tx = await this.contract5.or_uint8_euint8(37n, at(encryptedAmount.handles, 0), encryptedAmount.inputProof);
    await tx.wait();
    const res = await fhevm.debugger.decryptEuint(FhevmType.euint8, await this.contract5.resEuint8());
    expect(res).to.equal(37n);
  });
  ...
  it('test operator "xor" overload (euint8, uint8) => euint8 test 1 (239, 5)', async function () {
    ...
    const encryptedAmount = await input.encrypt();
    const tx = await this.contract5.xor_euint8_uint8(at(encryptedAmount.handles, 0), 5n, encryptedAmount.inputProof);
    await tx.wait();
    const res = await fhevm.debugger.decryptEuint(FhevmType.euint8, await this.contract5.resEuint8());
  ...
  it('test operator "xor" overload (euint8, uint8) => euint8 test 2 (10, 14)', async function () {
    ...
    const encryptedAmount = await input.encrypt();
    const tx = await this.contract5.xor_euint8_uint8(at(encryptedAmount.handles, 0), 14n, encryptedAmount.inputProof);
    await tx.wait();
    const res = await fhevm.debugger.decryptEuint(FhevmType.euint8, await this.contract5.resEuint8());
  ...
  it('test operator "xor" overload (euint8, uint8) => euint8 test 4 (14, 10)', async function () {
    ...
    const encryptedAmount = await input.encrypt();
    const tx = await this.contract5.xor_euint8_uint8(at(encryptedAmount.handles, 0), 10n, encryptedAmount.inputProof);
    await tx.wait();
    const res = await fhevm.debugger.decryptEuint(FhevmType.euint8, await this.contract5.resEuint8());
    expect(res).to.equal(4n);
  });
  ...
  it('test operator "xor" overload (uint8, euint8) => euint8 test 1 (80, 5)', async function () {
    ...
    input.add8(5n);
    const encryptedAmount = await input.encrypt();
    const tx = await this.contract5.xor_uint8_euint8(80n, at(encryptedAmount.handles, 0), encryptedAmount.inputProof);
    await tx.wait();
    const res = await fhevm.debugger.decryptEuint(FhevmType.euint8, await this.contract5.resEuint8());
  ...
  it('test operator "xor" overload (uint8, euint8) => euint8 test 2 (10, 14)', async function () {
    ...
    input.add8(14n);
    const encryptedAmount = await input.encrypt();
    const tx = await this.contract5.xor_uint8_euint8(10n, at(encryptedAmount.handles, 0), encryptedAmount.inputProof);
    await tx.wait();
    const res = await fhevm.debugger.decryptEuint(FhevmType.euint8, await this.contract5.resEuint8());
    expect(res).to.equal(4n);
  });
  ...
  it('test operator "xor" overload (uint8, euint8) => euint8 test 3 (14, 14)', async function () {
    ...
    input.add8(14n);
    const encryptedAmount = await input.encrypt();
    const tx = await this.contract5.xor_uint8_euint8(14n, at(encryptedAmount.handles, 0), encryptedAmount.inputProof);
    await tx.wait();
    const res = await fhevm.debugger.decryptEuint(FhevmType.euint8, await this.contract5.resEuint8());
    expect(res).to.equal(0n);
  });
  ...
  it('test operator "eq" overload (euint8, uint8) => ebool test 1 (221, 162)', async function () {
    ...
    const encryptedAmount = await input.encrypt();
    const tx = await this.contract5.eq_euint8_uint8(at(encryptedAmount.handles, 0), 162n, encryptedAmount.inputProof);
    await tx.wait();
  ...
  it('test operator "eq" overload (euint8, uint8) => ebool test 2 (217, 221)', async function () {
    ...
    const encryptedAmount = await input.encrypt();
    const tx = await this.contract5.eq_euint8_uint8(at(encryptedAmount.handles, 0), 221n, encryptedAmount.inputProof);
    await tx.wait();
    const res = await fhevm.debugger.decryptEbool(await this.contract5.resEbool());
    expect(res).to.equal(false);
  });
  ...
  it('test operator "eq" overload (euint8, uint8) => ebool test 4 (221, 217)', async function () {
    ...
    const encryptedAmount = await input.encrypt();
    const tx = await this.contract5.eq_euint8_uint8(at(encryptedAmount.handles, 0), 217n, encryptedAmount.inputProof);
    await tx.wait();
    const res = await fhevm.debugger.decryptEbool(await this.contract5.resEbool());
    expect(res).to.equal(false);
  });
  ...
  it('test operator "eq" overload (uint8, euint8) => ebool test 1 (123, 162)', async function () {
    ...
    input.add8(162n);
    const encryptedAmount = await input.encrypt();
    const tx = await this.contract5.eq_uint8_euint8(123n, at(encryptedAmount.handles, 0), encryptedAmount.inputProof);
    await tx.wait();
    const res = await fhevm.debugger.decryptEbool(await this.contract5.resEbool());
    expect(res).to.equal(false);
  });
  ...
  it('test operator "eq" overload (uint8, euint8) => ebool test 2 (217, 221)', async function () {
    ...
    input.add8(221n);
    const encryptedAmount = await input.encrypt();
    const tx = await this.contract5.eq_uint8_euint8(217n, at(encryptedAmount.handles, 0), encryptedAmount.inputProof);
    await tx.wait();
    const res = await fhevm.debugger.decryptEbool(await this.contract5.resEbool());
    expect(res).to.equal(false);
  });
  ...
  it('test operator "eq" overload (uint8, euint8) => ebool test 3 (221, 221)', async function () {
    ...
    input.add8(221n);
    const encryptedAmount = await input.encrypt();
    const tx = await this.contract5.eq_uint8_euint8(221n, at(encryptedAmount.handles, 0), encryptedAmount.inputProof);
    await tx.wait();
    const res = await fhevm.debugger.decryptEbool(await this.contract5.resEbool());
    expect(res).to.equal(true);
  });
  ...
  it('test operator "ne" overload (euint8, uint8) => ebool test 1 (151, 81)', async function () {
    ...
    const encryptedAmount = await input.encrypt();
    const tx = await this.contract5.ne_euint8_uint8(at(encryptedAmount.handles, 0), 81n, encryptedAmount.inputProof);
    await tx.wait();
    const res = await fhevm.debugger.decryptEbool(await this.contract5.resEbool());
    expect(res).to.equal(true);
  });
  ...
  it('test operator "ne" overload (euint8, uint8) => ebool test 2 (147, 151)', async function () {
    ...
    const encryptedAmount = await input.encrypt();
    const tx = await this.contract5.ne_euint8_uint8(at(encryptedAmount.handles, 0), 151n, encryptedAmount.inputProof);
    await tx.wait();
    const res = await fhevm.debugger.decryptEbool(await this.contract5.resEbool());
    expect(res).to.equal(true);
  });
  ...
  it('test operator "ne" overload (euint8, uint8) => ebool test 4 (151, 147)', async function () {
    ...
    const encryptedAmount = await input.encrypt();
    const tx = await this.contract5.ne_euint8_uint8(at(encryptedAmount.handles, 0), 147n, encryptedAmount.inputProof);
    await tx.wait();
    const res = await fhevm.debugger.decryptEbool(await this.contract5.resEbool());
    expect(res).to.equal(true);
  });
  ...
  it('test operator "ne" overload (uint8, euint8) => ebool test 1 (218, 81)', async function () {
    ...
    input.add8(81n);
    const encryptedAmount = await input.encrypt();
    const tx = await this.contract5.ne_uint8_euint8(218n, at(encryptedAmount.handles, 0), encryptedAmount.inputProof);
    await tx.wait();
    const res = await fhevm.debugger.decryptEbool(await this.contract5.resEbool());
    expect(res).to.equal(true);
  });
  ...
  it('test operator "ne" overload (uint8, euint8) => ebool test 2 (147, 151)', async function () {
    ...
    input.add8(151n);
    const encryptedAmount = await input.encrypt();
    const tx = await this.contract5.ne_uint8_euint8(147n, at(encryptedAmount.handles, 0), encryptedAmount.inputProof);
    await tx.wait();
    const res = await fhevm.debugger.decryptEbool(await this.contract5.resEbool());
    expect(res).to.equal(true);
  });
  ...
  it('test operator "ne" overload (uint8, euint8) => ebool test 3 (151, 151)', async function () {
    ...
    input.add8(151n);
    const encryptedAmount = await input.encrypt();
    const tx = await this.contract5.ne_uint8_euint8(151n, at(encryptedAmount.handles, 0), encryptedAmount.inputProof);
    await tx.wait();
    const res = await fhevm.debugger.decryptEbool(await this.contract5.resEbool());
    expect(res).to.equal(false);
  });
  ...
  it('test operator "ge" overload (euint8, uint8) => ebool test 1 (36, 47)', async function () {
    ...
    const encryptedAmount = await input.encrypt();
    const tx = await this.contract5.ge_euint8_uint8(at(encryptedAmount.handles, 0), 47n, encryptedAmount.inputProof);
    await tx.wait();
    const res = await fhevm.debugger.decryptEbool(await this.contract5.resEbool());
    expect(res).to.equal(false);
  });
  ...
  it('test operator "ge" overload (euint8, uint8) => ebool test 2 (32, 36)', async function () {
    ...
    const encryptedAmount = await input.encrypt();
    const tx = await this.contract5.ge_euint8_uint8(at(encryptedAmount.handles, 0), 36n, encryptedAmount.inputProof);
    await tx.wait();
    const res = await fhevm.debugger.decryptEbool(await this.contract5.resEbool());
    expect(res).to.equal(false);
  });
  ...
  it('test operator "ge" overload (euint8, uint8) => ebool test 4 (36, 32)', async function () {
    ...
    const encryptedAmount = await input.encrypt();
    const tx = await this.contract5.ge_euint8_uint8(at(encryptedAmount.handles, 0), 32n, encryptedAmount.inputProof);
    await tx.wait();
    const res = await fhevm.debugger.decryptEbool(await this.contract5.resEbool());
    expect(res).to.equal(true);
  });
  ...
  it('test operator "ge" overload (uint8, euint8) => ebool test 1 (87, 47)', async function () {
    ...
    input.add8(47n);
    const encryptedAmount = await input.encrypt();
    const tx = await this.contract5.ge_uint8_euint8(87n, at(encryptedAmount.handles, 0), encryptedAmount.inputProof);
    await tx.wait();
    const res = await fhevm.debugger.decryptEbool(await this.contract5.resEbool());
    expect(res).to.equal(true);
  });
  ...
  it('test operator "ge" overload (uint8, euint8) => ebool test 2 (32, 36)', async function () {
    ...
    input.add8(36n);
    const encryptedAmount = await input.encrypt();
    const tx = await this.contract5.ge_uint8_euint8(32n, at(encryptedAmount.handles, 0), encryptedAmount.inputProof);
    await tx.wait();
    const res = await fhevm.debugger.decryptEbool(await this.contract5.resEbool());
    expect(res).to.equal(false);
  });
  ...
  it('test operator "ge" overload (uint8, euint8) => ebool test 3 (36, 36)', async function () {
    ...
    input.add8(36n);
    const encryptedAmount = await input.encrypt();
    const tx = await this.contract5.ge_uint8_euint8(36n, at(encryptedAmount.handles, 0), encryptedAmount.inputProof);
    await tx.wait();
    const res = await fhevm.debugger.decryptEbool(await this.contract5.resEbool());
    expect(res).to.equal(true);
  });
  ...
  it('test operator "gt" overload (euint8, uint8) => ebool test 1 (244, 24)', async function () {
    ...
    const encryptedAmount = await input.encrypt();
    const tx = await this.contract5.gt_euint8_uint8(at(encryptedAmount.handles, 0), 24n, encryptedAmount.inputProof);
    await tx.wait();
    const res = await fhevm.debugger.decryptEbool(await this.contract5.resEbool());
    expect(res).to.equal(true);
  });
  ...
  it('test operator "gt" overload (euint8, uint8) => ebool test 2 (200, 204)', async function () {
    ...
    const encryptedAmount = await input.encrypt();
    const tx = await this.contract5.gt_euint8_uint8(at(encryptedAmount.handles, 0), 204n, encryptedAmount.inputProof);
    await tx.wait();
    const res = await fhevm.debugger.decryptEbool(await this.contract5.resEbool());
    expect(res).to.equal(false);
  });
  ...
  it('test operator "gt" overload (euint8, uint8) => ebool test 4 (204, 200)', async function () {
    ...
    const encryptedAmount = await input.encrypt();
    const tx = await this.contract5.gt_euint8_uint8(at(encryptedAmount.handles, 0), 200n, encryptedAmount.inputProof);
    await tx.wait();
    const res = await fhevm.debugger.decryptEbool(await this.contract5.resEbool());
    expect(res).to.equal(true);
  });
  ...
  it('test operator "gt" overload (uint8, euint8) => ebool test 1 (175, 24)', async function () {
    ...
    input.add8(24n);
    const encryptedAmount = await input.encrypt();
    const tx = await this.contract5.gt_uint8_euint8(175n, at(encryptedAmount.handles, 0), encryptedAmount.inputProof);
    await tx.wait();
    const res = await fhevm.debugger.decryptEbool(await this.contract5.resEbool());
    expect(res).to.equal(true);
  });
  ...
  it('test operator "gt" overload (uint8, euint8) => ebool test 2 (200, 204)', async function () {
    ...
    input.add8(204n);
    const encryptedAmount = await input.encrypt();
    const tx = await this.contract5.gt_uint8_euint8(200n, at(encryptedAmount.handles, 0), encryptedAmount.inputProof);
    await tx.wait();
    const res = await fhevm.debugger.decryptEbool(await this.contract5.resEbool());
    expect(res).to.equal(false);
  });
  ...
  it('test operator "gt" overload (uint8, euint8) => ebool test 3 (204, 204)', async function () {
    ...
    input.add8(204n);
    const encryptedAmount = await input.encrypt();
    const tx = await this.contract5.gt_uint8_euint8(204n, at(encryptedAmount.handles, 0), encryptedAmount.inputProof);
    await tx.wait();
    const res = await fhevm.debugger.decryptEbool(await this.contract5.resEbool());
    expect(res).to.equal(false);
  });
  ...
  it('test operator "le" overload (euint8, uint8) => ebool test 1 (212, 111)', async function () {
    ...
    const encryptedAmount = await input.encrypt();
    const tx = await this.contract5.le_euint8_uint8(at(encryptedAmount.handles, 0), 111n, encryptedAmount.inputProof);
    await tx.wait();
    const res = await fhevm.debugger.decryptEbool(await this.contract5.resEbool());
    expect(res).to.equal(false);
  });
  ...
  it('test operator "le" overload (euint8, uint8) => ebool test 2 (30, 34)', async function () {
    ...
    const encryptedAmount = await input.encrypt();
    const tx = await this.contract5.le_euint8_uint8(at(encryptedAmount.handles, 0), 34n, encryptedAmount.inputProof);
    await tx.wait();
    const res = await fhevm.debugger.decryptEbool(await this.contract5.resEbool());
    expect(res).to.equal(true);
  });
  ...
  it('test operator "le" overload (euint8, uint8) => ebool test 4 (34, 30)', async function () {
    ...
    const encryptedAmount = await input.encrypt();
    const tx = await this.contract5.le_euint8_uint8(at(encryptedAmount.handles, 0), 30n, encryptedAmount.inputProof);
    await tx.wait();
    const res = await fhevm.debugger.decryptEbool(await this.contract5.resEbool());
    expect(res).to.equal(false);
  });
  ...
  it('test operator "le" overload (uint8, euint8) => ebool test 1 (5, 111)', async function () {
    ...
    input.add8(111n);
    const encryptedAmount = await input.encrypt();
    const tx = await this.contract5.le_uint8_euint8(5n, at(encryptedAmount.handles, 0), encryptedAmount.inputProof);
    await tx.wait();
    const res = await fhevm.debugger.decryptEbool(await this.contract5.resEbool());
    expect(res).to.equal(true);
  });
  ...
  it('test operator "le" overload (uint8, euint8) => ebool test 2 (30, 34)', async function () {
    ...
    input.add8(34n);
    const encryptedAmount = await input.encrypt();
    const tx = await this.contract5.le_uint8_euint8(30n, at(encryptedAmount.handles, 0), encryptedAmount.inputProof);
    await tx.wait();
    const res = await fhevm.debugger.decryptEbool(await this.contract5.resEbool());
    expect(res).to.equal(true);
  });
  ...
  it('test operator "le" overload (uint8, euint8) => ebool test 3 (34, 34)', async function () {
    ...
    input.add8(34n);
    const encryptedAmount = await input.encrypt();
    const tx = await this.contract5.le_uint8_euint8(34n, at(encryptedAmount.handles, 0), encryptedAmount.inputProof);
    await tx.wait();
    const res = await fhevm.debugger.decryptEbool(await this.contract5.resEbool());
    expect(res).to.equal(true);
  });
  ...
  it('test operator "lt" overload (euint8, uint8) => ebool test 1 (218, 86)', async function () {
    ...
    const encryptedAmount = await input.encrypt();
    const tx = await this.contract5.lt_euint8_uint8(at(encryptedAmount.handles, 0), 86n, encryptedAmount.inputProof);
    await tx.wait();
    const res = await fhevm.debugger.decryptEbool(await this.contract5.resEbool());
    expect(res).to.equal(false);
  });
  ...
  it('test operator "lt" overload (euint8, uint8) => ebool test 2 (194, 198)', async function () {
    ...
    const encryptedAmount = await input.encrypt();
    const tx = await this.contract5.lt_euint8_uint8(at(encryptedAmount.handles, 0), 198n, encryptedAmount.inputProof);
    await tx.wait();
    const res = await fhevm.debugger.decryptEbool(await this.contract5.resEbool());
    expect(res).to.equal(true);
  });
  ...
  it('test operator "lt" overload (euint8, uint8) => ebool test 4 (198, 194)', async function () {
    ...
    const encryptedAmount = await input.encrypt();
    const tx = await this.contract5.lt_euint8_uint8(at(encryptedAmount.handles, 0), 194n, encryptedAmount.inputProof);
    await tx.wait();
    const res = await fhevm.debugger.decryptEbool(await this.contract5.resEbool());
    expect(res).to.equal(false);
  });
  ...
  it('test operator "lt" overload (uint8, euint8) => ebool test 1 (112, 86)', async function () {
    ...
    input.add8(86n);
    const encryptedAmount = await input.encrypt();
    const tx = await this.contract5.lt_uint8_euint8(112n, at(encryptedAmount.handles, 0), encryptedAmount.inputProof);
    await tx.wait();
    const res = await fhevm.debugger.decryptEbool(await this.contract5.resEbool());
    expect(res).to.equal(false);
  });
  ...
  it('test operator "lt" overload (uint8, euint8) => ebool test 2 (194, 198)', async function () {
    ...
    input.add8(198n);
    const encryptedAmount = await input.encrypt();
    const tx = await this.contract5.lt_uint8_euint8(194n, at(encryptedAmount.handles, 0), encryptedAmount.inputProof);
    await tx.wait();
    const res = await fhevm.debugger.decryptEbool(await this.contract5.resEbool());
    expect(res).to.equal(true);
  });
  ...
  it('test operator "lt" overload (uint8, euint8) => ebool test 3 (198, 198)', async function () {
    ...
    input.add8(198n);
    const encryptedAmount = await input.encrypt();
    const tx = await this.contract5.lt_uint8_euint8(198n, at(encryptedAmount.handles, 0), encryptedAmount.inputProof);
    await tx.wait();
    const res = await fhevm.debugger.decryptEbool(await this.contract5.resEbool());
    expect(res).to.equal(false);
  });
  ...
  it('test operator "min" overload (euint8, uint8) => euint8 test 1 (137, 8)', async function () {
    ...
    const encryptedAmount = await input.encrypt();
    const tx = await this.contract5.min_euint8_uint8(at(encryptedAmount.handles, 0), 8n, encryptedAmount.inputProof);
    await tx.wait();
    const res = await fhevm.debugger.decryptEuint(FhevmType.euint8, await this.contract5.resEuint8());
  ...
  it('test operator "min" overload (euint8, uint8) => euint8 test 2 (133, 137)', async function () {
    ...
    const encryptedAmount = await input.encrypt();
    const tx = await this.contract5.min_euint8_uint8(at(encryptedAmount.handles, 0), 137n, encryptedAmount.inputProof);
    await tx.wait();
    const res = await fhevm.debugger.decryptEuint(FhevmType.euint8, await this.contract5.resEuint8());
  ...
  it('test operator "min" overload (euint8, uint8) => euint8 test 4 (137, 133)', async function () {
    ...
    const encryptedAmount = await input.encrypt();
    const tx = await this.contract5.min_euint8_uint8(at(encryptedAmount.handles, 0), 133n, encryptedAmount.inputProof);
    await tx.wait();
    const res = await fhevm.debugger.decryptEuint(FhevmType.euint8, await this.contract5.resEuint8());
    expect(res).to.equal(133n);
  });
  ...
  it('test operator "min" overload (uint8, euint8) => euint8 test 1 (27, 8)', async function () {
    ...
    input.add8(8n);
    const encryptedAmount = await input.encrypt();
    const tx = await this.contract5.min_uint8_euint8(27n, at(encryptedAmount.handles, 0), encryptedAmount.inputProof);
    await tx.wait();
    const res = await fhevm.debugger.decryptEuint(FhevmType.euint8, await this.contract5.resEuint8());
    expect(res).to.equal(8n);
  });
  ...
  it('test operator "min" overload (uint8, euint8) => euint8 test 2 (133, 137)', async function () {
    ...
    input.add8(137n);
    const encryptedAmount = await input.encrypt();
    const tx = await this.contract5.min_uint8_euint8(133n, at(encryptedAmount.handles, 0), encryptedAmount.inputProof);
    await tx.wait();
    const res = await fhevm.debugger.decryptEuint(FhevmType.euint8, await this.contract5.resEuint8());
    expect(res).to.equal(133n);
  });
  ...
  it('test operator "min" overload (uint8, euint8) => euint8 test 3 (137, 137)', async function () {
    ...
    input.add8(137n);
    const encryptedAmount = await input.encrypt();
    const tx = await this.contract5.min_uint8_euint8(137n, at(encryptedAmount.handles, 0), encryptedAmount.inputProof);
    await tx.wait();
    const res = await fhevm.debugger.decryptEuint(FhevmType.euint8, await this.contract5.resEuint8());
    expect(res).to.equal(137n);
  });
  ...
  it('test operator "max" overload (euint8, uint8) => euint8 test 1 (125, 250)', async function () {
    ...
    const encryptedAmount = await input.encrypt();
    const tx = await this.contract5.max_euint8_uint8(at(encryptedAmount.handles, 0), 250n, encryptedAmount.inputProof);
    await tx.wait();
    const res = await fhevm.debugger.decryptEuint(FhevmType.euint8, await this.contract5.resEuint8());
  ...
  it('test operator "max" overload (euint8, uint8) => euint8 test 2 (11, 15)', async function () {
    ...
    const encryptedAmount = await input.encrypt();
    const tx = await this.contract5.max_euint8_uint8(at(encryptedAmount.handles, 0), 15n, encryptedAmount.inputProof);
    await tx.wait();
    const res = await fhevm.debugger.decryptEuint(FhevmType.euint8, await this.contract5.resEuint8());
  ...
  it('test operator "max" overload (euint8, uint8) => euint8 test 4 (15, 11)', async function () {
    ...
    const encryptedAmount = await input.encrypt();
    const tx = await this.contract5.max_euint8_uint8(at(encryptedAmount.handles, 0), 11n, encryptedAmount.inputProof);
    await tx.wait();
    const res = await fhevm.debugger.decryptEuint(FhevmType.euint8, await this.contract5.resEuint8());
    expect(res).to.equal(15n);
  });
  ...
  it('test operator "max" overload (uint8, euint8) => euint8 test 1 (91, 250)', async function () {
    ...
    input.add8(250n);
    const encryptedAmount = await input.encrypt();
    const tx = await this.contract5.max_uint8_euint8(91n, at(encryptedAmount.handles, 0), encryptedAmount.inputProof);
    await tx.wait();
    const res = await fhevm.debugger.decryptEuint(FhevmType.euint8, await this.contract5.resEuint8());
    expect(res).to.equal(250n);
  });
  ...
  it('test operator "max" overload (uint8, euint8) => euint8 test 2 (11, 15)', async function () {
    ...
    input.add8(15n);
    const encryptedAmount = await input.encrypt();
    const tx = await this.contract5.max_uint8_euint8(11n, at(encryptedAmount.handles, 0), encryptedAmount.inputProof);
    await tx.wait();
    const res = await fhevm.debugger.decryptEuint(FhevmType.euint8, await this.contract5.resEuint8());
    expect(res).to.equal(15n);
  });
  ...
  it('test operator "max" overload (uint8, euint8) => euint8 test 3 (15, 15)', async function () {
    ...
    input.add8(15n);
    const encryptedAmount = await input.encrypt();
    const tx = await this.contract5.max_uint8_euint8(15n, at(encryptedAmount.handles, 0), encryptedAmount.inputProof);
    await tx.wait();
    const res = await fhevm.debugger.decryptEuint(FhevmType.euint8, await this.contract5.resEuint8());
    expect(res).to.equal(15n);
  });
  ...
  it('test operator "add" overload (euint16, uint16) => euint16 test 1 (13756, 11971)', async function () {
    ...
    await tx.wait();
    const res = await fhevm.debugger.decryptEuint(FhevmType.euint16, await this.contract5.resEuint16());
  ...
  it('test operator "eq" overload (euint16, uint16) => ebool test 1 (56747, 879)', async function () {
    ...
    const encryptedAmount = await input.encrypt();
    const tx = await this.contract5.eq_euint16_uint16(at(encryptedAmount.handles, 0), 879n, encryptedAmount.inputProof);
    await tx.wait();
    const res = await fhevm.debugger.decryptEbool(await this.contract5.resEbool());
    expect(res).to.equal(false);
  });
  ...
  it('test operator "le" overload (uint16, euint16) => ebool test 1 (850, 42114)', async function () {
    ...
    input.add16(42114n);
    const encryptedAmount = await input.encrypt();
    const tx = await this.contract6.le_uint16_euint16(850n, at(encryptedAmount.handles, 0), encryptedAmount.inputProof);
    await tx.wait();
    const res = await fhevm.debugger.decryptEbool(await this.contract6.resEbool());
    expect(res).to.equal(true);
  });
  ...
  it('test operator "min" overload (euint16, uint16) => euint16 test 1 (58529, 26425)', async function () {
    ...
    await tx.wait();
    const res = await fhevm.debugger.decryptEuint(FhevmType.euint16, await this.contract6.resEuint16());
