 ...
 * builder, and `instance.publicDecrypt` becomes `fhevm.publicDecrypt` — which returns the same
...
describe('FHEVM manual operations (isIn / sum / shift-rotate)', function () {
  ...
  it('shr(euint64, uint8) applies modulo semantics for indexes > bit width', async function () {
    ...
    const res = await decrypt64Result(
      contract,
      contract.test_shr_euint64_uint8(at(encryptedAmount.handles, 0), OVERSIZED_SHIFT_64, encryptedAmount.inputProof),
    );
  ...
  it('shl(euint64, uint8) applies modulo semantics for indexes > bit width', async function () {
    ...
    const res = await decrypt64Result(
      contract,
      contract.test_shl_euint64_uint8(at(encryptedAmount.handles, 0), OVERSIZED_SHIFT_64, encryptedAmount.inputProof),
    );
  ...
  it('rotl(euint64, uint8) applies modulo semantics for indexes > bit width', async function () {
    ...
    const res = await decrypt64Result(
      contract,
      contract.test_rotl_euint64_uint8(at(encryptedAmount.handles, 0), OVERSIZED_SHIFT_64, encryptedAmount.inputProof),
    );
  ...
  it('rotr(euint64, uint8) applies modulo semantics for indexes > bit width', async function () {
    ...
    const res = await decrypt64Result(
      contract,
      contract.test_rotr_euint64_uint8(at(encryptedAmount.handles, 0), OVERSIZED_SHIFT_64, encryptedAmount.inputProof),
    );
  ...
  it('test operator "sum" euint16 - two elements', async function () {
    ...
    await tx.wait();
    const handle = (await contract.resEuint16()) as Hex;
    const res = await fhevm.publicDecrypt([handle]);
  ...
  it('test operator "sum" euint32 - two elements', async function () {
    ...
    await tx.wait();
    const handle = (await contract.resEuint32()) as Hex;
    const res = await fhevm.publicDecrypt([handle]);
  ...
  it('test operator "sum" euint8 - three elements', async function () {
    ...
    await tx.wait();
    const handle = (await contract.resEuint8()) as Hex;
    const res = await fhevm.publicDecrypt([handle]);
  ...
  it('test operator "sum" euint64 - two elements', async function () {
    ...
    await tx.wait();
    const handle = (await contract.resEuint64()) as Hex;
    const res = await fhevm.publicDecrypt([handle]);
  ...
  it('test operator "sum" euint128 - two elements', async function () {
    ...
    await tx.wait();
    const handle = (await contract.resEuint128()) as Hex;
    const res = await fhevm.publicDecrypt([handle]);
  ...
  it('test operator "sum" euint8 - duplicate handle counted twice', async function () {
    ...
    input.add8(value);
    const encryptedAmount = await input.encrypt();
    const tx = await contract.test_sum_euint8_duplicate(at(encryptedAmount.handles, 0), encryptedAmount.inputProof);
    await tx.wait();
    const handle = (await contract.resEuint8()) as Hex;
    const res = await fhevm.publicDecrypt([handle]);
  ...
  it('test operator "sum" euint8 - single element returns fresh handle', async function () {
    ...
    input.add8(value);
    const encryptedAmount = await input.encrypt();
    const tx = await contract.test_sum_euint8_single(at(encryptedAmount.handles, 0), encryptedAmount.inputProof);
    await tx.wait();
    const handle = (await contract.resEuint8()) as Hex;
    expect(handle).to.not.equal(at(encryptedAmount.handles, 0));
    const res = await fhevm.publicDecrypt([handle]);
  ...
  it('test operator "isIn" euint8 - value found in set', async function () {
    ...
    input.add8(20n);
    const encryptedAmount = await input.encrypt();
    const tx = await contract.test_isIn_euint8_found(at(encryptedAmount.handles, 0), encryptedAmount.inputProof);
    await tx.wait();
    const handle = (await contract.resEbool()) as Hex;
    const res = await fhevm.publicDecrypt([handle]);
  ...
  it('test operator "isIn" euint8 - value not found in set', async function () {
    ...
    input.add8(99n);
    const encryptedAmount = await input.encrypt();
    const tx = await contract.test_isIn_euint8_not_found(at(encryptedAmount.handles, 0), encryptedAmount.inputProof);
    await tx.wait();
    const handle = (await contract.resEbool()) as Hex;
    const res = await fhevm.publicDecrypt([handle]);
  ...
  it('test operator "isIn" euint16 - value found in set', async function () {
    ...
    input.add16(1000n);
    const encryptedAmount = await input.encrypt();
    const tx = await contract.test_isIn_euint16(at(encryptedAmount.handles, 0), encryptedAmount.inputProof);
    await tx.wait();
    const handle = (await contract.resEbool()) as Hex;
    const res = await fhevm.publicDecrypt([handle]);
    expect(res.clearValues[handle]).to.equal(true);
  ...
  it('test operator "isIn" euint32 - value found in set', async function () {
    ...
    input.add32(100000n);
    const encryptedAmount = await input.encrypt();
    const tx = await contract.test_isIn_euint32(at(encryptedAmount.handles, 0), encryptedAmount.inputProof);
    await tx.wait();
    const handle = (await contract.resEbool()) as Hex;
    const res = await fhevm.publicDecrypt([handle]);
    expect(res.clearValues[handle]).to.equal(true);
  ...
  it('test operator "isIn" euint64 - value found in set', async function () {
    ...
    const encryptedAmount = await input.encrypt();
    const tx = await contract.test_isIn_euint64(at(encryptedAmount.handles, 0), encryptedAmount.inputProof);
    await tx.wait();
    const handle = (await contract.resEbool()) as Hex;
    const res = await fhevm.publicDecrypt([handle]);
    expect(res.clearValues[handle]).to.equal(true);
  ...
  it('test operator "isIn" euint128 - value found in set', async function () {
    ...
    const encryptedAmount = await input.encrypt();
    const tx = await contract.test_isIn_euint128(at(encryptedAmount.handles, 0), encryptedAmount.inputProof);
    await tx.wait();
    const handle = (await contract.resEbool()) as Hex;
    const res = await fhevm.publicDecrypt([handle]);
    expect(res.clearValues[handle]).to.equal(true);
  ...
  it('test operator "isIn" euint8 - single element set, found', async function () {
    ...
    input.add8(42n);
    const encryptedAmount = await input.encrypt();
    const tx = await contract.test_isIn_euint8_single_element(
      at(encryptedAmount.handles, 0),
      encryptedAmount.inputProof,
    );
    await tx.wait();
  ...
  it('test operator "isIn" eaddress - value found in set', async function () {
    ...
    const encryptedAmount = await input.encrypt();
    const tx = await contract.test_isIn_eaddress_found(at(encryptedAmount.handles, 0), encryptedAmount.inputProof);
    await tx.wait();
    const handle = (await contract.resEbool()) as Hex;
    const res = await fhevm.publicDecrypt([handle]);
    expect(res.clearValues[handle]).to.equal(true);
  ...
  it('test operator "isIn" eaddress - value not found in set', async function () {
    ...
    const encryptedAmount = await input.encrypt();
    const tx = await contract.test_isIn_eaddress_not_found(at(encryptedAmount.handles, 0), encryptedAmount.inputProof);
    await tx.wait();
    const handle = (await contract.resEbool()) as Hex;
    const res = await fhevm.publicDecrypt([handle]);
    expect(res.clearValues[handle]).to.equal(false);
  ...
  it('test operator "isIn" euint256 - value found in set', async function () {
    ...
    input.add256(42n);
    const encryptedAmount = await input.encrypt();
    const tx = await contract.test_isIn_euint256_found(at(encryptedAmount.handles, 0), encryptedAmount.inputProof);
    await tx.wait();
    const handle = (await contract.resEbool()) as Hex;
    const res = await fhevm.publicDecrypt([handle]);
    expect(res.clearValues[handle]).to.equal(true);
  ...
  it('test operator "isIn" euint256 - value not found in set', async function () {
    ...
    input.add256(99n);
    const encryptedAmount = await input.encrypt();
    const tx = await contract.test_isIn_euint256_not_found(at(encryptedAmount.handles, 0), encryptedAmount.inputProof);
    await tx.wait();
    const handle = (await contract.resEbool()) as Hex;
    const res = await fhevm.publicDecrypt([handle]);
    expect(res.clearValues[handle]).to.equal(false);
