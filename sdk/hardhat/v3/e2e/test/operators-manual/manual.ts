...
describe('FHEVM manual operations', function () {
  ...
  it('Select works returning if false', async function () {
    ...
    await tx.wait();
    const res = await fhevm.debugger.decryptEuint(FhevmType.euint32, (await contract.resEuint32()) as Hex);
  ...
  it('Select ebool', async function () {
    ...
    await tx.wait();
    const res = await fhevm.debugger.decryptEbool((await contract.resEbool()) as Hex);
    expect(res).to.equal(false);
    const tx2 = await contract.test_select_ebool(false, false, true);
    await tx2.wait();
    const res2 = await fhevm.debugger.decryptEbool((await contract.resEbool()) as Hex);
  ...
  it('Select works for eaddress returning if false', async function () {
    ...
    await tx.wait();
    const res = await fhevm.debugger.decryptEaddress((await contract.resAdd()) as Hex);
  ...
  it('ebool eq ebool', async function () {
    ...
    await tx3.wait();
    const res3 = await fhevm.debugger.decryptEbool((await contract.resEbool()) as Hex);
    expect(res3).to.equal(false);
    const tx4 = await contract.eqEbool(true, false);
    await tx4.wait();
    const res4 = await fhevm.debugger.decryptEbool((await contract.resEbool()) as Hex);
  ...
  it('ebool to euint8 casting works with true', async function () {
    ...
    await tx.wait();
    const res = await fhevm.debugger.decryptEuint(FhevmType.euint8, (await contract.resEuint8()) as Hex);
  ...
  it('ebool to euint16 casting works with true', async function () {
    ...
    await tx.wait();
    const res = await fhevm.debugger.decryptEuint(FhevmType.euint16, (await contract.resEuint16()) as Hex);
    expect(res).to.equal(1);
  });
  ...
  it('ebool to euint64 casting works with true', async function () {
    ...
    await tx.wait();
    const res = await fhevm.debugger.decryptEuint(FhevmType.euint64, (await contract.resEuint64()) as Hex);
    expect(res).to.equal(1);
  });
  ...
  it('ebool to euint128 casting works with true', async function () {
    ...
    await tx.wait();
    const res = await fhevm.debugger.decryptEuint(FhevmType.euint128, (await contract.resEuint128()) as Hex);
    expect(res).to.equal(1);
  });
  ...
  it('ebool to euint256 casting works with true', async function () {
    ...
    await tx.wait();
    const res = await fhevm.debugger.decryptEuint(FhevmType.euint256, (await contract.resEuint256()) as Hex);
    expect(res).to.equal(1);
  });
