 ...
 * References whose offsets are empty for a given template patch as no-ops, so passing all of them is safe.
 */
export function buildHostAddressReplacementsV12(parameters: {
