...
const commands: Readonly<Record<CommandName, CheckCommand>> = {
  ...
  'pinned-dependencies': checkPinnedDependencies,
  'package-json': checkPackageJson,
  'package-json-paths': checkPackageJsonPaths,
  ...
  'manifest-coverage': checkManifestCoverage,
  'published-files': checkPublishedFiles,
  'tsconfig-paths': checkTsconfigPaths,
  'tsc-mode': checkTscMode,
  'commit-scope': checkCommitScope,
