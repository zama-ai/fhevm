...
interface IKmsManagement {
     ...
     */
    event ActivateKey(uint256 keyId, string[] kmsNodeS3BucketUrls);
     ...
     * @param kmsNodeS3BucketUrls The KMS nodes' s3 bucket URL that participated in the consensus.
     */
    event ActivateCrs(uint256 crsId, string[] kmsNodeS3BucketUrls);
     ...
     * @param keyId The ID of the key.
     * @param serverKeyDigest The digest of the server key.
     * @param publicKeyDigest The digest of the public key.
     * @param signature The signature of the KMS node that has responded.
     */
