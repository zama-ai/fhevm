...
pub mod GatewayOwnable {
    ...
    impl GatewayOwnableErrors {
        ...
        pub const VARIANT_NAMES: &'static [&'static str] = &[::core::stringify!(NotGatewayOwner)];
    ...
    impl alloy_sol_types::SolInterface for GatewayOwnableErrors {
        ...
        fn abi_decode_raw(selector: [u8; 4], data: &[u8]) -> alloy_sol_types::Result<Self> {
            static DECODE_SHIMS: &[fn(&[u8]) -> alloy_sol_types::Result<GatewayOwnableErrors>] =
                &[{
                    fn NotGatewayOwner(
                        data: &[u8],
        ...
        fn abi_decode_raw_validate(
            ...
            static DECODE_VALIDATE_SHIMS: &[fn(
                ...
                -> alloy_sol_types::Result<GatewayOwnableErrors>] = &[{
                fn NotGatewayOwner(data: &[u8]) -> alloy_sol_types::Result<GatewayOwnableErrors> {
                    <NotGatewayOwner as alloy_sol_types::SolError>::abi_decode_raw_validate(data)
                        .map(GatewayOwnableErrors::NotGatewayOwner)
                }
                NotGatewayOwner
            }];
    ...
    pub fn deploy<P: alloy_contract::private::Provider<N>, N: alloy_contract::private::Network>(
        __provider: P,
    ) -> impl ::core::future::Future<Output = alloy_contract::Result<GatewayOwnableInstance<P, N>>>
    {
    ...
    impl<P, N> ::core::fmt::Debug for GatewayOwnableInstance<P, N> {
        ...
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("GatewayOwnableInstance")
                .field(&self.address)
                .finish()
        }
    }
        ...
        GatewayOwnableInstance<P, N>
    {
        ...
        For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        #[inline]
        pub async fn deploy(__provider: P) -> alloy_contract::Result<GatewayOwnableInstance<P, N>> {
