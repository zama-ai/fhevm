...
pub mod IERC20Metadata {
    ...
    impl alloy_sol_types::SolInterface for IERC20MetadataCalls {
        ...
        fn abi_decode_raw(selector: [u8; 4], data: &[u8]) -> alloy_sol_types::Result<Self> {
            static DECODE_SHIMS: &[fn(&[u8]) -> alloy_sol_types::Result<IERC20MetadataCalls>] = &[
                {
                    fn name(data: &[u8]) -> alloy_sol_types::Result<IERC20MetadataCalls> {
                ...
                {
                    fn approve(data: &[u8]) -> alloy_sol_types::Result<IERC20MetadataCalls> {
                ...
                {
                    fn totalSupply(data: &[u8]) -> alloy_sol_types::Result<IERC20MetadataCalls> {
                ...
                {
                    fn transferFrom(data: &[u8]) -> alloy_sol_types::Result<IERC20MetadataCalls> {
                ...
                {
                    fn decimals(data: &[u8]) -> alloy_sol_types::Result<IERC20MetadataCalls> {
                ...
                {
                    fn balanceOf(data: &[u8]) -> alloy_sol_types::Result<IERC20MetadataCalls> {
                ...
                {
                    fn symbol(data: &[u8]) -> alloy_sol_types::Result<IERC20MetadataCalls> {
                ...
                {
                    fn transfer(data: &[u8]) -> alloy_sol_types::Result<IERC20MetadataCalls> {
                ...
                {
                    fn allowance(data: &[u8]) -> alloy_sol_types::Result<IERC20MetadataCalls> {
    ...
    pub fn deploy<P: alloy_contract::private::Provider<N>, N: alloy_contract::private::Network>(
        provider: P,
    ) -> impl ::core::future::Future<Output = alloy_contract::Result<IERC20MetadataInstance<P, N>>>
    {
    ...
    impl<P, N> ::core::fmt::Debug for IERC20MetadataInstance<P, N> {
        ...
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("IERC20MetadataInstance")
                .field(&self.address)
                .finish()
        }
    }
        ...
        IERC20MetadataInstance<P, N>
    {
        ...
        For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        #[inline]
        pub async fn deploy(provider: P) -> alloy_contract::Result<IERC20MetadataInstance<P, N>> {
