...
```*/
            ...
            static DECODE_SHIMS: &[fn(
            ...
            ) -> alloy_sol_types::Result<StringsErrors>] = &[
                {
                    fn StringsInvalidAddressFormat(
                        ...
                        <StringsInvalidAddressFormat as alloy_sol_types::SolError>::abi_decode_raw_with_config(
                                data,
                                config,
                            )
                ...
                },
                {
                    fn StringsInvalidChar(
                        ...
                        <StringsInvalidChar as alloy_sol_types::SolError>::abi_decode_raw_with_config(
                                data,
                                config,
                            )
                ...
                },
                {
                    fn StringsInsufficientHexLength(
                        ...
                        <StringsInsufficientHexLength as alloy_sol_types::SolError>::abi_decode_raw_with_config(
                                data,
                                config,
                            )
    ...
    #[automatically_derived]
    impl StringsErrors {
        /**Creates a [`StringsInsufficientHexLength`] error.

```solidity
error StringsInsufficientHexLength(uint256,uint256)
```*/
        #[inline]
        pub fn strings_insufficient_hex_length(
            value: alloy::sol_types::private::primitives::aliases::U256,
            length: alloy::sol_types::private::primitives::aliases::U256,
        ) -> Self {
            Self::StringsInsufficientHexLength(StringsInsufficientHexLength {
                value: value,
                length: length,
            })
        }
        /**Creates a [`StringsInvalidAddressFormat`] error.

```solidity
error StringsInvalidAddressFormat()
```*/
        #[inline]
        pub fn strings_invalid_address_format() -> Self {
            Self::StringsInvalidAddressFormat(StringsInvalidAddressFormat)
        }
        /**Creates a [`StringsInvalidChar`] error.

```solidity
error StringsInvalidChar()
```*/
        #[inline]
        pub fn strings_invalid_char() -> Self {
            Self::StringsInvalidChar(StringsInvalidChar)
        }
    }
