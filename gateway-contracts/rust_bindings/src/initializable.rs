...
pub mod Initializable {
    ...
    impl alloy_sol_types::SolInterface for InitializableErrors {
        ...
        fn abi_decode_raw(selector: [u8; 4], data: &[u8]) -> alloy_sol_types::Result<Self> {
            static DECODE_SHIMS: &[fn(&[u8]) -> alloy_sol_types::Result<InitializableErrors>] = &[
                {
                    fn NotInitializing(
                        data: &[u8],
    ...
    pub fn deploy<P: alloy_contract::private::Provider<N>, N: alloy_contract::private::Network>(
        __provider: P,
    ) -> impl ::core::future::Future<Output = alloy_contract::Result<InitializableInstance<P, N>>>
    {
    ...
    impl<P, N> ::core::fmt::Debug for InitializableInstance<P, N> {
        ...
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("InitializableInstance")
                .field(&self.address)
                .finish()
        }
    }
        ...
        InitializableInstance<P, N>
    {
        ...
        For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        #[inline]
        pub async fn deploy(__provider: P) -> alloy_contract::Result<InitializableInstance<P, N>> {
