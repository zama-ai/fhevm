...
See the [wrapper's documentation](`Ownable2StepUpgradeableInstance`) for more details.*/
    ...
    >(
        ...
        provider: P,
    ) -> Ownable2StepUpgradeableInstance<T, P, N> {
        Ownable2StepUpgradeableInstance::<T, P, N>::new(address, provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        Output = alloy_contract::Result<Ownable2StepUpgradeableInstance<T, P, N>>,
    > {
        Ownable2StepUpgradeableInstance::<T, P, N>::deploy(provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(provider: P) -> alloy_contract::RawCallBuilder<T, P, N> {
        Ownable2StepUpgradeableInstance::<T, P, N>::deploy_builder(provider)
    }
...
See the [module-level documentation](self) for all the available methods.*/
    ...
    #[automatically_derived]
    impl<T, P, N> ::core::fmt::Debug for Ownable2StepUpgradeableInstance<T, P, N> {
        #[inline]
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            provider: P,
        ) -> alloy_contract::Result<Ownable2StepUpgradeableInstance<T, P, N>> {
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    impl<T, P: ::core::clone::Clone, N> Ownable2StepUpgradeableInstance<T, &P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> Ownable2StepUpgradeableInstance<T, P, N> {
