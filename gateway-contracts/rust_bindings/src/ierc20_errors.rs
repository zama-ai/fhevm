...
pub mod IERC20Errors {
    ...
    impl alloy_sol_types::SolInterface for IERC20ErrorsErrors {
        ...
        fn abi_decode_raw(selector: [u8; 4], data: &[u8]) -> alloy_sol_types::Result<Self> {
            static DECODE_SHIMS: &[fn(&[u8]) -> alloy_sol_types::Result<IERC20ErrorsErrors>] = &[
                {
    ...
    pub fn deploy<P: alloy_contract::private::Provider<N>, N: alloy_contract::private::Network>(
        provider: P,
    ) -> impl ::core::future::Future<Output = alloy_contract::Result<IERC20ErrorsInstance<P, N>>>
    {
    ...
    impl<P, N> ::core::fmt::Debug for IERC20ErrorsInstance<P, N> {
        ...
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("IERC20ErrorsInstance")
                .field(&self.address)
                .finish()
        }
    }
        ...
        IERC20ErrorsInstance<P, N>
    {
        ...
        For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        #[inline]
        pub async fn deploy(provider: P) -> alloy_contract::Result<IERC20ErrorsInstance<P, N>> {
