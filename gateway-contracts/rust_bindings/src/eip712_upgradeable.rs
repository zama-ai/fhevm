...
pub mod EIP712Upgradeable {
    ...
    impl EIP712UpgradeableCalls {
        ...
        pub const VARIANT_NAMES: &'static [&'static str] = &[::core::stringify!(eip712Domain)];
    ...
    impl alloy_sol_types::SolInterface for EIP712UpgradeableCalls {
        ...
        fn abi_decode_raw(selector: [u8; 4], data: &[u8]) -> alloy_sol_types::Result<Self> {
            static DECODE_SHIMS: &[fn(&[u8]) -> alloy_sol_types::Result<EIP712UpgradeableCalls>] =
                &[{
                    fn eip712Domain(
                        data: &[u8],
        ...
        fn abi_decode_raw_validate(
            ...
            static DECODE_VALIDATE_SHIMS: &[fn(
                ...
                EIP712UpgradeableCalls,
            >] = &[{
                fn eip712Domain(data: &[u8]) -> alloy_sol_types::Result<EIP712UpgradeableCalls> {
                    <eip712DomainCall as alloy_sol_types::SolCall>::abi_decode_raw_validate(data)
                        .map(EIP712UpgradeableCalls::eip712Domain)
                }
                eip712Domain
            }];
    ...
    impl EIP712UpgradeableErrors {
        ...
        pub const SELECTORS: &'static [[u8; 4usize]] =
            &[[215u8, 230u8, 188u8, 248u8], [249u8, 46u8, 232u8, 169u8]];
        /// The names of the variants in the same order as `SELECTORS`.
    ...
    pub fn deploy<P: alloy_contract::private::Provider<N>, N: alloy_contract::private::Network>(
        __provider: P,
    ) -> impl ::core::future::Future<Output = alloy_contract::Result<EIP712UpgradeableInstance<P, N>>>
    {
    ...
    impl<P, N> ::core::fmt::Debug for EIP712UpgradeableInstance<P, N> {
        ...
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("EIP712UpgradeableInstance")
                .field(&self.address)
                .finish()
        }
    }
