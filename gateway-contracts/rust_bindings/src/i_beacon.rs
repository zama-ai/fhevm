...
pub mod IBeacon {
    ...
    impl IBeaconCalls {
        ...
        pub const VARIANT_NAMES: &'static [&'static str] = &[::core::stringify!(implementation)];
    ...
    impl alloy_sol_types::SolInterface for IBeaconCalls {
        ...
        fn abi_decode_raw(selector: [u8; 4], data: &[u8]) -> alloy_sol_types::Result<Self> {
            static DECODE_SHIMS: &[fn(&[u8]) -> alloy_sol_types::Result<IBeaconCalls>] = &[{
                fn implementation(data: &[u8]) -> alloy_sol_types::Result<IBeaconCalls> {
                    <implementationCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
        ...
        fn abi_decode_raw_validate(
            ...
            static DECODE_VALIDATE_SHIMS: &[fn(&[u8]) -> alloy_sol_types::Result<IBeaconCalls>] =
                &[{
                    fn implementation(data: &[u8]) -> alloy_sol_types::Result<IBeaconCalls> {
    ...
    pub fn deploy<P: alloy_contract::private::Provider<N>, N: alloy_contract::private::Network>(
        __provider: P,
    ) -> impl ::core::future::Future<Output = alloy_contract::Result<IBeaconInstance<P, N>>> {
        ...
        IBeaconInstance<P, N>
    {
        ...
        For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        #[inline]
        pub async fn deploy(__provider: P) -> alloy_contract::Result<IBeaconInstance<P, N>> {
        ...
        IBeaconInstance<P, N>
    {
        ...
        pub fn implementation(&self) -> alloy_contract::SolCallBuilder<&P, implementationCall, N> {
