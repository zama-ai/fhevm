...
ALLOWED_FORGE_VERSIONS = ["1.3.1-v1.3.1", "1.3.1-stable", "1.3.2-dev"]
...
class BindingsUpdater:
    ...
    def check_bindings_up_to_date(self):
        ...
        return_code = subprocess.call(
            f"/Users/luis/Documents/foundry/target/debug/forge bind --root {GW_ROOT_DIR} --module --skip-cargo-toml "
    ...
    def update_bindings(self):
        ...
        # when only updating one of them (since interfaces are included in many contracts)
        subprocess.run(
            f"/Users/luis/Documents/foundry/target/debug/forge bind --root {GW_ROOT_DIR} --hh -b {GW_CRATE_DIR}/src "
