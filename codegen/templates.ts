...
function coprocessorInterfaceCustomFunctions(): string {
  return `
     ...
     * @return result   Result value of the target type.
     */
    function trivialEncrypt(bytes32 ct, bytes1 toType) external returns (bytes32 result);
...
function tfheAsEboolUnaryCast(bits: number): string {
  ...
  if (bits == 8) {
    ...
    */
    function asEbool(bytes32 value) internal returns (ebool) {
    ...
    function asEbool(bool value) internal returns (ebool) {
        if (value) {
            return asEbool(bytes32(uint256(1)));
        } else {
            return asEbool(bytes32(uint256(0)));
        }
    }
  ...
  let result = `
    ...
    */
    function asEuint${bits}(uint256 value) internal returns (euint${bits}) {
        return euint${bits}.wrap(Impl.trivialEncrypt(bytes32(value), Common.euint${bits}_t));
    }
  ...
  let result = `
    ...
    */
    function asEaddress(address value) internal returns (eaddress) {
        return eaddress.wrap(Impl.trivialEncrypt(bytes32(uint256(uint160(value))), Common.euint160_t));
    }
